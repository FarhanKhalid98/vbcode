...
Begin VB.Form DefOPandMeasurements 
   ...
   ClientWidth     =   12000
   ControlBox      =   0   'False
   Icon            =   "DefOPandMeasurements.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.Frame FraHelp 
      ...
      Begin VB.TextBox Text1 
         ...
         TabIndex        =   6
         Tag             =   "NC"
         Text            =   "DefOPandMeasurements.frx":0ECA
         Top             =   360
         Width           =   3930
      End
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "DefOPandMeasurements.frx":0F0E
      ...
      BeginProperty stylesets(1).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(1).Picture=   "DefOPandMeasurements.frx":16FC
      ...
      BeginProperty stylesets(2).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(2).Picture=   "DefOPandMeasurements.frx":2016
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "DefOPandMeasurements.frx":2032
      BC              =   14737632
      FC              =   0
   End
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "DefOPandMeasurements.frx":204E
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "DefOPandMeasurements.frx":25F4
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin JeweledBut.JeweledButton BtnRefresh 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "DefOPandMeasurements.frx":2FAD
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin VB.Label LblCaption 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Custom Product and Measurements"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   13.5
         Charset         =   178
   ...
   End
End
Attribute VB_Name = "DefOPandMeasurements"
...
Private Sub Grid_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
  ...
  If Button = 2 And Shift = 0 Then
    ...
    mniCreateNewOrderProduct.Enabled = False
...
Private Sub mniCreateNewOrderProduct_Click()
  On Error GoTo ErrorHandler
  With DefCreateProductMeasurements
    .ParaInID = ""
    .ParaInIsGroup = True
...
Private Sub TvwGroups_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
  ...
  If Button = 2 And Shift = 0 Then
    ...
    mniCreatenewMeasurementOrderedProduct
    mniCreatenewAccounts.Enabled = (Len(vid) = 2)
    mniCreateNewOrderProduct.Enabled = (Len(vid) = 1)
