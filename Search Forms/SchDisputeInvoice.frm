...
Begin VB.Form SchDisputeInvoice 
   AutoRedraw      =   -1  'True
   ...
   Begin JeweledBut.JeweledButton BtnSelect 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchDisputeInvoice.frx":0000
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchDisputeInvoice.frx":001C
      BC              =   14737632
      FC              =   0
   End
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "SchDisputeInvoice.frx":0038
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
      ...
      Columns(1).Caption=   "Dispute Date"
      Columns(1).Name =   "Date"
      ...
      Columns(2).Caption=   "Invoice Type"
      Columns(2).Name =   "InvoiceType"
   ...
   End
End
Attribute VB_Name = "SchDisputeInvoice"
...
Public ParaOutDisputeID As String
Public ParaOutDisputeDate As String
Public ParaInDisputeDate As String

Private Sub LoadGrid()
   On Error GoTo ErrorHandler
   Set Rs = New ADODB.Recordset
   VStrSQL = "SELECT h.DisputeID as ID, h.DisputeDate as Date, InvoiceType, Tag, h.StoreID" & vbCrLf _
         + " , StoreName, UserName" & vbCrLf _
         + " FROM DisputeInvoiceHeader h inner join " & vbCrLf _
         + " (SELECT DisputeID, DisputeDate FROM DisputeInvoiceBody GROUP BY DisputeID, DisputeDate) b" & vbCrLf _
         + " on h.DisputeID = b.DisputeID and h.DisputeDate = b.DisputeDate " & vbCrLf _
         + " INNER JOIN users u ON h.userno = u.userno " & vbCrLf _
         + " left outer Join Stores s on h.StoreID = s.StoreID" & vbCrLf _
         + " WHERE h.DisputeDate = '" & DtpDate.DateValue & "'" & IIf(ObjUserSecurity.IsAdministrator = False, " and h.userno=" & ObjUserSecurity.UserNo, "") & IIf(vSessionID = 0, "", " and SessionID = " & vSessionID) & vOrder & vDirection
   ...
   Grid.Columns("InvoiceType").DataField = "InvoiceType"
...
Private Sub BtnSelect_Click()
  ...
  Me.ParaOutDisputeID = Rs!ID
  Me.ParaOutDisputeDate = Rs!Date
  Unload Me
  Exit Sub
ErrorHandler:
  Call ShowErrorMessage
...
Private Sub Form_Load()
   ...
   Me.ParaOutDisputeID = ""
   Me.ParaOutDisputeDate = ""
   DtpDate.DateValue = Me.ParaInDisputeDate
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
   ...
   If KeyCode = vbKeyReturn Then
      ...
      Case Grid.Name, TxtID.Name, DtpDate.Name, TxtTag.Name
