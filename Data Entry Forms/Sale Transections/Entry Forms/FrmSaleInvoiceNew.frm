...
Begin VB.Form FrmSaleInvoiceNew 
   ...
   ClientWidth     =   12000
   ControlBox      =   0   'False
   Icon            =   "FrmSaleInvoiceNew.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin SSDataWidgets_B_OLEDB.SSOleDBGrid GridSerial 
         ...
         BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         stylesets(0).Picture=   "FrmSaleInvoiceNew.frx":000C
         AllowDelete     =   -1  'True
         AllowUpdate     =   0   'False
         MultiLine       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnDelete 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoiceNew.frx":0028
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoiceNew.frx":0044
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnOpen 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoiceNew.frx":0060
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoiceNew.frx":007C
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoiceNew.frx":0098
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoiceNew.frx":00B4
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnStore 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoiceNew.frx":00D0
      BC              =   12632256
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoiceNew.frx":00EC
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnOrganization 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoiceNew.frx":0108
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnEmployee 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoiceNew.frx":0124
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnMember 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoiceNew.frx":0140
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmSaleInvoiceNew.frx":015C
      AllowUpdate     =   0   'False
      AllowRowSizing  =   0   'False
      AllowGroupSizing=   0   'False
      AllowColumnSizing=   0   'False
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid GridOffer 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmSaleInvoiceNew.frx":0178
      UseGroups       =   -1  'True
      MultiLine       =   0   'False
      AllowRowSizing  =   0   'False
      AllowGroupSizing=   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnCustomer 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoiceNew.frx":0194
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSaleMan 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoiceNew.frx":01B0
      BC              =   12632256
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "FrmSaleInvoiceNew"
...
Private Function FunSelectCustomer(ByVal CallerName As SelectAccountCaller, ByVal IsOptional As Boolean) As Boolean
    ...
    With CN.Execute(vStrSQL)
      If .RecordCount > 0 Then
          ...
          TxtPreviousPayable.Text = CN.Execute("SELECT isnull(dbo.FunCurrentDebit('" & TxtCustomerID.Text & "','" & DtpBillDate.DateValue & "'),0)").Fields(0).Value
...
Private Sub BtnPrint_Click()
   On Error GoTo ErrorHandler
   vStrSQL = "  select h.BillID, h.BillDate, EntryDate, Pr.PartyName + ' - ' + H.CustomerID as Customer_Name_ID, Pr.Address, StoreName, BillNo, Description," & vbCrLf _
            + " code, ProductName, dbo.FunSaleBodySerial(b.BillID,b.BillDate, b.ProductId) Serial," & vbCrLf _
            + " dbo.FunSaleBodyOffer(b.BillID,b.BillDate, b.ProductId) ProductOffer, QtyPack, Multiplier, Qty," & vbCrLf _
            + " Bonus,b.DiscPc, b.DiscPer, DiscVal, Offer, SaleTaxPer, SaleTaxval," & vbCrLf _
            + " (Amount-(Amount* (isnull(BillDiscPer,0)/100)) + (Amount* isnull(OtherCharges,0) /TotalAmount)) /((isnull(QtyPack,0)*isnull(Multiplier,0))+Qty+isnull(Bonus,0))  as price," & vbCrLf _
            + " (Amount-(Amount* (isnull(BillDiscPer,0)/100))) + (Amount* isnull(OtherCharges,0) /TotalAmount) as Amount," & vbCrLf _
            + " dbo.FunLastPurPrice(h.BillID,h.BillDate,b.ProductID) as LastPrice," & vbCrLf _
            + " RetailPrice" & vbCrLf _
    ...
    Set RptReportViewer.Report = New CryRptSaleInvoiceNew
...
'         sSql = "update Products set PurPrice = " & RsBody!Price & ", PurDiscPC = " & RsBody!DiscPC & ", PurchasePackingID = " & IIf(IsNull(RsBody!PackingID), "Null", RsBody!PackingID) & " Where ProductID='" & RsBody!ProductID & "'"
         CN.Execute sSql
         If Not IsNull(RsBody!PackingID) Then
...
Private Sub PopulateDataToGridserial()
   ...
   If RsBodySerial.RecordCount > 0 Then
'       sSql = "select d.* from SaleBodySerial d  where BillID=" & Val(TxtBillID.Text) & " and BillDate='" & DtpBillDate.DateValue & "' and ProductID = '" & Grid.Columns("ProductID").Text & "'"
'      With CN.Execute(sSql)
       With RsBodySerial
