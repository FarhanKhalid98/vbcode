...
Set oConnection = goPackage.Connections.New("DTSFlatFile")
        ...
        oConnection.ConnectionProperties("Data Source") = App.Path & "\database\" & FileName & ".txt"
        ...
        oConnection.Reusable = True
        oConnection.ConnectImmediate = False
        oConnection.DataSource = App.Path & "\database\" & FileName & ".txt"
        oConnection.ConnectionTimeout = 60
...
Set oStep = goPackage.Steps.New
        ...
        oStep.Name = "Copy Data from Activity to " & App.Path & "\database\" & FileName & ".txt Step"
        oStep.Description = "Copy Data from Activity to " & App.Path & "\database\" & FileName & ".txt Step"
        oStep.ExecutionStatus = 1
        oStep.TaskName = "Copied data in table " & App.Path & "\database\" & FileName & ".txt"
...
Set oCustomTask1 = oTask.CustomTask
        ...
        oCustomTask1.Name = "Copied data in table " & App.Path & "\database\" & FileName & ".txt"
        oCustomTask1.Description = "Copied data in table " & App.Path & "\database\" & FileName & ".txt"
        ...
        oCustomTask1.DestinationObjectName = App.Path & "\database\" & FileName & ".txt"
