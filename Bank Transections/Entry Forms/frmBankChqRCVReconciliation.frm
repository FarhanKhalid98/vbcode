...
Begin VB.Form frmBankChqRCVReconciliation 
   AutoRedraw      =   -1  'True
   BorderStyle     =   0  'None
   ClientHeight    =   9000
   ClientLeft      =   15
   ...
   Icon            =   "frmBankChqRCVReconciliation.frx":0000
   KeyPreview      =   -1  'True
   LockControls    =   -1  'True
   MinButton       =   0   'False
   Picture         =   "frmBankChqRCVReconciliation.frx":0ECA
   ScaleHeight     =   600
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   799
   ...
   Begin JeweledBut.JeweledButton btnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmBankChqRCVReconciliation.frx":783B
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton btnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmBankChqRCVReconciliation.frx":7857
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton btnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmBankChqRCVReconciliation.frx":7873
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton btnOpen 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmBankChqRCVReconciliation.frx":788F
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton btndelete 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "frmBankChqRCVReconciliation.frx":78AB
      BC              =   14737632
      FC              =   0
   End
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "frmBankChqRCVReconciliation.frx":78C7
      ...
      BeginProperty stylesets(1).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(1).Picture=   "frmBankChqRCVReconciliation.frx":78E3
      ...
      BeginProperty stylesets(2).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(2).Picture=   "frmBankChqRCVReconciliation.frx":78FF
      MultiLine       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmBankChqRCVReconciliation"
...
Private Sub PopulateDataToGrid()
   On Error GoTo ErrorHandler
   If RsBody.State = adStateOpen Then RsBody.Close
   RsBody.Open "select * from BankChqRCVBody where ActChequeDate Between ' " & dtpFromDate.DateValue & " ' and  '" & DtpToDate.DateValue & "'", CN, adOpenStatic, adLockBatchOptimistic
   If RsBody.RecordCount > 0 Then
      sSql = "Select  B.* From BankChqRCVBody B  Inner Join BankChqRCVHeader H on B.VoucherID = H.VoucherID Where ActChequeDate Between  '" & dtpFromDate.DateValue & "' And '" & DtpToDate.DateValue & "'"
