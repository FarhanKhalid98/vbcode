...
Begin VB.Form FrmCustomerOrder 
   ...
   Begin VB.Frame FraHelp 
      ...
      Begin VB.TextBox Text1 
         ...
         TabIndex        =   26
         Tag             =   "NC"
         Text            =   "FrmCustomerOrder.frx":0ECA
         Top             =   360
         Width           =   3975
      End
   ...
   Begin JeweledBut.JeweledButton BtnDelete 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomerOrder.frx":0FAA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomerOrder.frx":0FC6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnOpen 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomerOrder.frx":0FE2
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomerOrder.frx":0FFE
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomerOrder.frx":101A
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnOrderProduct 
      Height          =   330
      Left            =   1515
      TabIndex        =   14
      TabStop         =   0   'False
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomerOrder.frx":1036
      BC              =   12632256
      FC              =   0
   End
   Begin SITextBox.Txt TxtOrderProductName 
      Height          =   315
      Left            =   1875
      TabIndex        =   15
      Top             =   2985
      ...
      Masked          =   5
   End
   Begin SITextBox.Txt TxtOrderProductCode 
      Height          =   315
      Left            =   75
      TabIndex        =   5
      Top             =   2985
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmCustomerOrder.frx":1052
      AllowUpdate     =   0   'False
      ...
      Columns(1).Name =   "OrderProductName"
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid GridDetail 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmCustomerOrder.frx":106E
      ...
      BeginProperty stylesets(1).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(1).Picture=   "FrmCustomerOrder.frx":108A
      ...
      BeginProperty stylesets(2).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(2).Picture=   "FrmCustomerOrder.frx":10A6
      MultiLine       =   0   'False
...
'-----------------------
Private Sub BtnOrderProduct_Click()
   If FunSelectOrderProduct(ssButton, True) = True Then
      TxtQty.SetFocus
   Else
      TxtOrderProductCode.SetFocus
   End If
End Sub

Private Function FunSelectOrderProduct(ByVal CallerName As SelectAccountCaller, ByVal IsOptional As Boolean) As Boolean
   On Error GoTo ErrorHandler
   Dim vStrSQL As String
   If CallerName = ssButton Or CallerName = ssFunctionKey Then
      SchOrderProduct.Show vbModal, Me
      If SchOrderProduct.ParaOutCode = "" Then FunSelectOrderProduct = False: Exit Function
      TxtOrderProductCode.Text = SchOrderProduct.ParaOutCode
   End If
    '---------------------------
    vStrSQL = "select * from CustomProductsMeasurements where depth = 1 and " & vbCrLf _
            + " ID = '" & TxtOrderProductCode.Text & "'"
            
   With CN.Execute(vStrSQL)
      If .RecordCount > 0 Then
         TxtOrderProductName.Text = !Name
         FunSelectOrderProduct = True
         .Close
         If BtnSave.Enabled = False Then FormStatus = ChangeMode
      Else
         FunSelectOrderProduct = False
         .Close
         TxtOrderProductCode.Text = ""
...
'   If FunSelectOrderProduct = True Then
...
'         + " WHERE OrderProductCode = '" & TxtAreaCode.Text & " " & TxtOrderProductCode.Text & "'"
'
'      With CN.Execute(vStrSQL)
'         If .RecordCount > 0 Then
'            While Not .EOF
...
Private Sub BtnOpen_Click()
   SchCustomerOrder.Show vbModal, Me
   If SchCustomerOrder.ParaOutOrderID <> 0 Then
      TxtOrderID.Text = SchCustomerOrder.ParaOutOrderID
      GetPrevious
   End If
End Sub
...
Private Sub GetPrevious()
   On Error GoTo ErrorHandler
   vStrSQL = " Select * from CustomerOrderHeader" & _
...
'   End If
   ...
   If TxtOrderID.Enabled Then
      If CN.Execute("Select * from CustomerOrderHeader where OrderId = " & Val(TxtOrderID.Text)).RecordCount > 0 Then
  ...
  'Saving record
   ...
   CN.BeginTrans
   vStrSQL = "select * from CustomerOrderHeader where OrderId=" & Val(TxtOrderID.Text)
   With Rs
      ...
      End If
         ...
         !CustomerName = IIf(Trim(TxtCustomerName.Text) = "", Null, TxtCustomerName.Text)
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Customer Order"
   HelpLocation Me
...
Private Property Let FormStatus(ByVal vNewValue As FormMode)
   'Based upon the value of vNewValue, we shall deOrderProductCodee what controls to enable/disable
   On Error GoTo ErrorHandler
   vMode = vNewValue
   ...
   Case Is = NewMode
      ...
      TxtOrderID.Text = FunGetMaxID
      'DtpDate.Value = Date
      TxtOrderProductCode.Enabled = True
   ...
   Case Is = OpenMode
      ...
      BtnClear.Enabled = True
      BtnSave.Enabled = False
      If TxtOrderProductCode.Enabled And TxtOrderProductCode.Visible Then TxtOrderProductCode.SetFocus
      vIsNewRecord = False
      vIsNewRow = True
   Case Is = ChangeMode
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
   ...
   If KeyCode = vbKeyEscape Then
      ...
      Select Case ActiveControl.Name
         Case TxtOrderProductCode.Name, TxtQty.Name, TxtPrice.Name
         If TxtOrderProductCode.Enabled Then TxtOrderProductCode.SetFocus: Call SubClearDetailArea
      End Select
...
'         GetDataFromTexBoxesToGrid
   ...
   ElseIf KeyCode = vbKeyF1 Then
      Select Case ActiveControl.Name
         Case TxtOrderProductCode.Name: If FunSelectOrderProduct(ssFunctionKey, False) = True Then TxtQty.SetFocus
      End Select
   ElseIf ActiveControl.Name = TxtOrderProductCode.Name Then
      If KeyCode = vbKeyDown Then
         Grid.SetFocus
      ElseIf KeyCode = vbKeyF12 And Me.ActiveControl.Name = TxtOrderProductCode.Name Then
         KeyCode = 0
         TxtAdvance.SetFocus
      End If
   End If
...
Private Sub PopulateGridDetail()
   ...
   With CN.Execute(vSQL)
      While Not .EOF
         ...
         RsDetails.Filter = " OrderProductCode = '" & Grid.Columns("Code").Text & "' and ID = '" & !ID & "'"
...
Private Sub PopulateDataToGrid()
   RsBody.Filter = 0
   If RsBody.State = adStateOpen Then RsBody.Close
   RsBody.Open "Select * from CustomerOrderBody where OrderId=" & Val(TxtOrderID.Text), CN, adOpenStatic, adLockBatchOptimistic
   If RsBody.RecordCount > 0 Then
      vStrSQL = "select b.*, Name from CustomerOrderBody b join CustomProductsMeasurements p on p.ID = b.OrderProductCode where OrderId=" & Val(TxtOrderID.Text)
      With CN.Execute(vStrSQL)
         Grid.Redraw = False
         Grid.MoveFirst
         Grid.RemoveAll
         ...
         While Not .EOF
            Grid.AddNew
            Grid.Columns("Code").Text = !OrderProductCode
            Grid.Columns("OrderProductName").Text = !Name
   ...
   RsDetails.Open "Select * from CustomerOrderDetail where OrderId=" & Val(TxtOrderID.Text), CN, adOpenStatic, adLockBatchOptimistic
End Sub

Private Sub GetDataFromTexBoxesToGrid()
   'GridDetail.Visible = False
   If Trim(TxtOrderProductCode.Text) = "" Then
   ...
   End If
On Error GoTo ErrorHandler
   RsBody.Filter = "OrderProductCode='" & TxtOrderProductCode.Text & "'"
   If vIsNewRow Then
      If RsBody.RecordCount = 0 Then
         RsBody.AddNew
         Grid.Columns("Code").Text = TxtOrderProductCode.Text
         RsBody!OrderProductCode = TxtOrderProductCode.Text
      Else
         MsgBox "This Product Already Exists.", vbOKOnly + vbInformation, "Alert"
         If TxtOrderProductCode.Visible And TxtOrderProductCode.Enabled Then TxtOrderProductCode.SetFocus
         Exit Sub
      End If
   End If
...
'      RsDetails.Filter = "OrderProductCode = '" & TxtOrderProductCode.Text & "' and ProductID = " & GridDetail.Columns("ID").CellValue(GridDetail.GetBookmark(i))
'      If RsDetails.RecordCount = 0 Then RsDetails.AddNew
'      RsDetails!OrderProductCode = TxtOrderProductCode.Text
...
'
   Grid.Redraw = False
   With Grid
      If TxtOrderProductCode.Enabled = True Then
      ...
      End If
      .Columns("OrderProductName").Text = TxtOrderProductName.Text
...
Private Sub SubDetailUpdate()
   On Error GoTo ErrorHandler
   RsDetails.Filter = "OrderProductCode='" & IIf(Grid.Rows = 1, "", RsBody!OrderProductCode) & "' and ID='" & GridDetail.Columns("ID").Text & "'"
   If RsDetails.RecordCount = 0 And GridDetail.Columns("Value").Text <> "" Then
      RsDetails.AddNew
      RsDetails!OrderProductCode = RsBody!OrderProductCode
...
Private Sub TxtPrice_LostFocus()
   Select Case ActiveControl.Name
   Case TxtOrderProductCode.Name, TxtPrice.Name, TxtQty.Name
      Exit Sub
   End Select
...
Private Function FunGetMaxID() As Long
   On Error GoTo ErrorHandler
   FunGetMaxID = CN.Execute("Select isnull(max(OrderID),0) from CustomerOrderHeader").Fields(0) + 1
   Exit Function
ErrorHandler:
   Call ShowErrorMessage
End Function
...
Private Sub Grid_GotFocus()
   Flag = True
   TxtOrderProductCode.Enabled = False
...
'      RsDetails.Filter = "OrderProductCode='" & Grid.Columns("Code").Text & "'"
...
'   End If
   If ActiveControl.Name = Grid.Name Then
      ...
      If RsBody.RecordCount > 0 Then
         ...
         Grid.Refresh
         RsBody.Filter = 0
         RsDetails.Filter = "OrderProductCode='" & TxtOrderProductCode.Text & "'"
         If RsDetails.RecordCount > 0 Then RsDetails.Delete
      End If
   End If
...
Private Sub GetDataBackFromGridToTexBoxes()
   On Error GoTo ErrorHandler
   With Grid
      TxtOrderProductCode.Text = .Columns("Code").Text
      TxtOrderProductName.Text = .Columns("OrderProductName").Text
...
'      If Trim(Grid.Columns("OrderProductCode").Text) <> "" Then
'         CN.Execute "Update inscustomerheader set TotalAmount=" & Grid.Columns("TotalAmount").Value & " where OrderProductCode='" & Grid.Columns("OrderProductCode").Text & "'"
'      End If
'      Grid.MoveNext
'   Next vCounter
'   Grid.RemoveAll
'   Grid.Redraw = True
   CN.Execute "Delete from CustomerOrderDetail where OrderId = " & Val(TxtOrderID.Text)
   CN.Execute "Delete from CustomerOrderBody where OrderId = " & Val(TxtOrderID.Text)
   CN.Execute "Delete from CustomerOrderHeader where OrderId = " & Val(TxtOrderID.Text)
   CN.CommitTrans
   FormStatus = NewMode
   Exit Sub
ErrorHandler:
...
Private Sub TxtOrderProductCode_Change()
   If TxtOrderProductCode.Visible = False Then Exit Sub
   If ActiveControl.Name <> TxtOrderProductCode.Name Then Exit Sub
   If TxtOrderProductName.Text <> "" Then TxtOrderProductName.Text = ""
End Sub

Private Sub TxtOrderProductCode_LostFocus()
   TxtOrderProductCode.Text = StrConv(TxtOrderProductCode.Text, vbUpperCase)
End Sub

Private Sub TxtOrderProductCode_Validate(Cancel As Boolean)
    On Error GoTo ErrorHandler
    If Me.ActiveControl.Name <> TxtOrderProductCode.Name Then Exit Sub
    If Trim(TxtOrderProductCode.Text) = "" Then Exit Sub
    Dim vTemp As Boolean
    vTemp = Not FunSelectOrderProduct(ssValidate, True)
    If vTemp = True Then
        vTemp = Not FunSelectOrderProduct(ssButton, False)
    End If
    Cancel = vTemp
Exit Sub
ErrorHandler:
...
Private Sub TxtOrderProductCode_KeyDown(KeyCode As Integer, Shift As Integer)
