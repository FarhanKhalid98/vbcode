...
Begin VB.Form RptProductNotInPurchase 
   AutoRedraw      =   -1  'True
   ...
   ClientTop       =   375
   ClientWidth     =   15360
   Icon            =   "RptProductNotInPurchase.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   742
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductNotInPurchase.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductNotInPurchase.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductNotInPurchase.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductNotInPurchase.frx":0F1E
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin VB.Label LblCaption 
      ...
      Caption         =   "Product Not in Purchase "
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   13.5
         Charset         =   178
   ...
   End
End
Attribute VB_Name = "RptProductNotInPurchase"
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Products Not In Purchase"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   For Each frmObj In Forms
       Set frmObj = Nothing
   Next
   Set RptProductNotInPurchase = Nothing
   Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
...
Private Function SetReport() As Boolean
    ...
    vSQL = " Select p.ProductID, ProductName " & vbCrLf _
            + " From (select * from PurchaseHeader where PurchaseDate between '" & DtpFrom.DateValue & "' and '" & DtpTo.DateValue & "')h inner Join PurchaseBody b on h.PurID = b.PurID and h.PurchaseDate = b.PurchaseDate" & vbCrLf _
            + " Right Outer Join Products p on p.ProductID = b.ProductID" & vbCrLf _
            + " where b.ProductID is null " & IIf(Trim(TxtProductID.Text) = "", "", " and p.ProductID = '" & TxtProductID.Text & "'")
            
    Set RsReport = CN.Execute(vSQL)
    Set RptReportViewer.Report = New CRptProductsNotInPurchase
    If RsReport.BOF Then
        MsgBox "No record exists.", vbInformation, Me.Caption
        Me.MousePointer = vbDefault
        Exit Function
    End If
    RptReportViewer.Report.ReportTitle = "Products Not In Purchase"
