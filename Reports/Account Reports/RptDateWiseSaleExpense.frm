...
Begin VB.Form RptDateWiseSaleExpense 
   AutoRedraw      =   -1  'True
   ...
   ClientWidth     =   12000
   ControlBox      =   0   'False
   Icon            =   "RptDateWiseSaleExpense.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDateWiseSaleExpense.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDateWiseSaleExpense.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDateWiseSaleExpense.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "RptDateWiseSaleExpense"
...
Private Sub Form_Load()
    ShowPicture Me
    SetWindowText Me.hWnd, "Date Wise Sale And Expense"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   For Each frmObj In Forms
       Set frmObj = Nothing
   Next
   Set RptDateWiseSaleExpense = Nothing
   Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
