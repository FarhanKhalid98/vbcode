...
Begin VB.Form SchActReceiving 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchActReceiving.frx":0000
      AllowAddNew     =   -1  'True
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
      ...
      Columns(0).Caption=   "Account Receiving ID"
      Columns(0).Name =   "ID"
      Columns(0).DataField=   "Column 0"
      Columns(0).DataType=   8
      Columns(0).FieldLen=   256
      Columns(1).Width=   3519
      Columns(1).Caption=   "Account Receiving Name"
      Columns(1).Name =   "Name"
   ...
   Begin JeweledBut.JeweledButton CmdSelect 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchActReceiving.frx":001C
      BC              =   16777215
      FC              =   0
   End
   Begin JeweledBut.JeweledButton CmdClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchActReceiving.frx":0038
      BC              =   16777215
      FC              =   0
   End
   ...
   Begin VB.Label Label9 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Account Receiving Name"
      Height          =   195
      Left            =   3945
      TabIndex        =   2
      Top             =   1238
   ...
   End
End
Attribute VB_Name = "SchActReceiving"
