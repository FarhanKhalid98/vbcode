...
Begin VB.Form SchPendingPurchase 
   AutoRedraw      =   -1  'True
   BorderStyle     =   0  'None
   ClientHeight    =   9000
   ClientLeft      =   0
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchPendingPurchase.frx":0000
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnSelect 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchPendingPurchase.frx":001C
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchPendingPurchase.frx":0038
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "SchPendingPurchase"
...
Private Sub LoadGrid()
   ...
   vStrSQL = "SELECT h.PurID as ID, h.PurchaseDate as Date" & vbCrLf _
         ...
         + " (SELECT PurID, PurchaseDate, sum((isnull(qtypack,0)*isnull(multiplier,0))+ qtyloose + bonus) as TotalItems FROM PurchasePendingBody GROUP BY PurID, PurchaseDate) b" & vbCrLf _
         ...
         + " WHERE h.purchaseDate ='" & DtpDate.DateValue & "'" & IIf(ObjUserSecurity.IsAdministrator = False, " and h.userno=" & ObjUserSecurity.UserNo, "") & vOrder & vDirection
