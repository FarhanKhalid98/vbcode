...
Begin VB.Form FrmConsumptionReturnProducts 
   ...
   ClientWidth     =   12000
   ControlBox      =   0   'False
   Icon            =   "FrmConsumptionReturnProducts.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.Frame FraHelp 
      ...
      Begin VB.TextBox Text1 
         ...
         TabIndex        =   32
         Tag             =   "NC"
         Text            =   "FrmConsumptionReturnProducts.frx":0ECA
         Top             =   360
         Width           =   3975
      End
   ...
   Begin JeweledBut.JeweledButton BtnDelete 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmConsumptionReturnProducts.frx":0FAA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmConsumptionReturnProducts.frx":0FC6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnOpen 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmConsumptionReturnProducts.frx":0FE2
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmConsumptionReturnProducts.frx":0FFE
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmConsumptionReturnProducts.frx":101A
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnManufacturedProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmConsumptionReturnProducts.frx":1036
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmConsumptionReturnProducts.frx":1052
      AllowUpdate     =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnStore 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmConsumptionReturnProducts.frx":106E
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnUsedProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmConsumptionReturnProducts.frx":108A
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid GridUsed 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmConsumptionReturnProducts.frx":10A6
      AllowUpdate     =   0   'False
      AllowRowSizing  =   0   'False
      AllowGroupSizing=   0   'False
      AllowColumnSizing=   0   'False
   ...
   End
End
Attribute VB_Name = "FrmConsumptionReturnProducts"
...
Private Sub BtnDelete_Click()
   ...
   For vCounter = 1 To Grid.Rows
      If Trim(Grid.Columns("ProductID").Text) <> "" Then
         CN.Execute "Delete from ConsumptionReturnBody where ReturnID=" & Val(TxtReturnID.Text) & " and ProductID='" & Grid.Columns("Productid").Text & "'"
      End If
      Grid.MoveNext
   Next vCounter
   Grid.RemoveAll
...
'   'Products Used
   ...
   For vCounter = 1 To GridUsed.Rows
      If Trim(GridUsed.Columns("ProductID").Text) <> "" Then
         CN.Execute "Delete from ConsumptionReturnUsed where ReturnID=" & Val(TxtReturnID.Text) & " and ProductID='" & GridUsed.Columns("Productid").Text & "'"
      End If
      GridUsed.MoveNext
   Next vCounter
   GridUsed.RemoveAll
   ...
   CN.Execute "Delete from ConsumptionReturnHeader where ReturnID= " & (TxtReturnID.Text)
   CN.CommitTrans
   FormStatus = NewMode
   Exit Sub
ErrorHandler:
...
Private Sub BtnOpen_Click()
   SchConsumptionReturn.Show vbModal
   If SchConsumptionReturn.ParaOutReturnID = 0 Then Exit Sub
   TxtReturnID.Text = SchConsumptionReturn.ParaOutReturnID
   GetConsumptionReturn
End Sub
...
'  Header Validation
   ...
   If vIsNewRecord = True Then
      If CN.Execute("select * from ConsumptionReturnHeader where ReturnID=" & TxtReturnID.Text).RecordCount > 0 Then
...
'   With CN.Execute("Select * from ConsumptionReturnUsed where ReturnID=" & Val(TxtReturnID.Text))
'      While Not .EOF
'         CN.Execute "Delete from ConsumptionReturnUsed where ReturnID=" & !ReturnID & " and ProductID='" & !ProductID & "'"
'         .MoveNext
'      Wend
'      .Close
'   End With
   If vIsNewRecord = False Then Call ActivityLog("Manufactured Products", eEdit, TxtReturnID.Text)
   sSql = "select * from ConsumptionReturnHeader where ReturnID=" & Val(TxtReturnID.Text)
...
Private Sub PopulateDataToGrid()
   ...
   RsBody.Open "Select * from ConsumptionReturnBody where ReturnID=" & Val(TxtReturnID.Text), CN, adOpenStatic, adLockBatchOptimistic
   If RsBody.RecordCount > 0 Then
      sSql = "select p.productname, code, b.* from ConsumptionReturnBody b join products p on p.productid = b.productid where ReturnID=" & Val(TxtReturnID.Text)
...
Private Sub PopulateDataToUsed()
   ...
   RsUsedBody.Open "Select * from ConsumptionReturnUsed where ReturnID=" & Val(TxtReturnID.Text), CN, adOpenStatic, adLockBatchOptimistic
   If RsUsedBody.RecordCount > 0 Then
      sSql = "select p.productname,  u.* from ConsumptionReturnUsed u join products p on p.productid = u.productid where ReturnID=" & Val(TxtReturnID.Text)
      With CN.Execute(sSql)
         GridUsed.Redraw = False
         GridUsed.MoveFirst
         GridUsed.RemoveAll
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   Else
    ...
    Set RsBody = Nothing
    Set RsBody = Nothing
    Set FrmConsumptionReturnProducts = Nothing
   End If
   Exit Sub
ErrorHandler:
   Call ShowErrorMessage
...
Private Sub GetConsumptionReturn()
   On Error GoTo ErrorHandler
   sSql = "select ReturnID, ReturnDate, h.StoreID, StoreName FROM ConsumptionReturnHeader h join Stores s on h.storeid = s.storeid where ReturnID=" & Val(TxtReturnID.Text)
   With CN.Execute(sSql)
      If Not .BOF Then
...
Private Function FunGetMaxID() As Long
   On Error GoTo ErrorHandler
   FunGetMaxID = CN.Execute("Select isnull(max(ReturnID),0)+1 from ConsumptionReturnHeader").Fields(0)
   Exit Function
ErrorHandler:
   Call ShowErrorMessage
End Function
