...
Begin VB.Form RptProductNotIncludedList 
   AutoRedraw      =   -1  'True
   ...
   ClientWidth     =   12000
   ControlBox      =   0   'False
   Icon            =   "RptStockAdjustment.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.OptionButton OptExclude 
         ...
         Left            =   150
         TabIndex        =   28
         ToolTipText     =   $"RptStockAdjustment.frx":0ECA
         Top             =   630
         Width           =   3420
      End
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptStockAdjustment.frx":0F53
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptStockAdjustment.frx":0F6F
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptStockAdjustment.frx":0F8B
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptStockAdjustment.frx":0FA7
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptStockAdjustment.frx":0FC3
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSubGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptStockAdjustment.frx":0FDF
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnCompany 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptStockAdjustment.frx":0FFB
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "RptProductNotIncludedList"
...
Private Sub BtnPreview_Click()
   If SetReport Then
       RptReportViewer.Caption = "Stock Adjustment Report"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   Set RptStockAdjustment = Nothing
Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
...
Private Function SetReport() As Boolean
    ...
    Set RsReport = CN.Execute("EXEC ProdRptStockAdjustment " & IIf(OptExclude.Value = True, "0,0", "1,99999") & "," & IIf(Trim(TxtProductID.Text) = "", "Null", "'" & TxtProductID.Text & "'") & "," & IIf(Trim(TxtGroupID.Text) = "", "Null", "'" & TxtGroupID.Text & "'") & "," & IIf(Trim(TxtSubGroupID.Text) = "", "Null", "'" & TxtSubGroupID.Text & "'") & "," & IIf(Trim(TxtCompanyID.Text) = "", "Null", "'" & TxtCompanyID.Text & "'"))
    Set RptReportViewer.Report = New CryRptStockAdjustment
    If RsReport.BOF Then
        MsgBox "No record exists.", vbInformation, Me.Caption
        Me.MousePointer = vbDefault
        Exit Function
    End If
    RptReportViewer.Report.ReportTitle = "Stock Adjustment"
    ...
    .Close
    End With
    'RptReportViewer.Report.ParameterFields(4).AddCurrentValue IIf(OptExclude.Value = True, "Products exclude from Stock Adjustments", "Products include in Stock Adjustments")
