...
Begin VB.Form SchDepositBy 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchDepositBy.frx":0000
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
   ...
   End
End
Attribute VB_Name = "SchDepositBy"
...
Private Sub LoadData()
   VStrSQL = "SELECT Distinct DepositBy FROM BankCashDepositBody " & vOrder & vDirection
