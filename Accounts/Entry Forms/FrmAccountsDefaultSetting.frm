...
Begin VB.Form FrmAccountsDefaultSetting 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   11130
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   15360
   Icon            =   "FrmAccountsDefaultSetting.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   742
   ...
   Begin VB.Frame FraHelp 
      ...
      Begin VB.TextBox Text1 
         ...
         TabIndex        =   6
         Tag             =   "NC"
         Text            =   "FrmAccountsDefaultSetting.frx":0ECA
         Top             =   360
         Width           =   3930
      End
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmAccountsDefaultSetting.frx":0F1C
      BC              =   14737632
      FC              =   0
   End
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmAccountsDefaultSetting.frx":0F38
      MultiLine       =   0   'False
      ...
      Columns(1).Caption=   "Default Account No"
   ...
   Begin JeweledBut.JeweledButton BtnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmAccountsDefaultSetting.frx":0F54
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmAccountsDefaultSetting.frx":0F70
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "FrmAccountsDefaultSetting"
...
Private Sub cmbfilter_click()
  ...
  Rs.Open "Select * FROM Defaultvalues", CN, adOpenDynamic, adLockBatchOptimistic
  Grid.Redraw = False
  Grid.CancelUpdate
  Grid.RemoveAll
  ...
  Do Until Rs.EOF
    Grid.AddNew
    Grid.Columns("Key").Text = Rs!Key
    Grid.Columns("Value").Text = Rs!Value
    Grid.Update
    Rs.MoveNext
  Loop
...
Private Sub Form_Load()
  ...
  SetWindowText Me.hWnd, "Accounts Default Setting"
  HelpLocation Me
  cmbfilter_click
  Exit Sub
ErrorHandler:
