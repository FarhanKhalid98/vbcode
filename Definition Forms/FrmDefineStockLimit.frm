...
Begin VB.Form FrmDefineStockLimit 
   AutoRedraw      =   -1  'True
   ...
   ClientTop       =   375
   ClientWidth     =   15360
   Icon            =   "FrmDefineStockLimit.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   742
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "FrmDefineStockLimit.frx":0ECA
      ...
      BeginProperty stylesets(1).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(1).Picture=   "FrmDefineStockLimit.frx":0EE6
      MultiLine       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmDefineStockLimit.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmDefineStockLimit.frx":0F1E
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmDefineStockLimit.frx":0F3A
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnApply 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmDefineStockLimit.frx":0F56
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnFilter 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmDefineStockLimit.frx":0F72
      BC              =   12632256
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "FrmDefineStockLimit"
...
Abc:
  ...
  vSuppressUpdateEvent = True
    ssql = "Select p.ProductID, ProductName, isnull(prodSale.SaleQty,0) as SaleQty, RetailPrice, isnull(MaxStockLimit,0) MaxStockLimit, isnull(MinSTockLimit,0) as MinSTockLimit, GroupID, CompanyID, SubgroupID From " & vbCrLf _
        + " ( " & vbCrLf _
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Define Stock Limit"
...
Private Sub Form_Unload(Cancel As Integer)
   On Error GoTo ErrorHandler
      Set FrmDefineStockLimit = Nothing
   Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
