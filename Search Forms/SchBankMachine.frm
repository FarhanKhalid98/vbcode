...
Begin VB.Form SchBankMachine 
   ...
   Begin VB.TextBox TxtBankMachineID 
      ...
      Width           =   1660
   End
   Begin VB.TextBox TxtBankMachineName 
      Appearance      =   0  'Flat
      BackColor       =   &H00FFFFFF&
      Height          =   330
      Left            =   5786
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchBankMachine.frx":0000
      AllowUpdate     =   0   'False
...
Private Sub LoadGrid()
   vStrSQL = " Select *" & _
         " FROM BankMachines" & vOrder & vDirection
