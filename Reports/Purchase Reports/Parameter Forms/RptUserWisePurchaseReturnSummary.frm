...
Begin VB.Form RptUserWisePurchaseReturnSummary 
   AutoRedraw      =   -1  'True
   ...
   ClientWidth     =   12000
   ControlBox      =   0   'False
   Icon            =   "RptUserWisePurchaseReturnSummary.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptUserWisePurchaseReturnSummary.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptUserWisePurchaseReturnSummary.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptUserWisePurchaseReturnSummary.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin VB.Label Label7 
      ...
      Caption         =   "Purchase Return Summary (User Wise)"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   12
         Charset         =   178
   ...
   End
End
Attribute VB_Name = "RptUserWisePurchaseReturnSummary"
...
Private Sub Form_Load()
   On Error GoTo ErrorHandler
   ShowPicture Me
   SetWindowText Me.hWnd, "Purchase Return Summary (User Wise)"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   For Each frmObj In Forms
       Set frmObj = Nothing
   Next
   Set RptUserWisePurchaseReturnSummary = Nothing
Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
...
Private Function SetReport() As Boolean
   ...
   Set RsReport = CN.Execute("EXEC ProdRptUserWisePurchaseReturnSummary '" & DtpFrom.DateValue & "','" & DtpTo.DateValue & "','" & IIf(ObjUserSecurity.IsAdministrator = False, IIf(CmbUsers.ListCount > 0, CmbUsers.ItemData(CmbUsers.ListIndex), ""), IIf(CmbUsers.ListIndex > 0, CmbUsers.ItemData(CmbUsers.ListIndex), "")) & "'")
   Set RptReportViewer.Report = New CrptUserWisePurchaseReturnSummary
