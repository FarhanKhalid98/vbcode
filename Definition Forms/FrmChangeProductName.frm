...
Begin VB.Form FrmChangeProductName 
   AutoRedraw      =   -1  'True
   ...
   ClientTop       =   375
   ClientWidth     =   15420
   Icon            =   "FrmChangeProductName.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnFilter 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmChangeProductName.frx":0ECA
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmChangeProductName.frx":0EE6
      ...
      BeginProperty stylesets(1).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(1).Picture=   "FrmChangeProductName.frx":0F02
      MultiLine       =   0   'False
      ...
      Columns(3).Caption=   "Disc/PC"
      Columns(3).Name =   "DiscPC"
   ...
   Begin JeweledBut.JeweledButton BtnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmChangeProductName.frx":0F1E
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmChangeProductName.frx":0F3A
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmChangeProductName.frx":0F56
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "FrmChangeProductName"
...
Abc:
  ...
  ssql = "Select distinct p.ProductID, ProductName, RetailPrice, DiscPC FROM Products p left outer join ProductBarCodes b on p.productid = b.productid where 1=1 " & IIf(TxtProductID.Text = "", "", " and p.ProductID = " & Val(TxtProductID.Text) & " or Code = '" & Val(TxtProductID.Text) & "'") & IIf(Trim(TxtProductName.Text) = "", "", " and ProductName like '%" & TxtProductName.Text & "%'")
  Rs.Open ssql, cn, adOpenStatic, adLockBatchOptimistic
  Grid.Redraw = False
  Grid.CancelUpdate
  Grid.RemoveAll
  vSuppressUpdateEvent = True
  ssql = "SELECT distinct p.ProductID, ProductName, RetailPrice, DiscPC FROM Products p left outer join ProductBarCodes b on p.productid = b.productid where 1=1 " & IIf(TxtProductID.Text = "", "", " and p.ProductID = " & Val(TxtProductID.Text) & " or Code = '" & Val(TxtProductID.Text) & "'") & IIf(Trim(TxtProductName.Text) = "", "", " and ProductName like '%" & TxtProductName.Text & "%'") & " Order by p.ProductID --ProductName"
...
Private Sub BtnSave_Click()
   ...
   While Not Rs.EOF
      If Rs.EditMode <> adEditNone Then
         Call ActivityLog("Change Product Name", eEdit, , , Rs!Productid)
      End If
      Rs.MoveNext
   Wend
   Rs.UpdateBatch
