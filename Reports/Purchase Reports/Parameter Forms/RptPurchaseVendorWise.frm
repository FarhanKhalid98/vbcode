...
Begin VB.Form RptPurchaseVendorWise 
   AutoRedraw      =   -1  'True
   ...
   ClientWidth     =   12000
   ControlBox      =   0   'False
   Icon            =   "RptPurchaseVendorWise.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptPurchaseVendorWise.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptPurchaseVendorWise.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptPurchaseVendorWise.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptPurchaseVendorWise.frx":0F1E
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnStore 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptPurchaseVendorWise.frx":0F3A
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptPurchaseVendorWise.frx":0F56
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnVendor 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptPurchaseVendorWise.frx":0F72
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "RptPurchaseVendorWise"
...
Private Sub BtnPreview_Click()
   If SetReport Then
       If RdoDetail.Value = True Then RptReportViewer.Caption = "Purchase Detail (Vendor Wise)" Else RptReportViewer.Caption = "Purchase Summary (Vendor Wise)"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   Set RptPurchaseVendorWise = Nothing
Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
...
'    sSQL = "EXEC ProdRptSaleRegister '" & DtpFrom.DateValue & "','" & DtpTo.DateValue & "'," & IIf(Trim(TxtOrganizationID.Text) = "", "Null", "'" & TxtOrganizationID.Text & "'") & "," & IIf(Trim(TxtStoreID.Text) = "", "Null", "'" & TxtStoreID.Text & "'") & "," & IIf(Trim(TxtPartyID.Text) = "", "Null", "'" & TxtPartyID.Text & "'") & "," & IIf(Trim(TxtProductID.Text) = "", "Null", "'" & TxtProductID.Text & "'") & "," & IIf(RdoBoth.Value = True, "Null", IIf(RdoInv.Value = True, 0, 1))
    ...
    End If
    If RdoDetail.Value = True Then Set RptReportViewer.Report = New CrptPurchaseVendorWise Else Set RptReportViewer.Report = New CrptPurchaseVendorSummary
    If RsReport.BOF Then
        MsgBox "No record exists.", vbInformation, Me.Caption
        Me.MousePointer = vbDefault
        Exit Function
    End If
    If RdoDetail.Value = True Then RptReportViewer.Report.ReportTitle = "Purchase Detail (Vendor Wise)"
