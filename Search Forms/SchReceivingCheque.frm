...
Begin VB.Form SchReceivingCheque 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00B98A03&
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchReceivingCheque.frx":0000
      AllowAddNew     =   -1  'True
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
   ...
   Begin JeweledBut.JeweledButton CmdSelect 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchReceivingCheque.frx":001C
      BC              =   16777215
      FC              =   0
   End
   Begin JeweledBut.JeweledButton CmdClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchReceivingCheque.frx":0038
      BC              =   16777215
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "SchReceivingCheque"
...
Private Sub cmbfilter_click()
   ...
   End If
   Set Rs = CN.Execute("select ChequeNo, AccountName, Amount from BankChequeReceiveBody b left outer join ChartofAccounts c on c.AccountNo = ReceivingID" & vWhere)
...
Private Sub Form_Load()
   ...
   With CN.Execute("select ChequeNo from BankChequeReceiveBody")
      Do Until .EOF
