...
Begin VB.Form RptDailyActivity 
   AutoRedraw      =   -1  'True
   ...
   ClientTop       =   375
   ClientWidth     =   15360
   Icon            =   "RptDailyActivity.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   742
   ...
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDailyActivity.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDailyActivity.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDailyActivity.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnSearch 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDailyActivity.frx":0F1E
      BC              =   12632256
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDailyActivity.frx":0F3A
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "RptDailyActivity"
...
Private Function FunRefreshData() As Boolean
  On Error GoTo ErrorHandler
  Dim vSQL As String
  Set Rs = CN.Execute("EXECUTE SPDailyActivity " & IIf(Trim(TxtOrganizationID.Text) = "", "Null", "'" & TxtOrganizationID.Text & "'") & ",'" & DtpFrom.DateValue & "','" & DtpTo.DateValue & "'")
  FunRefreshData = True
  Exit Function
ErrorHandler:
  Call ShowErrorMessage
...
Private Sub Form_Load()
  ...
  SetWindowText Me.hWnd, "Daily Activity"
