...
Begin VB.Form FrmPurchaseDiscounts 
   AutoRedraw      =   -1  'True
   ...
   ClientTop       =   375
   ClientWidth     =   15360
   Icon            =   "FrmPurchaseDiscounts.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   742
   ...
   Begin JeweledBut.JeweledButton BtnFilter 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmPurchaseDiscounts.frx":0ECA
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmPurchaseDiscounts.frx":0EE6
      ...
      BeginProperty stylesets(1).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(1).Picture=   "FrmPurchaseDiscounts.frx":0F02
      MultiLine       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmPurchaseDiscounts.frx":0F1E
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmPurchaseDiscounts.frx":0F3A
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmPurchaseDiscounts.frx":0F56
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnApply 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmPurchaseDiscounts.frx":0F72
      BC              =   12632256
      FC              =   0
   End
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid GridC 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmPurchaseDiscounts.frx":0F8E
      stylesets(1).Name=   "SelectedRow"
      stylesets(1).ForeColor=   16777215
      stylesets(1).BackColor=   8388608
      stylesets(1).HasFont=   -1  'True
      BeginProperty stylesets(1).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(1).Picture=   "FrmPurchaseDiscounts.frx":0FAA
      MultiLine       =   0   'False
      ActiveCellStyleSet=   "SelectedCol"
      AllowRowSizing  =   0   'False
      AllowGroupSizing=   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnApplyC 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmPurchaseDiscounts.frx":0FC6
      BC              =   12632256
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "FrmPurchaseDiscounts"
...
Private Function FunSelectBrand() As Boolean
   On Error GoTo ErrorHandler
   SchBrand.Show vbModal, Me
   If SchBrand.ParaOutBrandID = "" Then FunSelectBrand = False: Exit Function
   FunSelectBrand = FindComboIndex(CmbBrand, SchBrand.ParaOutBrandID)
   Exit Function
ErrorHandler:
   Call ShowErrorMessage
End Function
...
Private Sub SubFilter()
   ssql = " SELECT p.ProductID, ProductName, PackingName, Multiplier, ListPrice, isnull(ppd.DiscPer,0) as DiscPer, isnull(ppd.DiscPack,0) as DiscPack" & vbCrLf _
      ...
      + " left outer join PurchaseProductDisc ppd on p.productid = ppd.productid " & vbCrLf _
...
Private Sub PopulateGrid()
   ...
   vSQL = "Select * FROM PurchaseProductDisc"
   Rs.Open vSQL, cn, adOpenDynamic, adLockBatchOptimistic
   Grid.Redraw = False
   Grid.CancelUpdate
   Grid.RemoveAll
...
Private Sub PopulateGridCC()
   ...
   End If
   Me.MousePointer = vbHourglass
   vSQL = "Select * FROM PurchaseCompanyDisc"
   RsC.Open vSQL, cn, adOpenDynamic, adLockBatchOptimistic
   GridC.Redraw = False
   GridC.CancelUpdate
   GridC.RemoveAll
   vSuppressUpdateEvent = True
   
   vSQL = " SELECT c.CompanyID, CompanyName, isnull(pcd.DiscPer,0) as DiscPer, isnull(pcd.DiscPack,0) as DiscPack" & vbCrLf _
      + " FROM Companies c " & vbCrLf _
      + " left outer join  PurchaseCompanyDisc pcd on c.CompanyID = pcd.CompanyID " & vbCrLf _
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Purchase Discounts"
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
   ...
   ElseIf KeyCode = vbKeyF1 Then
      Select Case ActiveControl.Name
         Case CmbBrand.Name: If FunSelectBrand() = True Then CmbBrand.SetFocus
...
Private Sub GridC_BeforeUpdate(Cancel As Integer)
   ...
   RsC.Filter = " CompanyID = " & Val(GridC.Columns("ID").Text)
