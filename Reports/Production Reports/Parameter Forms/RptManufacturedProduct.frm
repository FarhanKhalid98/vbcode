...
Begin VB.Form RptManufacturedProduct 
   AutoRedraw      =   -1  'True
   ...
   ClientTop       =   375
   ClientWidth     =   15360
   Icon            =   "RptManufacturedProduct.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   742
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptManufacturedProduct.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptManufacturedProduct.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptManufacturedProduct.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptManufacturedProduct.frx":0F1E
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnStore 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptManufacturedProduct.frx":0F3A
      BC              =   12632256
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "RptManufacturedProduct"
...
Private Function FunSelectProduct(ByVal CallerName As SelectAccountCaller, ByVal IsOptional As Boolean) As Boolean
   ...
   If CallerName = ssButton Or CallerName = ssFunctionKey Then
      ...
      If SchFinishedProduct.ParaOutID = "" Then FunSelectProduct = False: Exit Function
...
Private Sub BtnPreview_Click()
   If SetReport Then
       RptReportViewer.Caption = "Finished Product"
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Finished Product"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   Set RptManufacturedProduct = Nothing
Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
...
Private Function SetReport() As Boolean
    ...
    sSQL = "Select ManufacturedDate, Code as FinishedProductID, P.ProductName as FinishedProductName, B.QtyLoose as FinishedQty, f.manufacturedid, f.ProductID, (b.QtyLoose*f.QtyLoose) as QtyLoose, 0 as Rate, 0 as Amount ,PU.ProductName" & vbCrLf _
            + " from ManufacturedProductsHeader H" & vbCrLf _
            + " Inner Join ManufacturedProductsBody B ON B.ManufacturedID = H.ManufacturedID" & vbCrLf _
            + " inner join ManufacturedProductsFormula f on B.ManufacturedID = f.ManufacturedID and b.ProductID = f.FinishedProductID" & vbCrLf _
            + " Inner Join Products P on P.ProductID = Code" & vbCrLf _
            + " Inner Join Products PU on PU.ProductID = f.ProductID" & vbCrLf _
            + " where ManufacturedDate between '" & DtpFrom.DateValue & "' and '" & DtpTo.DateValue & "'" & IIf(TxtStoreID.Text = "", "", " and h.storeid = " & TxtStoreID.Text) & IIf(TxtProductID.Text = "", "", " and b.ProductID = " & TxtProductID.Text)
    
'    sSQL = "Select ManufacturedDate, Code as FinishedProductID, P.ProductName as FinishedProductName, B.QtyLoose as FinishedQty, U.*, PU.ProductName from ManufacturedProductsHeader H" & vbCrLf _
            + " Inner Join ManufacturedProductsBody B ON B.ManufacturedID = H.ManufacturedID" & vbCrLf _
    ...
    'Set RsReport = CN.Execute("EXEC ProdRptStoreWiseStockTransferDetail '" & DtpFrom.DateValue & "','" & DtpTo.DateValue & "','" & IIf(TxtFromStoreID.Text = "", "", TxtFromStoreID.Text) & "','" & IIf(TxtToStoreID.Text = "", "", TxtToStoreID.Text) & "','" & IIf(Trim(TxtProductID.Text) = "", "", TxtProductID.Text) & "'")
