...
Begin VB.Form RptCustomOrderBalance 
   AutoRedraw      =   -1  'True
   ...
   ClientTop       =   375
   ClientWidth     =   15360
   Icon            =   "RptCustomOrderBalance.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   742
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.OptionButton RdoAll 
         ...
         Width           =   1335
      End
      Begin VB.OptionButton RdoGZero 
         Caption         =   "Greater Than Zero"
         Height          =   255
         Left            =   240
         TabIndex        =   3
         Top             =   765
         Width           =   1935
      End
      Begin VB.OptionButton RdoEZero 
         Caption         =   "Equal to Zero"
         Height          =   255
         Left            =   2520
         TabIndex        =   2
         Top             =   255
         Width           =   1455
      End
      Begin VB.OptionButton RdoLZero 
         Caption         =   "Less than Zero"
         Height          =   255
         Left            =   2520
         TabIndex        =   4
         Top             =   765
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCustomOrderBalance.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCustomOrderBalance.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCustomOrderBalance.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnCustomer 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCustomOrderBalance.frx":0F1E
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin VB.Label LblCaption 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Customer Order Balance"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   18
         Charset         =   178
   ...
   End
End
Attribute VB_Name = "RptCustomOrderBalance"
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
   ...
   ElseIf KeyCode = vbKeyF1 Then
      Select Case ActiveControl.Name
         Case TxtCustomerID.Name: If FunSelectCustomer(ssFunctionKey, True) = True Then RdoAll.SetFocus
      End Select
   End If
   Exit Sub
ErrorHandler:
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Customer Order Balance"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   For Each frmObj In Forms
       Set frmObj = Nothing
   Next
   Set RptCustomOrderBalance = Nothing
Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
...
Private Function SetReport() As Boolean
    ...
    Set RsReport = cn.Execute("EXEC ProdRptCustomOrderBalance " & IIf(Trim(TxtCustomerID.Text) = "", "Null", Val(TxtCustomerID.Text)) & "," & IIf(RdoLZero.Value = True, 0, "Null") & "," & IIf(RdoEZero.Value = True, 0, "Null") & "," & IIf(RdoGZero.Value = True, 0, "Null") & ",'" & DtpFrom.DateValue & "','" & DtpTo.DateValue & "'")
    'Set RsReport = CN.Execute("EXEC ProdRptProductWiseProfit null,null,null,null,'2007-07-27', '2008-09-27'")
    Set RptReportViewer.Report = New CrptCustomOrderBalance
    ...
    If RsReport.BOF Then
        ...
        Exit Function
    End If
    RptReportViewer.Report.ReportTitle = "Custom Order Balance"
...
Private Function FunSelectCustomer(ByVal CallerName As SelectAccountCaller, ByVal IsOptional As Boolean) As Boolean
    ...
    VStrSQL = " Select * FROM Parties where PartyID = " & Val(TxtCustomerID.Text) & " AND PartyType <> 'V'"
