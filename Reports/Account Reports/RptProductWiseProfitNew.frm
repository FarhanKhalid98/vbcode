...
Begin VB.Form RptProductWiseProfitNew 
   AutoRedraw      =   -1  'True
   ...
   End
End
Attribute VB_Name = "RptProductWiseProfitNew"
...
Private Sub BtnPreview_Click()
   If SetReport Then
       RptReportViewer.Caption = "Product Wise Profit Report"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   For Each frmObj In Forms
       Set frmObj = Nothing
   Next
   Set RptProductWiseProfitNew = Nothing
   Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
...
Private Function SetReport() As Boolean
   ...
   Else
      Set RsReport = CN.Execute("EXEC ProdRptProductWiseProfitLP " & IIf(Trim(TxtProductID.Text) = "", "Null", TxtProductID.Text) & "," & IIf(Trim(TxtGroupID.Text) = "", "Null", TxtGroupID.Text) & "," & IIf(Trim(TxtCompanyID.Text) = "", "Null", TxtCompanyID.Text) & "," & IIf(Trim(TxtSubGroupID.Text) = "", "Null", TxtSubGroupID.Text) & "," & IIf(Trim(TxtOrganizationID.Text) = "", "Null", TxtOrganizationID.Text) & ",'" & DtpFrom.DateValue & "','" & DtpTo.DateValue & "'")
   End If
