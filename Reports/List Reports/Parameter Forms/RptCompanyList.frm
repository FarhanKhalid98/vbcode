...
Begin VB.Form RptCompanyList 
   ...
   End
End
Attribute VB_Name = "RptCompanyList"
...
Private Sub BtnPreview_Click()
   If SetReport Then
       RptReportViewer.Caption = "Company List Report"
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
   ...
   ElseIf KeyCode = vbKeyF1 Then
      Select Case ActiveControl.Name
         Case TxtCompanyID.Name: If FunSelectCompany(ssFunctionKey, True) = True Then BtnPreview.SetFocus
      End Select
   End If
   Exit Sub
ErrorHandler:
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Company List"
End Sub
...
Private Function SetReport() As Boolean
   ...
   SetReport = False
   VStrSQL = "Select CompanyID, CompanyName from Companies Where 1=1" & vbCrLf _
   + "" & IIf(Trim(TxtCompanyID.Text) = "", "", " And CompanyID = " & TxtCompanyID.Text)
   Me.MousePointer = vbHourglass
   If RsReport.State = adStateOpen Then RsReport.Close
   RsReport.Open VStrSQL, CN, adOpenStatic, adLockReadOnly
   Set RptReportViewer.Report = New CRptCompanyList
