...
Begin VB.Form SchCustomerDemands 
   AutoRedraw      =   -1  'True
   ...
   Begin JeweledBut.JeweledButton BtnSelect 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchCustomerDemands.frx":0000
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchCustomerDemands.frx":001C
      BC              =   14737632
      FC              =   0
   End
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "SchCustomerDemands.frx":0038
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
   ...
   End
End
Attribute VB_Name = "SchCustomerDemands"
...
Public ParaOutDemandID As String

Private Sub LoadGrid()
   On Error GoTo ErrorHandler
   Set Rs = New ADODB.Recordset
   vStrSQL = "SELECT H.DemandID as ID, H.DemandDate as Date,  H.ProductName, H.Remarks, UserName " & vbCrLf _
         + " FROM CustomerDemands H  " & vbCrLf _
         + " INNER JOIN users u ON h.userno = u.userno " & vbCrLf _
         + " WHERE 1=1 and DemandDate Between '" & DtpFrom.DateValue & "' and '" & DtpTo.DateValue & "'" & IIf(ObjUserSecurity.IsAdministrator = False And ObjUserSecurity.IsManager = False, " and h.userno=" & ObjUserSecurity.UserNo, "") & vOrder & vDirection
