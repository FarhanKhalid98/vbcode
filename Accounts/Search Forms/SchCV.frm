...
Private Sub LoadDetail()
  On Error GoTo ErrorHandler
    vSQL = " Select c.AccountName + isnull(' (' + p.Address + ')','')  as AccountName, b.Narration, Amount from Creditvouchers h" & vbCrLf _
      + " inner join Creditvouchersbody b on h.voucherno = b.voucherno and h.storeid = b.storeid" & vbCrLf _
      + " inner join chartofaccounts c on c.accountno = b.accountno" & vbCrLf _
