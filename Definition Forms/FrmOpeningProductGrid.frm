...
Begin VB.Form FrmOpeningProductGrid 
   ...
   ClientTop       =   375
   ClientWidth     =   15360
   Icon            =   "FrmOpeningProductGrid.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   742
   ...
   Begin VB.Frame FraHelp 
      ...
      Begin VB.TextBox Text1 
         ...
         TabIndex        =   14
         Tag             =   "NC"
         Text            =   "FrmOpeningProductGrid.frx":0ECA
         Top             =   360
         Width           =   3930
      End
   ...
   Begin JeweledBut.JeweledButton BtnSelect 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmOpeningProductGrid.frx":0F1C
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmOpeningProductGrid.frx":0F38
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmOpeningProductGrid.frx":0F54
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnFilter 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmOpeningProductGrid.frx":0F70
      BC              =   12632256
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnApply 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmOpeningProductGrid.frx":0F8C
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmOpeningProductGrid.frx":0FA8
      ...
      BeginProperty stylesets(1).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(1).Picture=   "FrmOpeningProductGrid.frx":0FC4
      MultiLine       =   0   'False
      ...
      Columns(2).Caption=   "Packing Name"
      Columns(2).Name =   "PackingName"
      ...
      Columns(9).Caption=   "WSPrice"
      Columns(9).Name =   "WSPrice"
      Columns(9).CaptionAlignment=   2
      Columns(9).DataField=   "Column 9"
      Columns(9).DataType=   8
      Columns(9).FieldLen=   256
      Columns(10).Width=   1429
      Columns(10).Caption=   "List Price"
      Columns(10).Name=   "ListPrice"
      Columns(10).DataField=   "Column 10"
      Columns(10).DataType=   8
      Columns(10).FieldLen=   256
      Columns(11).Width=   1217
      Columns(11).Caption=   "Retail Price"
      Columns(11).Name=   "RetailPrice"
      Columns(11).DataField=   "Column 11"
      Columns(11).DataType=   8
      Columns(11).FieldLen=   256
      Columns(12).Width=   2461
      Columns(12).Caption=   "Company"
      Columns(12).Name=   "Company"
      ...
      Columns(13).Caption=   "Group"
      Columns(13).Name=   "Group"
      Columns(13).CaptionAlignment=   2
      Columns(13).DataField=   "Column 13"
      Columns(13).DataType=   8
      Columns(13).FieldLen=   256
      Columns(13).Locked=   -1  'True
      Columns(14).Width=   2461
      Columns(14).Caption=   "Sub Group"
      Columns(14).Name=   "SubGroup"
      Columns(14).CaptionAlignment=   2
      Columns(14).DataField=   "Column 14"
      Columns(14).DataType=   8
      Columns(14).FieldLen=   256
      Columns(14).Locked=   -1  'True
      Columns(15).Width=   2461
      Columns(15).Caption=   "Brand"
      Columns(15).Name=   "Brand"
   ...
   Begin JeweledBut.JeweledButton BtnFromProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmOpeningProductGrid.frx":0FE0
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnToProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmOpeningProductGrid.frx":0FFC
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnVender 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmOpeningProductGrid.frx":1018
      BC              =   14737632
      FC              =   0
   End
...
Dim vSQL As String
Public ParaInOpeningID As Integer
Public ParaInOpeningDate As String
...
Private Sub PopulateGrid()
   ...
   RsTemp.Fields.Append "ProductID", adDouble
...
'      vSQL = " SELECT P.ProductID, P.ItemCode, ProductName, PurPrice, GroupName, isnull(CompanyName,'') as CompanyName, " & vbCrLf _
      ...
      + " where vendorid = " & Val(TxtVenderID.Text) & ") pur on pur.productid = p.productid" & vbCrLf _
      + " where p.isLocked = 0 " & vProductID & vProductName & vbCrLf _
      + IIf(CmbCompany.ListIndex = 0, "", " and p.CompanyID =" & CmbCompany.ItemData(CmbCompany.ListIndex)) & vbCrLf _
      + IIf(CmbGroup.ListIndex = 0, "", " and p.GroupID ='" & GetGroupID(CmbGroup) & "'") & vbCrLf _
      + IIf(CmbSubGroup.ListIndex = 0, "", " and p.SubGroupID =" & CmbSubGroup.ItemData(CmbSubGroup.ListIndex)) & vbCrLf _
...
Private Sub PopulateGridLoad()
   ...
   vSuppressUpdateEvent = True
       ...
       vSQL = " SELECT P.ProductID, ProductName, p.PurPrice, WSPrice, ListPrice, GroupName, isnull(CompanyName,'') as CompanyName, " & vbCrLf _
      + " isnull(SubGroupName,'') as SubGroupName, isnull(BrandName,'') as BrandName, RetailPrice, os.DiscPer, os.DiscPC, os.DiscVal, " & vbCrLf _
      + " isnull(packingname,'') packingname, isnull(pp.multiplier,0) multiplier" & vbCrLf _
      + " FROM Products p Left Outer join Groups g on g.GroupID = p.GroupID" & vbCrLf _
      + " left outer join SubGroups s on s.SubGroupID = p.SubGroupID" & vbCrLf _
      + " left outer join Companies c on c.CompanyID = p.CompanyID" & vbCrLf _
      + " Left outer join packings pk on pk.packingid = p.purchasepackingid" & vbCrLf _
      + " Left outer join productpacking pp on pp.productid = p.productid" & vbCrLf _
      + " left outer join Brands b on b.BrandID = p.BrandID" & vbCrLf _
      + " Inner join OpeningStock os on os.ProductID = p.ProductID" & vbCrLf _
      + " inner join OpeningInvoiceHeader oh  on oh.OpeningID = os.OpeningID and oh.OpeningDate = os.OpeningDate " & vbCrLf _
      + " where oh.OpeningID = " & Me.ParaInOpeningID & " and oh.OpeningDate = '" & Me.ParaInOpeningDate & "'" & vbCrLf _
   ...
   With cn.Execute(vSQL)
      Do Until .EOF
        ...
        Grid.Update
        RsTemp.AddNew
        RsTemp!Productid = !Productid
        RsTemp!ProductName = !ProductName
        RsTemp!PackingName = !PackingName
        RsTemp!Multiplier = !Multiplier
        RsTemp!QtyPack = 0
        RsTemp!QtyLoose = 0
        RsTemp!Price = !PurPrice
        RsTemp!DiscPC = !DiscPC
        RsTemp!DiscPer = !DiscPer
        RsTemp.Update
        .MoveNext
      Loop
   End With
...
Private Sub BtnFilter_Click()
   On Error GoTo ErrorHandler
   vProductID = IIf(Val(TxtToProductID.Text) = 0, IIf(Val(TxtFromProductID.Text) = 0, "", " and P.ProductID = '" & TxtFromProductID.Text & "'"), IIf(Val(TxtFromProductID.Text) = 0, "", " and P.ProductID Between " & Val(TxtFromProductID.Text) & " and " & Val(TxtToProductID.Text)))
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Opening Product Grid"
   HelpLocation Me
...
'      Grid.Columns("PurPrice").Text = Val(Grid.Columns("RetailPrice").Text) - Val(Grid.Columns("RetailPrice").Text) / 100 * Val(Grid.Columns("RetailPer").Text)
   ...
   End If
      ...
      RsTemp!DiscPer = Val(Grid.Columns("DiscPer").Value)
      RsTemp!DiscPC = Val(Grid.Columns("DiscPc").Value)
      RsTemp!Price = Val(Grid.Columns("PurPrice").Text)
'   ElseIf RsTemp.RecordCount = 1 And (Val(Grid.Columns("QtyLoose").Value) + Val(Grid.Columns("QtyPack").Value) = 0) Then
'      RsTemp.Delete
'   Else 'If RsTemp.RecordCount = 1 Then
'      RsTemp.Update
