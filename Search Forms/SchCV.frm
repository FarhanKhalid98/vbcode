...
Begin VB.Form SchCV 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid GridDetail 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "SchCV.frx":0054
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "SchCV.frx":0070
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
      AllowRowSizing  =   0   'False
      AllowGroupSizing=   0   'False
      ...
      Columns(6).Caption=   "StoreID"
      Columns(6).Name =   "StoreID"
...
Private Sub LoadData()
   ...
   vSQL = " Select h.VoucherNo ID, Voucherdate as Date, Sum(Amount) as Amount, UserName, Tag, StoreName, H.StoreID" & vbCrLf _
      ...
      + " Group by h.VoucherNo, Voucherdate, UserName, Tag, StoreName, H.StoreID" & vOrder & vDirection
...
Private Sub LoadDetail()
  On Error GoTo ErrorHandler
    vSQL = " Select c.AccountName + isnull(' (' + p.Address + ')','')  as AccountName, Amount from Creditvouchers h" & vbCrLf _
      + " inner join Creditvouchersbody b on h.voucherno = b.voucherno" & vbCrLf _
      + " inner join chartofaccounts c on c.accountno = b.accountno" & vbCrLf _
