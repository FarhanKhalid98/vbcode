...
Private Function SetReport() As Boolean
    ...
    Set RsReport = CN.Execute("EXEC ProdRptSales '" & DtpFrom.DateValue & "','" & DtpTo.DateValue & "'")
    Set RptReportViewer.Report = New CrpSales
    RptReportViewer.Report.ReportTitle = "Sales"
    ...
    With CN.Execute("Select CompanyName,Address,City,PhoneNo,email from Company")
      If .RecordCount > 0 Then
         ...
         RptReportViewer.Report.ParameterFields(3).AddCurrentValue IIf(IsNull(!PhoneNo) Or !PhoneNo = "", "", CStr(!PhoneNo))
      End If
      .Close
    End With
