...
Begin VB.Form RptGroupWisePurchaseReturnSummary 
   AutoRedraw      =   -1  'True
   ...
   ClientWidth     =   12000
   ControlBox      =   0   'False
   Icon            =   "RptGroupWisePurchaseReturnSummary.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptGroupWisePurchaseReturnSummary.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptGroupWisePurchaseReturnSummary.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptGroupWisePurchaseReturnSummary.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   Begin SITextBox.Txt TxtCode 
      ...
      Begin VB.Label Label6 
         ...
         Caption         =   "Group Wise Purchase Detail"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   18
            Charset         =   178
   ...
   Begin JeweledBut.JeweledButton BtnProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptGroupWisePurchaseReturnSummary.frx":0F1E
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptGroupWisePurchaseReturnSummary.frx":0F3A
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSubGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptGroupWisePurchaseReturnSummary.frx":0F56
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnCompany 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptGroupWisePurchaseReturnSummary.frx":0F72
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin VB.Label Label7 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Purchase Return Summary (Group Wise)"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   12
         Charset         =   178
   ...
   End
End
Attribute VB_Name = "RptGroupWisePurchaseReturnSummary"
...
Private Sub Form_Load()
   ShowPicture Me
   SetWindowText Me.hWnd, "Purchase Return Summary (Group Wise)"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   For Each frmObj In Forms
       Set frmObj = Nothing
   Next
   Set RptGroupWisePurchaseReturnSummary = Nothing
Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
...
Private Function SetReport() As Boolean
    ...
    Set RsReport = CN.Execute("EXEC ProdRptGroupWisePurchaseReturnSummary '" & DtpFrom.DateValue & "','" & DtpTo.DateValue & "','" & IIf(Trim(TxtProductID.Text) = "", "", TxtProductID.Text) & "','" & IIf(Trim(TxtGroupID.Text) = "", "", TxtGroupID.Text) & "','" & IIf(Trim(TxtSubGroupID.Text) = "", "", TxtSubGroupID.Text) & "','" & IIf(Trim(TxtCompanyID.Text) = "", "", TxtCompanyID.Text) & "'")
    Set RptReportViewer.Report = New CrptGroupWisePurchaseReturnSummary
