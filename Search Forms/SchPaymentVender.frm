...
Begin VB.Form SchPaymentVender 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00F8E8D6&
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchPaymentVender.frx":0000
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnSelect 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchPaymentVender.frx":001C
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchPaymentVender.frx":0038
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "SchPaymentVender"
...
Private Sub LoadGrid()
   ...
   vSQL = "SELECT PaymentHeader.PaymentID as ID, PaymentDate, EmpName as EmployeeName" & vbCrLf _
         ...
         + " (SELECT PaymentID, sum(isnull(Amount,0)) as TotalAmount, count(VenderID) as NoofEntries FROM PaymentVender GROUP BY PaymentID) PaymentVender" & vbCrLf _
