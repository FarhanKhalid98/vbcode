...
Begin VB.Form RptReceivedRegister 
   AutoRedraw      =   -1  'True
   ...
   ClientTop       =   375
   ClientWidth     =   15420
   Icon            =   "RptReceivedRegister.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptReceivedRegister.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptReceivedRegister.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptReceivedRegister.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnSearch 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptReceivedRegister.frx":0F1E
      BC              =   12632256
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnOrganization 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptReceivedRegister.frx":0F3A
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnZone 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptReceivedRegister.frx":0F56
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSector 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptReceivedRegister.frx":0F72
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSession 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptReceivedRegister.frx":0F8E
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnUser 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptReceivedRegister.frx":0FAA
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "RptReceivedRegister"
...
Private Function FunRefreshData() As Boolean
   ...
   vSQL = "EXECUTE ProdRptReceivedRegister " & IIf(Trim(TxtOrganizationID.Text) = "", "Null", TxtOrganizationID.Text) & "," & IIf(Trim(TxtAccountNo.Text) = "", "Null", "'" & TxtAccountNo.Text & "'") & "," & IIf(Trim(TxtUserNo.Text) = "", "Null", TxtUserNo.Text) & "," & IIf(Trim(TxtSectorID.Text) = "", "Null", TxtSectorID.Text) & "," & IIf(Trim(TxtzoneID.Text) = "", "Null", "" & TxtzoneID.Text) & ", '" & DtpFrom.DateValue & "','" & DtpTo.DateValue & "'," & IIf(ChkRecoveryCustomer.Value = 1, "'RI'", "''") & "," & IIf(ChkSaleAmount.Value = 1, "'SI'", "''")
...
'      Set RptReportViewer.Report = New CrpAccountLedger
       Set RptReportViewer.Report = Application1.OpenReport(vTmp & "\Reports\AccountReports\CrpReceivedRegister.rpt")
   End If
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Received Register"
