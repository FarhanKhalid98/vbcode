...
Begin VB.Form FrmCustomOrderBooking 
   ...
   ClientTop       =   375
   ClientWidth     =   15360
   Icon            =   "FrmCustomOrderBooking1.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   742
   ...
   Begin JeweledBut.JeweledButton BtnDelete 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomOrderBooking1.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomOrderBooking1.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnOpen 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomOrderBooking1.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomOrderBooking1.frx":0F1E
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomOrderBooking1.frx":0F3A
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnCustomProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomOrderBooking1.frx":0F56
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmCustomOrderBooking1.frx":0F72
      AllowUpdate     =   0   'False
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid GridDetail 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmCustomOrderBooking1.frx":0F8E
      ...
      BeginProperty stylesets(1).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(1).Picture=   "FrmCustomOrderBooking1.frx":0FAA
      ...
      BeginProperty stylesets(2).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(2).Picture=   "FrmCustomOrderBooking1.frx":0FC6
      MultiLine       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomOrderBooking1.frx":0FE2
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnVender 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomOrderBooking1.frx":0FFE
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnOrganization 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomOrderBooking1.frx":101A
      BC              =   12632256
      FC              =   0
   End
...
Dim vBm As Variant
Dim i As Integer, vCashDrawer As Boolean, vLaserInvoice As Boolean, vPrintHeader  As Boolean, vNoofPrints As Byte
...
Private Function FunSelectVender(ByVal CallerName As SelectAccountCaller, ByVal IsOptional As Boolean) As Boolean
    ...
    If CallerName = ssButton Or CallerName = ssFunctionKey Then
        ...
        If SchVendor.ParaOutVendorID = "" Then FunSelectVender = False: Exit Function
        TxtVenderID.Text = SchVendor.ParaOutVendorID
    End If
    '---------------------------
    vStrSQL = " Select * FROM Parties where PartyID = '" & TxtVenderID.Text & "' AND PartyType <> 'C' and isLockParty=0"
...
Private Sub BtnVender_Click()
   If FunSelectVender(ssButton, False) = True Then
      If TxtCustomProductCode.Enabled Then TxtCustomProductCode.SetFocus Else TxtVenderID.SetFocus
   Else
...
Private Sub BtnOpen_Click()
   SchCustomOrder.ParaInShowOrder = True
   SchCustomOrder.Show vbModal, Me
   If SchCustomOrder.ParaOutOrderID <> 0 Then
      TxtOrderID.Text = SchCustomOrder.ParaOutOrderID
      cn.Execute ("Insert Into UserActivities values ('Custom Order Booking'" & "," & TxtOrderID.Text & ",'" & DtpOrderDate.DateValue & "','Opened','" & Date & "','" & Time & "',4,'Opened'," & vUser & ")")
      GetPrevious
   End If
End Sub
...
Private Sub GetPrevious()
   On Error GoTo ErrorHandler
   vStrSQL = " Select h.*, p.partyname as PartyName, v.partyname as VenderName, OrganizationName, BankMachineName from CustomOrderHeader h left outer join Organizations o on o.OrganizationID = h.OrganizationID left outer join parties p on h.customerid = p.partyid left outer join BankMachines b on b.BankMachineid = h.BankMachineid left outer join Parties v on v.PartyID = h.VendorID" & _
   ...
   With cn.Execute(vStrSQL)
      If Not .BOF Then
         ...
         TxtVenderName.Text = IIf(IsNull(!VenderName), "", !VenderName)
...
Private Sub BtnPrint_Click()
   ...
   vStrSQL = "  select u.username, h.OrderID, h.OrderDate, DueDate, h.TotalAmount, h.Advance, Name as productname, b.qty, b.price as price, b.amount, " & vbCrLf _
      + "  Case when CustomerID = '621' then isnull(CustomerName,PartyName) Else PartyName End as Customer,  " & vbCrLf _
      + " Cash, Credit, BankCard" & vbCrLf _
      ...
      + "  where h.OrderID = " & Val(TxtOrderID.Text) & " and h.OrderDate ='" & DtpOrderDate.DateValue & "'" & vbCrLf _
      + " Order By SerialNo"
   ...
   If InStr(1, Printer.DeviceName, "CBM1000") > 0 Then
      Set RptReportViewer.Report = New CrptCustomOrderBookingCBM
   ElseIf InStr(1, Printer.DeviceName, "AB-80K") > 0 Then
      Set RptReportViewer.Report = New CrptCustomOrderBookingAurora
   ...
   RptReportViewer.Report.ParameterFields(5).AddCurrentValue ""
   RptReportViewer.Report.ParameterFields(6).AddCurrentValue CBool(False)
   RptReportViewer.Report.ParameterFields(7).AddCurrentValue CStr(ObjRegistry.OrderStatement)
   ...
   cn.Execute ("Insert Into UserActivities values ('Custom Order Booking'" & "," & TxtOrderID.Text & ",'" & DtpOrderDate.DateValue & "','Printed','" & Date & "','" & Time & "',5,'Printed'," & vUser & ")")
   RptReportViewer.Report.PrintOut False
   
   
   '''''''''''''''''' measurement Report
   vStrSQL = "  select h.OrderID, h.OrderDate,  DueDate, h.TotalAmount, h.Advance, CPM.Name as productname, b.qty, b.price as price, b.amount, " & vbCrLf _
      + "  Case when CustomerID = '621' then isnull(CustomerName,PartyName) Else PartyName End as Customer,  " & vbCrLf _
      + " Cash, Credit, BankCard," & vbCrLf _
      + " cpm.Name as productname, p.name, unitname, value" & vbCrLf _
            + " from  CustomOrderHeader h inner join CustomOrderBody b on h.OrderID = b.OrderID" & vbCrLf _
            + " left outer join CustomOrderDetail cod on cod.orderid = b.orderid and cod.customproductcode = b.customproductcode" & vbCrLf _
            + " Inner join CustomProductsMeasurements CPM on CPM.id  = b.CustomProductCode" & vbCrLf _
            + " left outer join CustomProductsMeasurements p on p.id = cod.id and p.parentid = cod.customproductcode" & vbCrLf _
            + " left outer join units un on un.unitid = Cod.unitid" & vbCrLf _
            + " inner join users u on u.UserNo = h.UserNo" & vbCrLf _
            + " inner join Parties Pr on Pr.PartyID = h.CustomerID" & vbCrLf _
   ...
   ElseIf InStr(1, Printer.DeviceName, "AB-80K") > 0 Then
      ...
      RptReportViewer.Report.TopMargin = 255
   Else 'InStr(1, Printer.DeviceName, "AB-80K") > 0 Then
      Set RptReportViewer.Report = New CrptCustomOrderBookingMeasurementAurora
      RptReportViewer.Report.LeftMargin = 0
      RptReportViewer.Report.RightMargin = 0
      RptReportViewer.Report.TopMargin = 0
   End If
...
On Error GoTo ErrorHandler
   ...
   ''''''''''''' User Authentication ''''''''''''''
   vUserAction = UserAuthentication("MniCustomOrderBooking", vUser, ObjUserSecurity.IsAdministrator, IIf(vIsNewRecord = True, eUserNewRecord, eUserEdit))
   If vUserAction <> "" Then
...
'   End If
   ...
   '''''''''''''''''''''''Check Posing Date'''''''''''''''''''''''''''''''''
    ...
    With cn.Execute(vStrSQL)
        If .Fields(0).Value >= DtpOrderDate.DateValue Then
  ...
  'Saving record
   ...
   RsBody.Filter = 0
   If RsBody.BOF = False Then RsBody.MoveFirst
   ...
   RsDetails.Filter = 0
   If RsDetails.BOF = False Then RsDetails.MoveFirst
...
Private Property Let FormStatus(ByVal vNewValue As FormMode)
   ...
   Case Is = NewMode
      ...
      DtpOrderDate.DateValue = IIf(Abs(vSystemDate) = 1, vDate, IIf(Format(Now, "hh") >= vHDiff, vDate, DateAdd("d", -1, vDate)))
      TxtOrderID.Text = FunGetMaxID
      'DtpDate.Value = Date
...
'         GetDataFromTexBoxesToGrid
   ...
   ElseIf KeyCode = vbKeyF1 Then
      Select Case ActiveControl.Name
         ...
         Case TxtVenderID.Name: If FunSelectVender(ssFunctionKey, False) = True Then If TxtCustomProductCode.Enabled Then TxtCustomProductCode.SetFocus Else TxtVenderID.SetFocus
...
'   End If
   If ActiveControl.Name = Grid.Name Then
      ...
      If RsBody.RecordCount > 0 Then
         ...
         If RsDetails.RecordCount > 0 Then RsDetails.Delete
         cn.Execute ("Insert Into UserActivities values ('Custom Order Booking'" & "," & TxtOrderID.Text & ",'" & DtpOrderDate.DateValue & "','Removed ProdcutID-" & Grid.Columns("Code").Text & " Qty-" & Grid.Columns("Qty").Text & " Price-" & Grid.Columns("Price").Text & " Amount-" & Grid.Columns("Amount").Text & "','" & Date & "','" & Time & "',2,'Updated'," & vUser & ")")
      End If
   End If
...
Private Sub BtnClear_Click()
   ...
   cn.Execute ("Insert Into UserActivities values ('Custom Order Booking'" & "," & TxtOrderID.Text & ",'" & DtpOrderDate.DateValue & "','Cleared','" & Date & "','" & Time & "',6,'Cleared'," & vUser & ")")
...
Private Sub BtnClose_Click()
   '''''''''''''''''''''''''''''''''''''User Activities'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
   cn.Execute ("Insert Into UserActivities values ('Custom Order Booking'" & "," & TxtOrderID.Text & ",'" & DtpOrderDate.DateValue & "','Closed','" & Date & "','" & Time & "',7,'Closed'," & vUser & ")")
   ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
   Unload Me
End Sub
...
Private Sub BtnDelete_Click()
   On Error GoTo ErrorHandler
    ''''''''''''' User Authentication ''''''''''''''
   vUserAction = UserAuthentication("MniCustomOrderBooking", vUser, ObjUserSecurity.IsAdministrator, eUserDelete)
   If vUserAction <> "" Then
      MsgBox vUserAction, vbCritical, "Error"
      Exit Sub
   End If
...
Private Sub UserActivities()
    ...
    With cn.Execute("Select  * from CustomOrderHeader where OrderID =" & TxtOrderID.Text & " And OrderDate = '" & DtpOrderDate.DateValue & "'")
        If Val(TxtVenderID.Text) <> IIf(IsNull(!VendorID), 0, !VendorID) Then
            cn.Execute ("Insert Into UserActivities values ('Custom Order Booking'" & "," & TxtOrderID.Text & ",'" & DtpOrderDate.DateValue & "','Updated EmpID-" & !EmpID & "','" & Date & "','" & Time & "',2,'Updated'," & vUser & ")")
        End If
    End With
    Grid.MoveFirst
    
    For i = 1 To Grid.rows - 1
        With cn.Execute("Select * from CustomOrderBody Where OrderID = " & TxtOrderID.Text & " and CustomProductCode ='" & Grid.Columns("Code").Text & "'")
             If .EOF = True Then
                cn.Execute ("Insert Into UserActivities values ('Custom Order Booking'" & "," & TxtOrderID.Text & ",'" & DtpOrderDate.DateValue & "','Inserted New ProdcutID-" & Grid.Columns("Code").Text & " Qty-" & Grid.Columns("Qty").Text & " Price-" & Grid.Columns("Price").Text & " Amount-" & Grid.Columns("Amount").Text & "','" & Date & "','" & Time & "',2,'Updated'," & vUser & ")")
             Else
                If Grid.Columns("Qty").Text <> !Qty Or Grid.Columns("Price").Text <> !Price Then
                   cn.Execute ("Insert Into UserActivities values ('Custom Order Booking'" & "," & TxtOrderID.Text & ",'" & DtpOrderDate.DateValue & "','Updated ProdcutID-" & Grid.Columns("Code").Text & " Qty-" & !Qty & " Price-" & !Price & " Amount-" & !Amount & "','" & Date & "','" & Time & "',2,'Updated'," & vUser & ")")
                End If
            End If
        End With
    Grid.MoveNext
   ...
   Else
    cn.Execute ("Insert Into UserActivities values ('Custom Order Booking'" & "," & TxtOrderID.Text & ",'" & DtpOrderDate.DateValue & "','Saved','" & Date & "','" & Time & "',1,'Saved'," & vUser & ")")
   End If
End Sub
