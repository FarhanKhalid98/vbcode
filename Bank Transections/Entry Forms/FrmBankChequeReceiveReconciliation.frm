...
Begin VB.Form FrmBankChequeReceiveReconciliation 
   AutoRedraw      =   -1  'True
   BorderStyle     =   0  'None
   ClientHeight    =   11550
   ClientLeft      =   15
   ...
   Icon            =   "FrmBankChequeReceiveReconciliation.frx":0000
   KeyPreview      =   -1  'True
   ScaleHeight     =   770
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   1030
   ...
   Begin JeweledBut.JeweledButton btnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmBankChequeReceiveReconciliation.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton btnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmBankChequeReceiveReconciliation.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton btnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmBankChequeReceiveReconciliation.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton btnOpen 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmBankChequeReceiveReconciliation.frx":0F1E
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton btndelete 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmBankChequeReceiveReconciliation.frx":0F3A
      BC              =   14737632
      FC              =   0
   End
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmBankChequeReceiveReconciliation.frx":0F56
      ...
      BeginProperty stylesets(1).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(1).Picture=   "FrmBankChequeReceiveReconciliation.frx":0F72
      ...
      BeginProperty stylesets(2).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(2).Picture=   "FrmBankChequeReceiveReconciliation.frx":0F8E
      MultiLine       =   0   'False
   ...
   Begin VB.Label LblCaption 
      ...
      BackColor       =   &H80000003&
      BackStyle       =   0  'Transparent
      Caption         =   "Bank Cheque Receiving Reconciliation "
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   13.5
         Charset         =   178
   ...
   End
End
Attribute VB_Name = "FrmBankChequeReceiveReconciliation"
...
Private Sub Form_Load()
   SetWindowText Me.hWnd, "Bank Cheque Receive Reconciliation"
   ShowPicture Me, 2
...
Private Sub PopulateDataToGrid()
   On Error GoTo ErrorHandler
   If RsBody.State = adStateOpen Then RsBody.Close
   RsBody.Open "select * from BankChequeReceiveBody where ChequeDate Between ' " & dtpFromDate.DateValue & " ' and  '" & DtpToDate.DateValue & "'", CN, adOpenStatic, adLockBatchOptimistic
   If RsBody.RecordCount > 0 Then
      sSql = "Select B.*, AccountName From BankChequeReceiveBody B  Inner Join BankChequeReceiveHeader H on B.VoucherID = H.VoucherID left outer join chartofaccounts c on c.AccountNo = b.ReceivingID Where ChequeDate Between  '" & dtpFromDate.DateValue & "' And '" & DtpToDate.DateValue & "'"
      With CN.Execute(sSql)
         If .RecordCount > 0 Then
            ...
            While Not .EOF
               ...
               Grid.Columns("PartyName").Text = (!AccountName)
