...
Begin VB.Form RptCurrentStock 
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCurrentStock.frx":0000
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCurrentStock.frx":001C
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCurrentStock.frx":0038
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCurrentStock.frx":0054
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCurrentStock.frx":0070
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "RptCurrentStock"
...
Private Sub BtnPreview_Click()
   If SetReport Then
       RptReportViewer.Caption = "Current Stock Report"
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
   ...
   ElseIf KeyCode = vbKeyF1 Then
      Select Case ActiveControl.Name
         ...
         Case TxtGroupID.Name: If FunSelectGroup(ssFunctionKey, True) = True Then TxtStockLimit.SetFocus
      End Select
   End If
   Exit Sub
ErrorHandler:
...
Private Sub Form_Load()
   ShowPicture Me
   SetWindowText Me.hwnd, "Current Stock"
End Sub
...
Private Function SetReport() As Boolean
    ...
    Set RsReport = CN.Execute("EXEC ProdRptCurrentStock '" & IIf(Trim(TxtProductID.Text) = "", "", TxtProductID.Text) & "','" & IIf(Trim(TxtGroupID.Text) = "", "", TxtGroupID.Text) & "','','" & IIf(TxtStockLimit.Text = "", "", TxtStockLimit.Text) & "'")
