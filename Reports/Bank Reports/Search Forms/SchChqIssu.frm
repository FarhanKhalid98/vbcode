...
Begin VB.Form SchChqIssu 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "SchChqIssu.frx":0054
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
      ...
      Columns(2).Caption=   "Account Payee Name"
      Columns(2).Name =   "ACPayeeName"
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid GridDetail 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "SchChqIssu.frx":0070
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
      AllowRowSizing  =   0   'False
      AllowGroupSizing=   0   'False
      ...
      Columns(1).Caption=   "ChequeAmount"
...
Private Sub LoadData()
  On Error GoTo ErrorHandler
    ...
    vSQL = " Select h.VochID ID, h.ACPayeeName, h.VochDate as Date, Sum(isnull((b.ActAmount),0)) as Amount" & vbCrLf _
      + " from BankchqIssuHeader h inner join BankchqIssubody b on h.VochID = b.VochID " & vbCrLf _
      + " Where VochDate between '" & DtpFrom.DateValue & "' AND '" & DtpTo.DateValue & "'" & vbCrLf _
      + IIf(Trim(TxtAccountName.Text) = "", "", " and H.ACPayeeName like '%" & TxtAccountName.Text & "%'") & vbCrLf _
      + IIf(Trim(TxtChequeNo.Text) = "", "", " and B.ActChequeNo like '%" & TxtChequeNo.Text & "%'") & vbCrLf _
      + " Group by h.VochID, h.ACPayeeName, Vochdate " & vOrder & vDirection
    ...
    Grid.Columns("ACPayeeName").DataField = "ACPayeeName"
    LoadDetail
  Exit Sub
ErrorHandler:
...
Private Sub LoadDetail()
  On Error GoTo ErrorHandler
    ...
    vSQL = " Select B.ActChequeNo, B.ActChequeDate, B.ActAmount from BankchqIssubody B" & vbCrLf _
      + " inner join BankchqIssuHeader H on h.vochID = b.vochID " & vbCrLf _
      + " Where h.vochID = " & Grid.Columns("ID").Text & vbCrLf _
    ...
    GridDetail.Columns("ChequeAmount").DataField = "ActAmount"
  Exit Sub
ErrorHandler:
  Call ShowErrorMessage
End Sub
