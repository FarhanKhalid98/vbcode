...
Begin VB.Form FrmRecoveryCustomerWiseOld 
   ...
   ClientWidth     =   11985
   ControlBox      =   0   'False
   Icon            =   "FrmRecoveryCustomerWiseOld.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "FrmRecoveryCustomerWiseOld.frx":0ECA
   ScaleHeight     =   8970
   ScaleWidth      =   11985
   ...
   Begin JeweledBut.JeweledButton BtnSaleMan 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmRecoveryCustomerWiseOld.frx":783B
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnDelete 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmRecoveryCustomerWiseOld.frx":7857
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmRecoveryCustomerWiseOld.frx":7873
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnOpen 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmRecoveryCustomerWiseOld.frx":788F
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmRecoveryCustomerWiseOld.frx":78AB
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmRecoveryCustomerWiseOld.frx":78C7
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmRecoveryCustomerWiseOld.frx":78E3
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnCustomer 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmRecoveryCustomerWiseOld.frx":78FF
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmRecoveryCustomerWiseOld.frx":791B
      AllowUpdate     =   0   'False
   ...
   End
End
Attribute VB_Name = "FrmRecoveryCustomerWiseOld"
...
Private Sub BtnPrint_Click()
   On Error GoTo ErrorHandler
      vStrSQL = " Select H.RecoveryID, H.RecoveryDate, SM.SaleManName, Pty.PartyName, B.CustomerID, b.PreviousReceivable," & vbCrLf _
