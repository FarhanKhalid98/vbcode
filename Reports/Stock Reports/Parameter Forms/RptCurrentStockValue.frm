...
Begin VB.Form RptCurrentStockValue 
   AutoRedraw      =   -1  'True
   ...
   ClientWidth     =   12000
   ControlBox      =   0   'False
   Icon            =   "RptCurrentStockValue.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCurrentStockValue.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCurrentStockValue.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCurrentStockValue.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCurrentStockValue.frx":0F1E
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSubGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCurrentStockValue.frx":0F3A
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnCompany 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCurrentStockValue.frx":0F56
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCurrentStockValue.frx":0F72
      BC              =   12632256
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "RptCurrentStockValue"
...
Private Sub BtnPreview_Click()
   If SetReport Then
      If RdoGroupWise.Value = True Then
          RptReportViewer.Caption = "Current Stock Value Group Wise"
          RptReportViewer.Report.ReportTitle = "Current Stock Value (Group Wise)"
      ElseIf RdoSubGroupWIse.Value = True Then
          RptReportViewer.Caption = "Current Stock Value (SubGroup Wise)"
          RptReportViewer.Report.ReportTitle = "Current Stock Value (SubGroup Wise)"
      Else
          RptReportViewer.Caption = "Current Stock Value (Company Wise)"
          RptReportViewer.Report.ReportTitle = "Current Stock Value (Company Wise)"
      End If
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
   ...
   ElseIf KeyCode = vbKeyF1 Then
      Select Case ActiveControl.Name
         ...
         Case TxtSubGroupID.Name: If FunSelectSubGroup(ssFunctionKey, True) = True Then TxtStockLimit.SetFocus
      End Select
   End If
   Exit Sub
ErrorHandler:
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Current Stock Value"
   Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   Set RptCurrentStockValue = Nothing
Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
...
Private Function SetReport() As Boolean
   ...
   If RdoRetail.Value = True Then
      Set RsReport = CN.Execute("EXEC ProdRptCurrentStock '" & IIf(Trim(TxtProductID.Text) = "", "", TxtProductID.Text) & "','" & IIf(Trim(TxtGroupID.Text) = "", "", TxtGroupID.Text) & "','" & IIf(Trim(TxtCompanyID.Text) = "", "", TxtCompanyID.Text) & "','" & IIf(Trim(TxtSubGroupID.Text) = "", "", TxtSubGroupID.Text) & "','" & IIf(TxtStockLimit.Text = "", "", TxtStockLimit.Text) & "'")
   ElseIf RdoWholeSale.Value = True Then
      Set RsReport = CN.Execute("EXEC ProdRptCurrentStockWholeSale '" & IIf(Trim(TxtProductID.Text) = "", "", TxtProductID.Text) & "','" & IIf(Trim(TxtGroupID.Text) = "", "", TxtGroupID.Text) & "','" & IIf(Trim(TxtCompanyID.Text) = "", "", TxtCompanyID.Text) & "','" & IIf(Trim(TxtSubGroupID.Text) = "", "", TxtSubGroupID.Text) & "','" & IIf(TxtStockLimit.Text = "", "", TxtStockLimit.Text) & "'")
   End If
   If RdoGroupWise.Value = True Then
      Set RptReportViewer.Report = New CRptCurrentStockValueGroupWise
      RptReportViewer.Report.ReportTitle = "Current Stock Value (Group Wise)"
   ElseIf RdoSubGroupWIse.Value = True Then
      Set RptReportViewer.Report = New CRptCurrentStockValueSubGroupWise
      RptReportViewer.Report.ReportTitle = "Current Stock Value (SubGroup Wise)"
   Else
      Set RptReportViewer.Report = New CRptCurrentStockValueCompanyWise
      RptReportViewer.Report.ReportTitle = "Current Stock Value (Company Wise)"
   End If
