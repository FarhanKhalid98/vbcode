...
Begin VB.Form frmBarcode128 
   ...
   End
End
Attribute VB_Name = "frmBarcode128"
...
'        fname = Trim(.FileName)
'    End With
    sPath = "C:\" & txtBarcode.Text & ".bmp"
    If Dir(sPath) <> "" Then Kill sPath     'If file exists
    
    SavePicture Me.picSave.Image, "C:\" & txtBarcode.Text & ".bmp"
