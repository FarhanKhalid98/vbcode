...
Begin VB.Form DefCreateProductMeasurements 
   ...
   ClientWidth     =   12000
   ControlBox      =   0   'False
   Icon            =   "DefCreateProductMeasurements.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.Frame FraHelp 
      ...
      Begin VB.TextBox Text1 
         ...
         TabIndex        =   15
         Tag             =   "NC"
         Text            =   "DefCreateProductMeasurements.frx":0ECA
         Top             =   360
         Width           =   3930
      End
   ...
   Begin JeweledBut.JeweledButton BtnNew 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "DefCreateProductMeasurements.frx":0F31
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "DefCreateProductMeasurements.frx":0F4D
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "DefCreateProductMeasurements.frx":0F69
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "DefCreateProductMeasurements.frx":0F85
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnUnit 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "DefCreateProductMeasurements.frx":0FA1
      BC              =   14737632
      FC              =   0
   End
