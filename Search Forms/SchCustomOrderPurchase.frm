...
Begin VB.Form SchCustomOrderPurchase 
   AutoRedraw      =   -1  'True
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchCustomOrderPurchase.frx":0000
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnSelect 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchCustomOrderPurchase.frx":001C
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchCustomOrderPurchase.frx":0038
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "SchCustomOrderPurchase"
...
Private Sub LoadGrid()
   ...
   vStrSQL = "SELECT PurchaseID, PurchaseDate, case when d.credit = 1 then 'Credit' when d.cash = 1 then 'Cash' when d.BankCard = 1 then 'Bank Card' end as PaymentType" & vbCrLf _
         + " , d.VenderName, TotalAmount, Payment, TotalItems, UserName" & vbCrLf _
         + " FROM CustomOrderPurchase D " & vbCrLf _
         ...
         + " WHERE PurchaseDate between '" & DtpFromDate.DateValue & "' and '" & DtpToDate.DateValue & "'" & IIf(ObjUserSecurity.IsAdministrator = False And ObjUserSecurity.IsManager = False, " and h.userno=" & ObjUserSecurity.UserNo, "") & vPartyName & vOrder & vDirection
   Rs.Open vStrSQL, CN, adOpenStatic, adLockReadOnly
   Set Grid.DataSource = Rs
   Grid.Columns("ID").DataField = "PurchaseID"
   Grid.Columns("Date").DataField = "PurchaseDate"
...
Private Sub BtnSelect_Click()
   ...
   Me.ParaOutPurchaseID = Rs!PurchaseID
   Unload Me
   Exit Sub
ErrorHandler:
   Call ShowErrorMessage
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
   ...
   If KeyCode = vbKeyReturn Then
      ...
      Case Grid.Name, TxtPurchaseID.Name, DtpFromDate.Name, DtpToDate.Name
...
Private Sub TxtPurchaseID_Change()
   ...
   Rs.Find "PurchaseID = " & TxtPurchaseID.Text, , adSearchForward, 1
...
Private Sub TxtVenderName_Change()
   On Error GoTo ErrorHandler
   vPartyName = " and VenderName like '%" & TxtVenderName.Text & "%'"
   LoadGrid
   Exit Sub
ErrorHandler:
   Call ShowErrorMessage
