...
Begin VB.Form SchStockWastage 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchStockWastage.frx":0000
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnSelect 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchStockWastage.frx":001C
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchStockWastage.frx":0038
      BC              =   14737632
      FC              =   0
   End
...
Public ParaInWastageDate As String

Private Sub LoadGrid()
   On Error GoTo ErrorHandler
   Set Rs = New ADODB.Recordset
   VStrSQL = "SELECT h.WastageID, h.WastageDate" & vbCrLf _
         ...
         + " WHERE h.WastageDate ='" & DtpDate.DateValue & "'" & IIf(ObjUserSecurity.IsAdministrator = False, " and h.userno=" & ObjUserSecurity.UserNo, "") & IIf(vSessionID = 0, "", " and SessionID = " & vSessionID) & vOrder & vDirection
...
Private Sub Form_Load()
   ...
   DtpDate.DateValue = ParaInWastageDate
   Me.ParaOutWastageID = 0
   Me.ParaOutWastageDate = ""
