...
Begin VB.Form SchLoan 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "SchLoan.frx":0054
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid GridDetail 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "SchLoan.frx":0070
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
      AllowRowSizing  =   0   'False
      AllowGroupSizing=   0   'False
...
Private Sub LoadData()
   ...
   vSQL = " Select h.VoucherNo ID, Voucherdate as Date, Sum(Amount) as Amount, UserName, Tag" & vbCrLf _
      + " from LoanVouchers h inner join LoanVouchersbody b on h.voucherno = b.voucherno " & vbCrLf _
...
Private Sub LoadDetail()
  On Error GoTo ErrorHandler
    vSQL = " Select AccountName, Amount from LoanVouchers h" & vbCrLf _
      + " inner join LoanVouchersbody b on h.voucherno = b.voucherno" & vbCrLf _
      + " inner join chartofaccounts c on c.accountno = b.accountno" & vbCrLf _
