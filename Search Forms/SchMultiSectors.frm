...
Begin VB.Form SchSector 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchMultiSectors.frx":0000
      AllowAddNew     =   -1  'True
      AllowDelete     =   -1  'True
      MultiLine       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchMultiSectors.frx":001C
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnSelect 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchMultiSectors.frx":0038
      BC              =   14737632
      FC              =   0
   End
...
Public ParaOutSectorID As String, vSelection As String
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
   ...
   If KeyCode = vbKeyReturn Then
      ...
      Case Grid.Name, TxtSectorID.Name, TxtSectorName.Name
...
Private Sub Grid_KeyPress(KeyAscii As Integer)
   ...
   Case Asc("a") To Asc("z"), Asc("A") To Asc("Z")
      TxtSectorName.Text = Chr(KeyAscii): TxtSectorName.SelStart = Len(TxtSectorName.Text): TxtSectorName.SetFocus
   Case vbKey0 To vbKey9
      TxtSectorID.Text = Chr(KeyAscii): TxtSectorID.SelStart = Len(TxtSectorID.Text): TxtSectorID.SetFocus
   End Select
End Sub
...
Private Sub TxtSectorID_Change()
   On Error GoTo ErrorHandler
   If Trim(TxtSectorID.Text) = "" Then Grid.MoveFirst: Exit Sub
   Rs.Find "SectorId like " & Val(TxtSectorID.Text), , adSearchForward, 1
...
Private Sub TxtSectorName_Change()
   On Error GoTo ErrorHandler
   If Trim(TxtSectorName.Text) = "" Then Grid.MoveFirst: Exit Sub
   Rs.Find "SectorName like '" & TxtSectorName.Text & "%'", , adSearchForward, 1
   If Rs.EOF Then Grid.MoveLast
   Exit Sub
ErrorHandler:
   Call ShowErrorMessage
...
Private Sub LoadData()
   vStrSQL = "SELECT * FROM Sectors" & vOrder & vDirection
   ...
   Do Until Rs.EOF
     Grid.AddNew
     Grid.Columns("ID").Text = Rs!SectorId
     Grid.Columns("Name").Text = Rs!SectorName
