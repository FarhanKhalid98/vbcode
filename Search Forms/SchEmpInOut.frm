...
Begin VB.Form SchEmpInOut 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchEmpInOut.frx":0ECA
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
...
Private Sub LoadGrid()
   ...
   vSQL = "SELECT  EmpName as EmployeeName" & vbCrLf _
         ...
         + " WHERE DateOut is Null " & IIf(ChkAllIn.Value = 1, "", " And AttendDate = '" & DtpFrom.DateValue & "'") & vOrder & vDirection
