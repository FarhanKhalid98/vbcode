...
Begin VB.Form frmBarcodeViewer 
   ...
   ClientWidth     =   3600
   ForeColor       =   &H8000000C&
   Icon            =   "frmBarcodeGenerator1.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   179
   ScaleMode       =   3  'Pixel
...
picEan.Print "   786 Self Store  Rs.10/-"
For i = 1 To m_lBarcodeLength     '8 or 13 digit code
    ...
    .CurrentY = 47
    Dim length, pos, a
    length = Len("Nestle Cere Lac Wheat & Milk 400 G")
    If length > 25 Then
      a = Left("Nestle Cere Lac Wheat & Milk 400 G", 25)
      pos = InStrRev(a, " ")
      picEan.Print Space(5) & Left("Nestle Cere Lac Wheat & Milk 400 G", pos)
      .CurrentY = 59
      picEan.Print Space(5) & Right("Nestle Cere Lac Wheat & Milk 400 G", length - pos)
     Else
...
picEan.Line (r_lPositionX, 15)-(r_lPositionX, 35 + r_bytExtension)
End Sub
