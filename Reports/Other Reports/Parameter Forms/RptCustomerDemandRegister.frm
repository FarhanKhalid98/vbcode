...
Begin VB.Form RptCustomerDemandRegister 
   AutoRedraw      =   -1  'True
   ...
   ClientTop       =   375
   ClientWidth     =   15360
   Icon            =   "RptCustomerDemandRegister.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   742
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCustomerDemandRegister.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCustomerDemandRegister.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCustomerDemandRegister.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnStore 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCustomerDemandRegister.frx":0F1E
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnVendor 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCustomerDemandRegister.frx":0F3A
      BC              =   12632256
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCustomerDemandRegister.frx":0F56
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSubGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCustomerDemandRegister.frx":0F72
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnCompany 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptCustomerDemandRegister.frx":0F8E
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "RptCustomerDemandRegister"
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Customer Demand Register"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   For Each frmObj In Forms
       Set frmObj = Nothing
   Next
   Set RptCustomerDemandRegister = Nothing
   Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
...
Private Function SetReport() As Boolean
   ...
   Set RsReport = CN.Execute("EXEC ProdRptCustomerDemandRegister '" & DtpFrom.DateValue & "','" & DtpTo.DateValue & "'," & IIf(Val(TxtStoreID.Text) = 0, "Null", Val(TxtStoreID.Text)))
   Set RptReportViewer.Report = New CrptCustomerDemandRegsiter
   RptReportViewer.Report.ReportTitle = "Customer Demand Register"
