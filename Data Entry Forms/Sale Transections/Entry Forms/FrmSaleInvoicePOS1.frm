...
Begin VB.Form FrmSaleInvoicePOS 
   ...
   ClientTop       =   480
   ClientWidth     =   15360
   Icon            =   "FrmSaleInvoicePOS1.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   758
   ...
   Begin VB.Frame Frame1 
      ...
      Begin JeweledBut.JeweledButton BtnCancel 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "FrmSaleInvoicePOS1.frx":0ECA
         BC              =   14737632
         FC              =   0
      End
      Begin JeweledBut.JeweledButton BtnOk 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "FrmSaleInvoicePOS1.frx":0EE6
         BC              =   14737632
         FC              =   0
      End
      Begin VB.Frame FrameCredit 
         ...
         Begin JeweledBut.JeweledButton BtnCustomer 
            ...
            FOCUSR          =   -1  'True
            MPTR            =   0
            MICON           =   "FrmSaleInvoicePOS1.frx":0F02
            BC              =   12632256
            FC              =   0
         End
         ...
         Begin JeweledBut.JeweledButton BtnAddCustomer 
            ...
            FOCUSR          =   -1  'True
            MPTR            =   0
            MICON           =   "FrmSaleInvoicePOS1.frx":0F1E
            BC              =   12632256
            FC              =   0
         End
         ...
         Begin JeweledBut.JeweledButton BtnBankMachineCredit 
            ...
            FOCUSR          =   -1  'True
            MPTR            =   0
            MICON           =   "FrmSaleInvoicePOS1.frx":0F3A
            BC              =   12632256
            FC              =   0
         End
      ...
      Begin VB.Frame FrameBank 
         ...
         Begin JeweledBut.JeweledButton BtnBankMachine 
            ...
            FOCUSR          =   -1  'True
            MPTR            =   0
            MICON           =   "FrmSaleInvoicePOS1.frx":0F56
            BC              =   12632256
            FC              =   0
         End
   ...
   Begin VB.Frame Frame3 
      ...
      Begin SSDataWidgets_B_OLEDB.SSOleDBGrid GridSerial 
         ...
         BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         stylesets(0).Picture=   "FrmSaleInvoicePOS1.frx":0F72
         AllowDelete     =   -1  'True
         AllowUpdate     =   0   'False
         MultiLine       =   0   'False
   ...
   Begin VB.Frame FraHelp 
      ...
      Begin VB.TextBox Text1 
         ...
         TabIndex        =   68
         Tag             =   "NC"
         Text            =   "FrmSaleInvoicePOS1.frx":0F8E
         Top             =   300
         Width           =   3975
      End
   ...
   Begin JeweledBut.JeweledButton BtnDelete 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS1.frx":1105
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS1.frx":1121
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnOpen 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS1.frx":113D
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS1.frx":1159
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS1.frx":1175
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS1.frx":1191
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnStore 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS1.frx":11AD
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnEmployee 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS1.frx":11C9
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnMember 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS1.frx":11E5
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnOrganization 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS1.frx":1201
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnTable 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS1.frx":121D
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS1.frx":1239
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSaleOrder 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS1.frx":1255
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSaveAS 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS1.frx":1271
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSyllabus 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS1.frx":128D
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmSaleInvoicePOS1.frx":12A9
      stylesets(1).Name=   "Red"
      stylesets(1).ForeColor=   665589
      ...
      BeginProperty stylesets(1).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(1).Picture=   "FrmSaleInvoicePOS1.frx":12C5
      stylesets(2).Name=   "Blue"
      ...
      BeginProperty stylesets(2).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(2).Picture=   "FrmSaleInvoicePOS1.frx":12E1
      ...
      BeginProperty stylesets(3).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(3).Picture=   "FrmSaleInvoicePOS1.frx":12FD
      ...
      BeginProperty stylesets(4).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(4).Picture=   "FrmSaleInvoicePOS1.frx":1319
      ...
      BeginProperty stylesets(5).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(5).Picture=   "FrmSaleInvoicePOS1.frx":1335
      AllowUpdate     =   0   'False
      AllowGroupSizing=   0   'False
      AllowColumnSizing=   0   'False
      AllowGroupMoving=   0   'False
...
'   VStrSQL = " Select UserName, h.billid, h.BillDate, isnull(h.BillTime,0) as BillTime, h.Description, h.TotalAmount as tbill, isnull(h.Billdisc,0) as discount, isnull(h.ServiceCharges,0) as ServiceCharges, isnull(h.STax,0) as STax, isnull(h.cashReceived,0) as CashReceived, case when isdeadproduct = 1 then 'Book' else  p.ProductName end /*case when isproduct = 1 then p.ProductName else dbo.FunGetProduct(h.billid, h.BillDate) end */ ProductName, p.productName1, unitname, isnull(QtyPack,0) * isnull(Multiplier,0) + Isnull(Bonus,0) + b.qty as Qty, b.price/isnull(multiplier,1) as price, b.amount, b.DiscPC, b.DiscPer, b.DiscVal, isnull(b.SC,0) as SC, InvoiceNo, " & IIf(ObjRegistry.AllowUrduProduct = False, " isnull(Remarks,'')", " isnull(RemarksUrdu,'')") & " as Remarks" & vbCrLf _
  ...
  If vFBRInvoiceNo <> "" Then
      GenerateBMP StrPtr("D:\Example.bmp"), StrPtr(vFBRInvoiceNo), 3, 10, QualityStandard
      SaveFBRInvoiceImage
  End If
