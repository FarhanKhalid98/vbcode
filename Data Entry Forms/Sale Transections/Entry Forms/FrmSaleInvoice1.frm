...
Begin VB.Form FrmSaleInvoice 
   ...
   Begin JeweledBut.JeweledButton BtnSProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoice1.frx":0ECA
      BC              =   12632256
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnDelete 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoice1.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoice1.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnOpen 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoice1.frx":0F1E
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoice1.frx":0F3A
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoice1.frx":0F56
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid GridSale 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmSaleInvoice1.frx":0F72
      AllowUpdate     =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoice1.frx":0F8E
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnStore 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoice1.frx":0FAA
      BC              =   12632256
      FC              =   0
   End
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
   ...
   ElseIf KeyCode = vbKeyReturn Then
      ...
      Case TxtQty.Name, TxtDiscPC.Name, TxtDiscPer.Name, TxtDiscVal.Name
               ...
               If Grid.Columns("Productid").Text = TxtPID.Text Then
                  ...
                  With CN.Execute("select * from registry")
                     If .RecordCount > 0 Then
                        If !NegativeSale = False Then
                           If DtpBillDate.Enabled = True Then
                              If (Val(LblStock.Caption) - Val(TxtQty.Text) - Val(Grid.Columns("Qty").Value)) < 0 Then
                                 MsgBox "Insufficient Stock for this Product", vbInformation + vbOKOnly, "Error"
                                 Grid.MoveLast
                                 Grid.Redraw = True
                                 Exit Sub
                              End If
                           Else
                              If (Val(LblStock.Caption) - Val(TxtQty.Text) - Val(Grid.Columns("Qty").Value) + Val(Grid.Columns("QtyOrigional").Value)) < 0 Then
                                 MsgBox "Insufficient Stock for this Product", vbInformation + vbOKOnly, "Error"
                                 Grid.MoveLast
                                 Grid.Redraw = True
                                 Exit Sub
   ...
   With Grid
      With CN.Execute("select * from registry")
         If .RecordCount > 0 Then
            If !NegativeSale = False Then
               If DtpBillDate.Enabled = True Then
                  If (Val(LblStock.Caption) - Val(TxtQty.Text)) < 0 Then
                     MsgBox "Insufficient Stock for this Product", vbInformation + vbOKOnly, "Error"
                     Grid.Redraw = True
                     Exit Sub
                  End If
               Else
                  If (Val(LblStock.Caption) - Val(TxtQty.Text) + Val(Grid.Columns("QtyOrigional").Value)) < 0 Then
                     MsgBox "Insufficient Stock for this Product", vbInformation + vbOKOnly, "Error"
                     Grid.Redraw = True
                     Exit Sub
                  End If
