...
Private Sub LoadData()
   ...
   vSQL = " Select Sum(Amount) as Amount " & vbCrLf _
      + " from Debitvouchers h inner join Debitvouchersbody b on h.voucherno = b.voucherno " & vbCrLf _
      + " inner join chartofaccounts c on c.accountno = b.accountno" & vbCrLf _
      + " inner join Users u on u.UserNo = h.UserNo" & vbCrLf _
      + " Where Voucherdate between '" & DtpFrom.DateValue & "' AND '" & DtpTo.DateValue & "'" & vbCrLf _
...
Private Sub LoadDetail()
   On Error GoTo ErrorHandler
   vSQL = " Select c.AccountName + isnull(' (' + p.Address + ')','')  as AccountName, Amount from Debitvouchers h" & vbCrLf _
      + " inner join Debitvouchersbody b on h.voucherno = b.voucherno" & vbCrLf _
      + " inner join chartofaccounts c on c.accountno = b.accountno" & vbCrLf _
