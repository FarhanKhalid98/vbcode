...
Begin VB.Form FrmAutoBackupDB 
   ...
   Begin VB.ComboBox CmbHHmm 
      Height          =   315
      ItemData        =   "FrmAutoBackupDB.frx":0ECA
      Left            =   5445
      List            =   "FrmAutoBackupDB.frx":0ED4
   ...
   Begin JeweledBut.JeweledButton btnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmAutoBackupDB.frx":0EEC
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton btnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmAutoBackupDB.frx":0F08
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton btnOpen 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmAutoBackupDB.frx":0F24
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton btndelete 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmAutoBackupDB.frx":0F40
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton btnBackup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmAutoBackupDB.frx":0F5C
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton btnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmAutoBackupDB.frx":0F78
      BC              =   14737632
      FC              =   0
   End
