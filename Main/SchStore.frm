...
Begin VB.Form SchStore 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchStore.frx":0000
      AllowUpdate     =   0   'False
...
Private Sub Grid_KeyPress(KeyAscii As Integer)
   ...
   Case vbKey0 To vbKey9
      TxtStoreID.Text = Chr(KeyAscii): TxtStoreID.SelStart = Len(TxtStoreID.Text): TxtStoreID.SetFocus
   End Select
End Sub
...
Private Sub TxtStoreID_Change()
   On Error GoTo ErrorHandler
   If Trim(TxtStoreID.Text) = "" Then Grid.MoveFirst: Exit Sub
   Rs.Find "StoreID =" & TxtStoreID.Text, , adSearchForward, 1
