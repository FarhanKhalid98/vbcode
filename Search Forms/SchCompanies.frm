...
Begin VB.Form SchCompanies 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchCompanies.frx":E7FA
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
   ...
   End
End
Attribute VB_Name = "SchCompanies"
...
Public ParaOutCompanyID As String
...
Private Sub BtnSelect_Click()
  ...
  Me.ParaOutCompanyID = Rs!companyid
  Unload Me
  Exit Sub
ErrorHandler:
...
Private Sub TxtCompanyID_Change()
   ...
   Rs.Find "CompanyID like '" & TxtCompanyID.Text & "%'", , adSearchForward, 1
...
Private Sub LoadData()
   VStrSQL = "SELECT * FROM Companies" & vOrder & vDirection
