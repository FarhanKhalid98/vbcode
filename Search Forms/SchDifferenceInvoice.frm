...
Begin VB.Form SchDifferenceInvoice 
   AutoRedraw      =   -1  'True
   BorderStyle     =   0  'None
   ClientHeight    =   9000
   ClientLeft      =   0
   ...
   Begin JeweledBut.JeweledButton BtnSelect 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchDifferenceInvoice.frx":0000
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchDifferenceInvoice.frx":001C
      BC              =   14737632
      FC              =   0
   End
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "SchDifferenceInvoice.frx":0038
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
   ...
   End
End
Attribute VB_Name = "SchDifferenceInvoice"
...
Public ParaOutDifferenceID As String
Public ParaOutInvoiceDate As String
Public ParaInInvoiceDate As String

Private Sub LoadGrid()
   On Error GoTo ErrorHandler
   Set Rs = New ADODB.Recordset
   vStrSQL = "SELECT h.DisputeID as ID, DisputeDate as Date, InvoiceType, Tag, h.StoreID" & vbCrLf _
...
Private Sub BtnClose_Click()
  Me.ParaOutDifferenceID = ""
  Me.ParaOutInvoiceDate = ""
  Unload Me
End Sub
...
Private Sub BtnSelect_Click()
  ...
  Me.ParaOutDifferenceID = Rs!ID
  Me.ParaOutInvoiceDate = Rs!Date
  Unload Me
  Exit Sub
ErrorHandler:
  Call ShowErrorMessage
