...
Begin VB.Form RptSaleRegister 
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptSaleRegister.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptSaleRegister.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptSaleRegister.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptSaleRegister.frx":0F1E
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnOrganizaton 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptSaleRegister.frx":0F3A
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnStore 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptSaleRegister.frx":0F56
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptSaleRegister.frx":0F72
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSubGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptSaleRegister.frx":0F8E
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnCompany 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptSaleRegister.frx":0FAA
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnUser 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptSaleRegister.frx":0FC6
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnCustomer 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptSaleRegister.frx":0FE2
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnEmpName 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptSaleRegister.frx":0FFE
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSector 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptSaleRegister.frx":101A
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnZone 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptSaleRegister.frx":1036
      BC              =   14737632
      FC              =   0
   End
...
Private Function SetReport() As Boolean
    ...
    sSql = "EXEC ProdRptSaleRegister '" & DtpFrom.DateValue & "','" & DtpTo.DateValue & "'," & IIf(Trim(TxtOrganizationID.Text) = "", "Null", "'" & TxtOrganizationID.Text & "'") & "," & IIf(Trim(TxtStoreID.Text) = "", "Null", "'" & TxtStoreID.Text & "'") & "," & IIf(Trim(TxtZoneID.Text) = "", "Null", "'" & TxtZoneID.Text & "'") & vbCrLf _
                              & "," & IIf(Trim(TxtSectorID.Text) = "", "Null", "'" & TxtSectorID.Text & "'") & "," & IIf(Trim(TxtPartyID.Text) = "", "Null", "'" & TxtPartyID.Text & "'") & "," & IIf(Trim(TxtEmpID.Text) = "", "Null", "'" & TxtEmpID.Text & "'") & "," & IIf(Trim(TxtUserNo.Text) = "", "Null", "'" & TxtUserNo.Text & "'") & "," & IIf(Trim(TxtCompanyID.Text) = "", "Null", "'" & TxtCompanyID.Text & "'") & "," & IIf(Trim(TxtGroupID.Text) = "", "Null", "'" & TxtGroupID.Text & "'") & "," & IIf(Trim(TxtSubGroupID.Text) = "", "Null", "'" & TxtSubGroupID.Text & "'") & "," & IIf(Trim(TxtProductID.Text) = "", "Null", "'" & TxtProductID.Text & "'") & "," & IIf(RdoBoth.Value = True, "Null", IIf(RdoInv.Value = True, 0, 1))
    If RdoDetail.Value = True Then
