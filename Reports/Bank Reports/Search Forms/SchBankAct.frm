...
Begin VB.Form SchBankAct 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchBankAct.frx":0000
      AllowAddNew     =   -1  'True
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
...
Private Sub cmbfilter_click()
   ...
   End If
   Set Rs = CN.Execute("select AccountNo, AccountName from ChartOfAccounts   " & vwhere)
...
Private Sub Form_Load()
   ...
   With CN.Execute("select AccountNo from ChartOfAccounts")
      Do Until .EOF
