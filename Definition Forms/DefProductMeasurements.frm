...
Begin VB.Form DefProductMeasurements 
   ...
   ClientWidth     =   12000
   ControlBox      =   0   'False
   Icon            =   "DefProductMeasurements.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.Frame FraHelp 
      ...
      Begin VB.TextBox Text1 
         ...
         TabIndex        =   6
         Tag             =   "NC"
         Text            =   "DefProductMeasurements.frx":0ECA
         Top             =   360
         Width           =   3930
      End
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "DefProductMeasurements.frx":0F0E
      ...
      BeginProperty stylesets(1).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(1).Picture=   "DefProductMeasurements.frx":16FC
      ...
      BeginProperty stylesets(2).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(2).Picture=   "DefProductMeasurements.frx":2016
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "DefProductMeasurements.frx":2032
      BC              =   14737632
      FC              =   0
   End
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "DefProductMeasurements.frx":204E
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "DefProductMeasurements.frx":25F4
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin JeweledBut.JeweledButton BtnRefresh 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "DefProductMeasurements.frx":2FAD
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin VB.Label LblCaption 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Ordered Product and Measurements"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   13.5
         Charset         =   178
   ...
   Begin VB.Menu MnuAccounts 
      ...
      Begin VB.Menu mniCreateNewChildGroup 
         Caption         =   "Create new Child Product"
      End
      Begin VB.Menu mniModifyPropertiesForGroup 
         Caption         =   "Modify the Properties for this Product"
      End
      Begin VB.Menu mniDeleteGroup 
         Caption         =   "Delete this Product"
      End
      Begin VB.Menu MniSep1 
         Caption         =   "-"
      End
      Begin VB.Menu mniCreatenewAccounts 
         Caption         =   "Create new Measurements for this Product"
      End
      Begin VB.Menu mniModifyAccount 
         Caption         =   "Modify the Selected Measurements"
      End
      Begin VB.Menu mniDeleteAccount 
         Caption         =   "Delete this Measurements"
      End
   End
End
Attribute VB_Name = "DefProductMeasurements"
...
Private Sub RefreshMeasurementList()
  ...
  With CN.Execute("Select * FROM ProductMeasurements where isdetailed=0 Order by ID")
    Do Until .EOF
...
Private Sub mniCreatenewAccounts_Click()
  ...
  With DefCreateProductMeasurements
    ...
    .ParaInIsNew = True
    .ParaInParentName = CN.Execute("Select Name from ProductMeasurements where ID = '" & Left(Replace(TvwGroups.SelectedItem.Key, "Account:", ""), 2) & "'").Fields(0)
...
Private Sub mniDeleteAccount_Click()
  ...
  vtbl = Common.ChildDataExists("ProductMeasurements", "ID='" & Grid.Columns("ID").Text & "'", "")
  If vtbl <> "" Then
  ...
  CN.Execute ("Delete From ProductMeasurements Where ID = '" & Grid.Columns("ID").Text & "'")
  Exit Sub
ErrorHandler:
  Call ShowErrorMessage
End Sub
...
Private Sub mniDeleteGroup_Click()
  ...
  vtbl = Common.ChildDataExists("ProductMeasurements", "ID='" & Replace(TvwGroups.SelectedItem.Key, "Account:", "") & "'", "")
  If CN.Execute("Select count(*) FROM ProductMeasurements Where ParentID = '" & Replace(TvwGroups.SelectedItem.Key, "Account:", "") & "'").Fields(0) > 0 Then
  ...
  CN.Execute ("Delete From ProductMeasurements Where ID = '" & Replace(TvwGroups.SelectedItem.Key, "Account:", "") & "'")
...
Private Sub mniModifyAccount_Click()
  ...
  With DefCreateProductMeasurements
    ...
    .ParaInIsGroup = False
    .ParaInIsLocked = CN.Execute("Select islocked from ProductMeasurements where ID = '" & Grid.Columns("ID").Text & "'").Fields(0)
    .ParaInIsNew = False
    .ParaInParentName = CN.Execute("Select Name from ProductMeasurements where ID = '" & Left(Replace(TvwGroups.SelectedItem.Key, "Account:", ""), 1) & "'").Fields(0)
    .ParaInParentID = Replace(TvwGroups.SelectedItem.Key, "Account:", "")
...
Private Sub mniModifyPropertiesForGroup_Click()
  ...
  With DefCreateProductMeasurements
    ...
    .ParaInIsGroup = True
    .ParaInIsLocked = CN.Execute("Select islocked from ProductMeasurements where ID = '" & Replace(TvwGroups.SelectedItem.Key, "Account:", "") & "'").Fields(0)
    .ParaInIsNew = False
    If TypeName(TvwGroups.SelectedItem.Parent) <> "Nothing" Then .ParaInParentName = CN.Execute("Select Name from ProductMeasurements where ID = '" & Left(Replace(TvwGroups.SelectedItem.Key, "Account:", ""), 1) & "'").Fields(0)
...
Private Sub TvwGroups_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
  ...
  If Button = 2 And Shift = 0 Then
    ...
    mniCreatenewAccounts.Enabled = (Len(vid) = 2)
    mniCreateNewChildGroup.Enabled = (Len(vid) = 1)
...
Private Sub TvwGroups_NodeClick(ByVal Node As MSComctlLib.Node)
  ...
  Set RsPM = CN.Execute("SElect p.*, UnitName, cast(IsDetailed as varchar)+cast(IsLocked as varchar)+cast(IsEditable as varchar) as Flags FROM ProductMeasurements p left outer join units u on u.unitid = p.unitid Where ParentID = '" & vid & "' AND IsDetailed=1")
