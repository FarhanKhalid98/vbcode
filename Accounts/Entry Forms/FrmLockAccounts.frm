...
Begin VB.Form FrmLockAccounts 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmLockAccounts.frx":0F1C
      ...
      BeginProperty stylesets(1).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(1).Picture=   "FrmLockAccounts.frx":0F38
      MultiLine       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmLockAccounts.frx":0F54
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmLockAccounts.frx":0F70
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmLockAccounts.frx":0F8C
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "FrmLockAccounts"
...
Private Sub cmbfilter_click()
  ...
  Rs.Open "Select * FROM ChartOfAccounts Where AccountNo Like '" & CmbFilter.ItemData(CmbFilter.ListIndex) & "%'", cn, adOpenStatic, adLockBatchOptimistic
  Grid.Redraw = False
  Grid.CancelUpdate
  Grid.RemoveAll
  ...
  Do Until Rs.EOF
    ...
    Grid.Columns("Locked").Value = Rs!IsLocked
    Grid.Update
    Rs.MoveNext
  Loop
 ...
 On Error GoTo ErrorHandler
   ...
   While Not Rs.EOF
      If Rs.EditMode <> adEditNone Then
         Call ActivityLog("Lock Accounts", eEdit, , , Rs!AccountNo)
      End If
      Rs.MoveNext
   Wend
   Rs.UpdateBatch
...
Private Sub Form_Load()
  On Error GoTo ErrorHandler
  SetWindowText Me.hWnd, "Lock Accounts"
  ShowPicture Me, 2
  AddLabelEffect Me, 2, vbWhite, vbBlack, lblEffectBorder
  HelpLocation Me
  With cn.Execute("Select AccountNo, AccountName from ChartofAccounts Where isdetailed = 0")
    Do Until .EOF
...
Private Sub TxtAccountName_Change()
  ...
  End If
  'Me.MousePointer = vbHourglass
  Rs.Open "Select * FROM ChartOfAccounts Where AccountNo Like '" & CmbFilter.ItemData(CmbFilter.ListIndex) & "%' and AccountName like '%" & TxtAccountName.Text & "%'", cn, adOpenStatic, adLockBatchOptimistic
  Grid.Redraw = False
  Grid.CancelUpdate
  Grid.RemoveAll
  vSuppressUpdateEvent = True
