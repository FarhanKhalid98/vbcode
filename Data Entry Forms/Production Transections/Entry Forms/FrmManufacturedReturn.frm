...
Begin VB.Form FrmManufacturedReturn 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   11130
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   15360
   Icon            =   "FrmManufacturedReturn.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   742
   ...
   Begin VB.Frame FraHelp 
      ...
      Begin VB.TextBox Text1 
         ...
         TabIndex        =   29
         Tag             =   "NC"
         Text            =   "FrmManufacturedReturn.frx":0ECA
         Top             =   360
         Width           =   3975
      End
   ...
   Begin JeweledBut.JeweledButton BtnDelete 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmManufacturedReturn.frx":0FAA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmManufacturedReturn.frx":0FC6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnOpen 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmManufacturedReturn.frx":0FE2
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmManufacturedReturn.frx":0FFE
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmManufacturedReturn.frx":101A
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnManufacturedProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmManufacturedReturn.frx":1036
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmManufacturedReturn.frx":1052
      AllowUpdate     =   0   'False
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid GridUsed 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmManufacturedReturn.frx":106E
      AllowUpdate     =   0   'False
      AllowRowSizing  =   0   'False
      AllowGroupSizing=   0   'False
      AllowColumnSizing=   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnStore 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmManufacturedReturn.frx":108A
      BC              =   12632256
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "FrmManufacturedReturn"
...
Private Sub BtnDelete_Click()
   ...
   ''''''''''''' User Authentication ''''''''''''''
   vUserAction = UserAuthentication("MniManufacturedReturn", vUser, ObjUserSecurity.IsAdministrator, eUserDelete)
   If vUserAction <> "" Then
...
'         CN.Execute "Delete from ManufacturedReturnUsed where ReturnID=" & Val(TxtReturnID.Text) & " and ProductID='" & GridUsed.Columns("Productid").Text & "'"
'      End If
'      GridUsed.MoveNext
'   Next vCounter
'   GridUsed.RemoveAll
'   GridUsed.Redraw = True
   'Header
   Call ActivityLog("Manufactured Return", eDelete, TxtReturnID.Text)
...
Private Sub BtnOpen_Click()
   SchManufacturedReturn.Show vbModal
   If SchManufacturedReturn.ParaOutReturnID = 0 Then Exit Sub
   TxtReturnID.Text = SchManufacturedReturn.ParaOutReturnID
   GetManufacturedReturn
End Sub
...
Private Sub BtnSave_Click()
  On Error GoTo ErrorHandler
   ...
   ''''''''''''' User Authentication ''''''''''''''
   vUserAction = UserAuthentication("MniManufacturedReturn", vUser, ObjUserSecurity.IsAdministrator, IIf(vIsNewRecord = True, eUserNewRecord, eUserEdit))
   If vUserAction <> "" Then
      MsgBox vUserAction, vbCritical, "Error"
      Exit Sub
   End If
...
'  Header Validation
   ...
   If RsBody.RecordCount = 0 Then
      MsgBox "Please enter at least one Manufactured Return", vbExclamation, "Alert"
      If TxtCode.Visible And TxtCode.Enabled Then TxtCode.SetFocus
      Exit Sub
   End If
   cn.BeginTrans
'   ' delete from manufacture product used
'   With CN.Execute("Select * from ManufacturedReturnUsed where ReturnID=" & Val(TxtReturnID.Text))
'      While Not .EOF
'         CN.Execute "Delete from ManufacturedReturnUsed where ReturnID=" & !ReturnID & " and ProductID='" & !ProductID & "'"
'         .MoveNext
'      Wend
'      .Close
'   End With
   If vIsNewRecord = False Then Call ActivityLog("Manufactured Return", eEdit, TxtReturnID.Text)
  ...
  ' validation has been performed when a row is added to the grid
   With RsBody
      ...
      .UpdateBatch
   End With
   If vIsNewRecord = True Then Call ActivityLog("Manufactured Return", eAdd, TxtReturnID.Text)
   cn.CommitTrans
   FormStatus = NewMode
   Exit Sub
ErrorHandler:
...
Private Sub PopulateDataToGrid()
   ...
   RsBody.Open "Select * from ManufacturedReturnBody where ReturnID=" & Val(TxtReturnID.Text), cn, adOpenDynamic, adLockBatchOptimistic
   If RsBody.RecordCount > 0 Then
...
Private Sub PopulateDataToUsed()
   ssql = "select ProductName, u.* from ManufacturedReturnUsed u join products p on p.productid = u.productid where ReturnID=" & Val(TxtReturnID.Text)
   With cn.Execute(ssql)
      GridUsed.Redraw = False
      GridUsed.MoveFirst
      GridUsed.RemoveAll
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Manufactured Return"
   HelpLocation Me
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   Next
   Set RsBody = Nothing
   Set FrmManufacturedReturn = Nothing
   End If
   Exit Sub
ErrorHandler:
   Call ShowErrorMessage
...
Private Sub GetManufacturedReturn()
   On Error GoTo ErrorHandler
   ssql = "select ReturnID, ReturnDate, h.StoreID, StoreName FROM ManufacturedReturnHeader h join Stores s on h.storeid = s.storeid where ReturnID=" & Val(TxtReturnID.Text)
   With cn.Execute(ssql)
      If Not .BOF Then
