...
Begin VB.Form RptDemandListStoreWise 
   AutoRedraw      =   -1  'True
   ...
   ClientTop       =   375
   ClientWidth     =   15360
   Icon            =   "RptDemandListStoreWise.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   742
   ...
   Begin VB.OptionButton RdoMin 
      BackColor       =   &H00FFFFFF&
      Caption         =   "Minimun Demand"
      Height          =   375
      Left            =   4598
      TabIndex        =   5
      Top             =   7350
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDemandListStoreWise.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDemandListStoreWise.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDemandListStoreWise.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDemandListStoreWise.frx":0F1E
      BC              =   12632256
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDemandListStoreWise.frx":0F3A
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSubGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDemandListStoreWise.frx":0F56
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnCompany 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDemandListStoreWise.frx":0F72
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnStore 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDemandListStoreWise.frx":0F8E
      BC              =   12632256
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "RptDemandListStoreWise"
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
   ...
   ElseIf KeyCode = vbKeyF1 Then
      Select Case ActiveControl.Name
         ...
         Case TxtSubGroupID.Name: If FunSelectSubGroup(ssFunctionKey, True) = True Then TxtCompanyID.SetFocus
         Case TxtCompanyID.Name: If FunSelectCompany(ssFunctionKey, True) = True Then RdoMin.SetFocus
      End Select
   End If
   Exit Sub
ErrorHandler:
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Demand List (Store Wise)"
   Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   For Each frmObj In Forms
       Set frmObj = Nothing
   Next
   Set RptDemandListStoreWise = Nothing
Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
...
Private Function SetReport() As Boolean
   ...
   If RdoMin.Value = True Then
      Set RsReport = CN.Execute("EXEC ProdRptStockLimitMinStoreWise " & IIf(Trim(TxtStoreID.Text) = "", "Null", TxtStoreID.Text) & "," & IIf(Trim(TxtProductID.Text) = "", "Null", TxtProductID.Text) & "," & IIf(Trim(TxtGroupID.Text) = "", "Null", TxtGroupID.Text) & "," & IIf(Trim(TxtSubGroupID.Text) = "", "Null", TxtSubGroupID.Text) & "," & IIf(Trim(TxtCompanyID.Text) = "", "Null", TxtCompanyID.Text))
      'Set RsReport = CN.Execute("EXEC ProdRptStockLimitMinStoreWise null,null," & IIf(Trim(TxtGroupID.Text) = "", "Null", TxtGroupID.Text) & "," & IIf(Trim(TxtSubGroupID.Text) = "", "Null", TxtSubGroupID.Text) & "," & IIf(Trim(TxtCompanyID.Text) = "", "Null", TxtCompanyID.Text))
      Set RptReportViewer.Report = New CrptDemandListMinStoreWise
      RptReportViewer.Report.ReportTitle = "Mininmum Demand List (Store Wise)"
      ...
      End If
   Else
        Set RsReport = CN.Execute("EXEC ProdRptStockLimitMaxStoreWise " & IIf(Trim(TxtStoreID.Text) = "", "Null", TxtStoreID.Text) & "," & IIf(Trim(TxtProductID.Text) = "", "Null", TxtProductID.Text) & "," & IIf(Trim(TxtGroupID.Text) = "", "Null", TxtGroupID.Text) & "," & IIf(Trim(TxtSubGroupID.Text) = "", "Null", TxtSubGroupID.Text) & "," & IIf(Trim(TxtCompanyID.Text) = "", "Null", TxtCompanyID.Text))
        Set RptReportViewer.Report = New CrptDemandListMaxStoreWise
        RptReportViewer.Report.ReportTitle = "Maxinmum Demand List (Store Wise)"
        If RsReport.BOF Then
            MsgBox "No record exists.", vbInformation, Me.Caption
            Me.MousePointer = vbDefault
            Exit Function
