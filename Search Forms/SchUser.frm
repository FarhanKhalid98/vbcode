...
Begin VB.Form SchUser 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchUser.frx":0000
      AllowUpdate     =   0   'False
...
Private Sub Grid_KeyPress(KeyAscii As Integer)
   ...
   Case Asc("a") To Asc("z"), Asc("A") To Asc("Z")
      TxtUserName.Text = Chr(KeyAscii): TxtUserName.SelStart = Len(TxtUserName.Text): TxtUserName.SetFocus
   Case vbKey0 To vbKey9
      TxtUserNo.Text = Chr(KeyAscii): TxtUserNo.SelStart = Len(TxtUserNo.Text): TxtUserNo.SetFocus
   End Select
End Sub
...
Private Sub TxtUserNo_Change()
   On Error GoTo ErrorHandler
   If Trim(TxtUserNo.Text) = "" Then Grid.MoveFirst: Exit Sub
   Rs.Find "UserNo =" & TxtUserNo.Text, , adSearchForward, 1
...
Private Sub TxtUserName_Change()
   On Error GoTo ErrorHandler
   If Trim(TxtUserName.Text) = "" Then Grid.MoveFirst: Exit Sub
   Rs.Find "UserName like '" & Replace(TxtUserName.Text, "'", "''") & "%'", , adSearchForward, 1
   If Rs.EOF Then Grid.MoveLast
   Exit Sub
ErrorHandler:
   Call ShowErrorMessage
