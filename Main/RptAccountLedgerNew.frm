...
Begin VB.Form RptLedgerNew 
   ...
   ClientTop       =   375
   ClientWidth     =   15420
   Icon            =   "RptAccountLedgerNew.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptAccountLedgerNew.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptAccountLedgerNew.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptAccountLedgerNew.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnSearch 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptAccountLedgerNew.frx":0F1E
      BC              =   12632256
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnOrganization 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptAccountLedgerNew.frx":0F3A
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnZone 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptAccountLedgerNew.frx":0F56
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSector 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptAccountLedgerNew.frx":0F72
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSession 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptAccountLedgerNew.frx":0F8E
      BC              =   14737632
      FC              =   0
   End
...
Private Function FunRefreshData() As Boolean
   ...
   vSQL = "SELECT a.organizationID, OrganizationName, ca.AccountNo,  str(ca.AccountNo) + '-' + ca.AccountName + ' ' + isnull(P.Address,'') + ' '  + isnull(p.phone1,'') + ' ' + isnull(p.phone2,'') + ' ' + isnull(p.Mobile,'') + ' ' + isnull(P.Description,'') as AccountName," & vbCrLf & _
...
'      Set RptReportViewer.Report = New CrpAccountLedger
       Set RptReportViewer.Report = Application1.OpenReport(App.Path & "\Reports\AccountReports\CrpAccountLedger.rpt")
   End If
