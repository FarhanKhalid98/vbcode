...
Begin VB.Form SchChequeIssue 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchChequeIssue.frx":0000
      AllowAddNew     =   -1  'True
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
...
Private Sub cmbfilter_click()
   ...
   End If
   Set Rs = CN.Execute("Select ChequeNo, ReceiveBy, Amount  from BankChequeIssueBody  " & vwhere)
...
Private Sub Form_Load()
   ...
   With CN.Execute("select ChequeNo from BankChequeIssueBody")
      Do Until .EOF
