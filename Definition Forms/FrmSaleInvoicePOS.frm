...
Begin VB.Form FrmSaleInvoicePOS 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin JeweledBut.JeweledButton BtnCancel 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "FrmSaleInvoicePOS.frx":0ECA
         BC              =   14737632
         FC              =   0
      End
      Begin JeweledBut.JeweledButton BtnOk 
         ...
         FOCUSR          =   -1  'True
         MPTR            =   0
         MICON           =   "FrmSaleInvoicePOS.frx":0EE6
         BC              =   14737632
         FC              =   0
      End
      Begin VB.Frame FrameCredit 
         ...
         Begin JeweledBut.JeweledButton BtnCustomer 
            ...
            FOCUSR          =   -1  'True
            MPTR            =   0
            MICON           =   "FrmSaleInvoicePOS.frx":0F02
            BC              =   12632256
            FC              =   0
         End
         ...
         Begin JeweledBut.JeweledButton BtnAddCustomer 
            ...
            FOCUSR          =   -1  'True
            MPTR            =   0
            MICON           =   "FrmSaleInvoicePOS.frx":0F1E
            BC              =   12632256
            FC              =   0
         End
         ...
         Begin JeweledBut.JeweledButton BtnBankMachineCredit 
            ...
            FOCUSR          =   -1  'True
            MPTR            =   0
            MICON           =   "FrmSaleInvoicePOS.frx":0F3A
            BC              =   12632256
            FC              =   0
         End
      ...
      Begin VB.Frame FrameBank 
         ...
         Begin JeweledBut.JeweledButton BtnBankMachine 
            ...
            FOCUSR          =   -1  'True
            MPTR            =   0
            MICON           =   "FrmSaleInvoicePOS.frx":0F56
            BC              =   12632256
            FC              =   0
         End
   ...
   Begin VB.Frame Frame3 
      ...
      Begin SSDataWidgets_B_OLEDB.SSOleDBGrid GridSerial 
         ...
         BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         stylesets(0).Picture=   "FrmSaleInvoicePOS.frx":0F72
         AllowDelete     =   -1  'True
         AllowUpdate     =   0   'False
         MultiLine       =   0   'False
   ...
   Begin VB.Frame FraHelp 
      ...
      Begin VB.TextBox Text1 
         ...
         TabIndex        =   68
         Tag             =   "NC"
         Text            =   "FrmSaleInvoicePOS.frx":0F8E
         Top             =   300
         Width           =   3975
      End
   ...
   Begin JeweledBut.JeweledButton BtnDelete 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS.frx":1105
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS.frx":1121
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnOpen 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS.frx":113D
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS.frx":1159
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS.frx":1175
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS.frx":1191
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnStore 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS.frx":11AD
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnEmployee 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS.frx":11C9
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnMember 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS.frx":11E5
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnOrganization 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS.frx":1201
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnTable 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS.frx":121D
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS.frx":1239
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSaleOrder 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS.frx":1255
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSaveAS 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS.frx":1271
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSyllabus 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmSaleInvoicePOS.frx":128D
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmSaleInvoicePOS.frx":12A9
      ...
      BeginProperty stylesets(1).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(1).Picture=   "FrmSaleInvoicePOS.frx":12C5
      ...
      BeginProperty stylesets(2).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(2).Picture=   "FrmSaleInvoicePOS.frx":12E1
      ...
      BeginProperty stylesets(3).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(3).Picture=   "FrmSaleInvoicePOS.frx":12FD
      ...
      BeginProperty stylesets(4).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(4).Picture=   "FrmSaleInvoicePOS.frx":1319
      ...
      BeginProperty stylesets(5).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(5).Picture=   "FrmSaleInvoicePOS.frx":1335
      AllowUpdate     =   0   'False
      AllowGroupSizing=   0   'False
      AllowColumnSizing=   0   'False
      AllowGroupMoving=   0   'False
...
'   cnSalePOS.CursorLocation = adUseClient
   If objFSO.FileExists(App.path & "\Settings.ini") Then
   ...
   LblSaleTaxPer.Visible = vPOSID <> ""
   TxtSaleTaxPer.Visible = vPOSID <> ""
   LblSaleTaxValue.Visible = vPOSID <> ""
   TxtSaleTaxValue.Visible = vPOSID <> ""
   LblTotalSaleTaxValue.Visible = vPOSID <> ""
   TxtTotalSaleTaxValue.Visible = vPOSID <> ""
...
'   If RsBody.RecordCount > 0 Then
      sSQL = " Select p.ProductName, b.code, HeaderStoreID, b.ColourID, b.SizeID, ColourName, SizeName, EmpName, StoreName, b.ProductID, ProductName, isProduct," & vbCrLf & _
             ...
             " SC, b.DiscPC, b.DiscPer, b.DiscVal, Amount, b.DiscAmount, Cost, b.EmpComm, b.TokenVal, b.SaleTaxPer, b.SaleTaxVal" & vbCrLf & _
...
Private Sub Grid_BeforeDelete(Cancel As Integer, DispPromptMsg As Integer)
   ...
   TxtTotalItems.Caption = Val(TxtTotalItems.Caption) - 1
   TxtTotalAmount.Caption = Val(TxtTotalAmount.Caption) - Grid.Columns("TotalAmount").Value
   TxtTotalSaleTaxValue.Text = Val(TxtTotalSaleTaxValue.Text) - Grid.Columns("SaleTaxVal").Value
...
'         Set RptReportViewer.Report = Application1.OpenReport(App.Path & "\reports\CrpSaleInvoiceAurora.rpt")
...
'      Set RptReportViewer.Report = Application1.OpenReport(App.Path & "\reports\CrptSaleInvoice.rpt")
...
'   VStrSQL = " Select UserName, h.billid, h.BillDate, isnull(h.BillTime,0) as BillTime, h.Description, h.TotalAmount as tbill, isnull(h.Billdisc,0) as discount, isnull(h.ServiceCharges,0) as ServiceCharges, isnull(h.STax,0) as STax, isnull(h.cashReceived,0) as CashReceived, case when isdeadproduct = 1 then 'Book' else  p.ProductName end /*case when isproduct = 1 then p.ProductName else dbo.FunGetProduct(h.billid, h.BillDate) end */ ProductName, p.productName1, unitname, isnull(QtyPack,0) * isnull(Multiplier,0) + Isnull(Bonus,0) + b.qty as Qty, b.price/isnull(multiplier,1) as price, b.amount, b.DiscPC, b.DiscPer, b.DiscVal, isnull(b.SC,0) as SC, InvoiceNo, " & IIf(ObjRegistry.AllowUrduProduct = False, " isnull(Remarks,'')", " isnull(RemarksUrdu,'')") & " as Remarks" & vbCrLf _
  ...
  If vFBRInvoiceNo <> "" Then
      GenerateBMP StrPtr(App.path & "\Example.bmp"), StrPtr(vFBRInvoiceNo), 3, 10, QualityStandard
      SaveFBRInvoiceImage
  End If
...
Private Sub SaveFBRInvoiceImage()
   On Error GoTo ErrorHandler
      ...
      Rs.AddNew
         strFileNm = App.path & "\Example.bmp"
         DataFile = 1
...
'/******* FBR Integeration*************/
   If vPOSID <> "" Then
      vHeader = "{InvoiceNumber:'',POSID:'" & vPOSID & "',DateTime:'" & Replace(DtpBillDate.Date, "/", "-") & "',BuyerName:'" & TxtCashCustomer.Text & "',TotalQuantity:" & Val(TxtTotalQty.Caption) & ",TotalSaleValue:" & Val(TxtTotalAmount.Caption) & ",Totaltaxcharged:" & Val(TxtTotalSaleTaxValue.Text) & ",TotalBillAmount:" & Val(TxtNetAmount.Caption) & ",PaymentMode:1,InvoiceType:1,USIN:'" & TxtSID.Text & "', items : ["
   End If
''''''''''''''''''''''''''''
...
vStrPara = vStrPara & .Columns("SaleTaxPer").Text & ","  'SaleTaxPer
vStrPara = vStrPara & .Columns("SaleTaxVal").Text & ","  ' SaleTaxVal
...
vStrDetail = vStrDetail & " (P" & .Columns("ProductID").Text & " Q" & .Columns("Qty").Text & " A" & .Columns("Amount").Text & ")"
   ...
   '/******* FBR Integeration*************/
   If vPOSID <> "" Then
      vStrSQL = "Select isnull(PCTCode,'25') from Groups g inner join products p on p.groupid = g.groupid where p.productid = '" & .Columns("ProductID").Text & "'"
      vProducts = vProducts + "{itemcode:'" & .Columns("ProductID").Text & "', itemname:'" & .Columns("ProductName").Text & "',PCTCODE:'" & cn.Execute(vStrSQL).Fields(0).Value & "',quantity:" & .Columns("Qty").Text & ",taxrate:" & .Columns("SaleTaxPer").Value & ",SaleValue:" & .Columns("Amount").Value - .Columns("SaleTaxVal").Value & ",Discount:" & .Columns("DiscVal").Value & ",taxcharged:" & .Columns("SaleTaxVal").Value & ",totalamount:" & .Columns("Amount").Value & ",InvoiceType:1},"
   End If
   ''''''''''''''''''''''''''''
...
cn.Execute ("Exec SaleBodySerialInsert " & vStrPara)
   ...
   Dim p As Object, a As String, B As String
   ...
   If vPOSID <> "" Then
         ...
         cn.Execute "update saleheader set  FBRInvoiceNo = '" & vFBRInvoiceNo & "' where sid = " & TxtSID.Text
   End If
