...
Begin VB.Form FrmAccountDefaultSettings 
   ...
   ClientWidth     =   12000
   ControlBox      =   0   'False
   Icon            =   "FrmAccountDefaultSettings.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame FraHelp 
      ...
      Begin VB.TextBox Text1 
         ...
         TabIndex        =   6
         Tag             =   "NC"
         Text            =   "FrmAccountDefaultSettings.frx":0ECA
         Top             =   360
         Width           =   3930
      End
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmAccountDefaultSettings.frx":0F1C
      BC              =   14737632
      FC              =   0
   End
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmAccountDefaultSettings.frx":0F38
      MultiLine       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmAccountDefaultSettings.frx":0F54
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmAccountDefaultSettings.frx":0F70
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "FrmAccountDefaultSettings"
...
Private Sub Grid_BeforeUpdate(Cancel As Integer)
  On Error GoTo ErrorHandler
    ...
    Rs.Find "AccountNo = '" & Grid.Columns("ID").Text & "'", , adSearchForward, 1
