...
Begin VB.Form RptProductsUsed 
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductsUsed.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductsUsed.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductsUsed.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductsUsed.frx":0F1E
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnStore 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductsUsed.frx":0F3A
      BC              =   12632256
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "RptProductsUsed"
...
Private Sub BtnPreview_Click()
   If SetReport Then
       RptReportViewer.Caption = "Products Used"
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Products Used"
...
Private Function SetReport() As Boolean
    ...
    sSQL = " select h.Manufacturedid, ManufacturedDate, h.StoreID, StoreName, b.ProductID, ProductName, QtyLoose, Rate, Amount" & vbCrLf _
         + " from ManufacturedProductsHeader h " & vbCrLf _
         + " inner join ManufacturedProductsUsed b on h.manufacturedid = b.manufacturedid" & vbCrLf _
    ...
    Set RptReportViewer.Report = New CrpProductsUsed
