...
Begin VB.Form RptProductAnalysis 
   AutoRedraw      =   -1  'True
   ...
   ClientTop       =   375
   ClientWidth     =   15360
   Icon            =   "RptProductAnalysis.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   742
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductAnalysis.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductAnalysis.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductAnalysis.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnVendor 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductAnalysis.frx":0F1E
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductAnalysis.frx":0F3A
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductAnalysis.frx":0F56
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSubGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductAnalysis.frx":0F72
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnCompany 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductAnalysis.frx":0F8E
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "RptProductAnalysis"
...
Private Sub BtnPreview_Click()
   If SetReport Then
        If RdoGroupWise.Value = True Then
            RptReportViewer.Caption = "Product Analysis (Group Wise)"
            RptReportViewer.Report.ReportTitle = "Product Analysis (Group Wise)"
        ElseIf RdoSubGroupWIse.Value = True Then
            RptReportViewer.Caption = "Product Analysis (SubGroup Wise)"
            RptReportViewer.Report.ReportTitle = "Product Analysis (SubGroup Wise)"
        Else
            RptReportViewer.Caption = "Product Analysis (Company Wise)"
            RptReportViewer.Report.ReportTitle = "Product Analysis (Company Wise)"
   End If
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Product Analysis"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   Set RptProductAnalysis = Nothing
Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
...
Private Function SetReport() As Boolean
   ...
   CN.Execute ("EXEC ProdUpdatCurrentStock")
   CN.Execute ("EXEC ProdUpdatCurrentStockStore")
   Set RsReport = CN.Execute("EXEC ProdRptProductAnalysis " & IIf(Trim(TxtProductID.Text) = "", "Null", "'" & TxtProductID.Text & "'") & "," & IIf(Trim(TxtGroupID.Text) = "", "Null", "'" & TxtGroupID.Text & "'") & "," & IIf(Trim(TxtSubGroupID.Text) = "", "Null", TxtSubGroupID.Text) & "," & IIf(Trim(TxtCompanyID.Text) = "", "Null", TxtCompanyID.Text) & "," & IIf(Trim(TxtVendorID.Text) = "", "Null", TxtVendorID.Text) & "," & ChkMinDemand.Value & "," & ChkMaxDemand.Value & ",'" & DtpFrom.DateValue & "','" & DtpTo.DateValue & "'" & "," & IIf(Trim(TxtProductID.Text) <> "", "Null", "'%" & TxtProductName.Text & "%'") & "," & IIf(ChkOnlyIncludeSaleDate.Value = False, "Null", "1"))
   If RdoGroupWise.Value = True Then
     Set RptReportViewer.Report = New CRptProductAnalysisGroupWise
   ElseIf RdoSubGroupWIse.Value = True Then
     Set RptReportViewer.Report = New CRptProductAnalysisSubGroupWise
   Else
     Set RptReportViewer.Report = New CRptProductAnalysisCompanyWise
   End If
