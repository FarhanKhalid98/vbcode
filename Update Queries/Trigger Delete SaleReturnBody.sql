CREATE TRIGGER [td_SaleReturnbody] ON dbo.SaleReturnBody 
FOR DELETE
AS
BEGIN
...
/****************************************************/
Select @DProductId=ProductId, @DStoreId=StoreId, @DQty = Qty , @DCost=Price-isnull(DiscPC,0), @DelTTLCost = Round(@DQty * @DCost, 2)
