...
Begin VB.Form SchChequeIssue 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "SchChequeIssue.frx":0054
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid GridDetail 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "SchChequeIssue.frx":0070
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
      AllowRowSizing  =   0   'False
      AllowGroupSizing=   0   'False
   ...
   End
End
Attribute VB_Name = "SchChequeIssue"
...
Private Sub LoadData()
   ...
   vSQL = " Select h.VoucherID ID, AccountName as ACPayeeName, h.VoucherDate as Date, Sum(isnull((b.Amount),0)) as Amount, UserName as CO" & vbCrLf _
      + " from BankChequeIssueHeader h inner join BankChequeIssuebody b on h.VoucherID = b.VoucherID " & vbCrLf _
      + " inner join ChartofAccounts c on c.AccountNo = h.ACPayeeID " & vbCrLf _
      ...
      + IIf(Trim(TxtchequeNo.Text) = "", "", " and B.ChequeNo like '%" & TxtchequeNo.Text & "%'") & IIf(vSessionID = 0, "", " and SessionID = " & vSessionID) & vbCrLf _
...
Private Sub LoadDetail()
   ...
   vSQL = " Select B.ChequeNo, B.ChequeDate, B.Amount from BankChequeIssuebody B" & vbCrLf _
      + " inner join BankChequeIssueHeader H on h.VoucherID = b.VoucherID " & vbCrLf _
      + " inner join Users u on u.userno = h.userno " & vbCrLf _
   ...
   GridDetail.Columns("ChequeAmount").DataField = "Amount"
   Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
