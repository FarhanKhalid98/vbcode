...
Begin VB.Form SchChqIssu 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "SchChqIssu.frx":6F39
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid GridDetail 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "SchChqIssu.frx":6F55
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
      AllowRowSizing  =   0   'False
      AllowGroupSizing=   0   'False
...
Private Sub LoadData()
  On Error GoTo ErrorHandler
    ...
    vSQL = " Select h.VoucherID ID, h.ACPayeeName, h.VoucherDate as Date, Sum(isnull((b.ActAmount),0)) as Amount, UserName as CO" & vbCrLf _
      + " from BankchqIssuHeader h inner join BankchqIssubody b on h.VoucherID = b.VoucherID " & vbCrLf _
      ...
      + " Group by h.VoucherID, h.ACPayeeName, Voucherdate,UserName " & vOrder & vDirection
...
Private Sub LoadDetail()
  On Error GoTo ErrorHandler
    ...
    vSQL = " Select B.ActChequeNo, B.ActChequeDate, B.ActAmount from BankchqIssubody B" & vbCrLf _
      + " inner join BankchqIssuHeader H on h.VoucherID = b.VoucherID " & vbCrLf _
      + " inner join Users u on u.userno = h.userno " & vbCrLf _
