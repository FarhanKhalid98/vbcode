cREATE TRIGGER [ti_purchasesbody] ON dbo.PurchaseBody 
FOR INSERT
AS
BEGIN
...
/****************************************************/
Select @IProductId=ProductId, @IStoreId=StoreId, @IQty = (isnull(QtyPack,0)*isnull(Multiplier,0))+QtyLoose , @ICost=Price-isnull(DiscPC,0), @NewTTLCost = Round(@IQty * @ICost, 2)
