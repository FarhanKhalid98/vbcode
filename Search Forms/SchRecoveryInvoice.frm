...
Begin VB.Form SchRecoveryInvoice 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00F8E8D6&
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchRecoveryInvoice.frx":0000
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnSelect 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchRecoveryInvoice.frx":001C
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchRecoveryInvoice.frx":0038
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "SchRecoveryInvoice"
...
Private Sub LoadGrid()
   ...
   vSQL = "SELECT RecoveryHeader.RecoveryID as ID, RecoveryDate, EmpName as EmployeeName" & vbCrLf _
         ...
         + " (SELECT RecoveryID, sum(isnull(Amount,0)) as TotalAmount, count(*) as NoofEntries FROM RecoveryInvoice GROUP BY RecoveryID) RI" & vbCrLf _
         + " ON RecoveryHeader.RecoveryID = RI.RecoveryID" & vbCrLf _
         + " left outer JOIN Employees ON RecoveryHeader.EmpID = Employees.EmpID " & vbCrLf _
         + " WHERE RecoveryDate Between '" & DtpFromDate.DateValue & "' AND '" & DtpToDate.DateValue & "'" & vOrder & vDirection
