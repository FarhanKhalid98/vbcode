...
Begin VB.Form FrmProductionInOld 
   ...
   ClientWidth     =   12000
   ControlBox      =   0   'False
   Icon            =   "FrmProductionInOld.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnDelete 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmProductionInOld.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmProductionInOld.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnOpen 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmProductionInOld.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmProductionInOld.frx":0F1E
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmProductionInOld.frx":0F3A
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmProductionInOld.frx":0F56
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmProductionInOld.frx":0F72
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmProductionInOld.frx":0F8E
      AllowUpdate     =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnPurchaseAll 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmProductionInOld.frx":0FAA
      BC              =   12632256
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPurchase 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmProductionInOld.frx":0FC6
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnFromStore 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmProductionInOld.frx":0FE2
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnToStore 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmProductionInOld.frx":0FFE
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnOrganization 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmProductionInOld.frx":101A
      BC              =   12632256
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "FrmProductionInOld"
...
Private Sub BtnPrint_Click()
   ...
   vStrSQL = " Select H.PINID, H.PINDate, H.FromStoreID, H.ToStoreID, H.Description, OrganizationName" & vbCrLf _
...
Private Sub BtnPurchase_Click()
   If FunSelectPurchase(ssButton, False) = True Then
      If TxtOrganizationID.Visible Then TxtOrganizationID.SetFocus
   Else
...
Private Sub GetProductionIN()
   On Error GoTo ErrorHandler
   sSql = "Select h.*, OrganizationName, t.StoreName as ToStoreName, f.StoreName as FromStoreName FROM ProductionInHeader h left outer join Organizations o on o.OrganizationID = h.OrganizationID left outer join Stores f on f.StoreID = h.FromStoreID join Stores t on t.StoreID = h.ToStoreID where h.PINID=" & Val(TxtPINID.Text)
   With CN.Execute(sSql)
      If Not .BOF Then
