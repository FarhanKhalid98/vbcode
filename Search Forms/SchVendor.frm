...
Begin VB.Form SchVendor 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchVendor.frx":0000
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
...
Public ParaOutVendorID As String
...
Private Sub LoadGrid()
   vStrSQL = "SELECT * FROM Parties WHERE PartyType='V' and isLockParty = 0 " & vPartyName & vOrder & vDirection
