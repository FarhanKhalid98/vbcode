...
Begin VB.Form FrmBankChqIssuance 
   AutoRedraw      =   -1  'True
   BorderStyle     =   0  'None
   ClientHeight    =   9000
   ClientLeft      =   15
   ...
   Icon            =   "FrmBankChqIssuance.frx":0000
   KeyPreview      =   -1  'True
   LockControls    =   -1  'True
   MinButton       =   0   'False
   Picture         =   "FrmBankChqIssuance.frx":0ECA
   ScaleHeight     =   600
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   799
   ...
   Begin JeweledBut.JeweledButton btnAccount 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmBankChqIssuance.frx":783B
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton btnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmBankChqIssuance.frx":7857
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton btnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmBankChqIssuance.frx":7873
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton btnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmBankChqIssuance.frx":788F
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton btnOpen 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmBankChqIssuance.frx":78AB
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton btndelete 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmBankChqIssuance.frx":78C7
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton btnBank 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmBankChqIssuance.frx":78E3
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton btnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmBankChqIssuance.frx":78FF
      BC              =   14737632
      FC              =   0
   End
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmBankChqIssuance.frx":791B
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
   ...
   End
End
Attribute VB_Name = "FrmBankChqIssuance"
...
Private Sub BtnPrint_Click()
 On Error GoTo ErrorHandler
   Dim vStrSQL As String
   vStrSQL = "Select H.VoucherID,  H.VoucherDate,  H.BankAcID, H.BankACName, " & vbCrLf _
    + "H.ACPayeeID, H.ACPayeeName, " & vbCrLf _
    + "(H.ACPayeeName + ' - ' + Cast(H.ACPayeeID as Varchar) )  Code, " & vbCrLf _
    + "B.ActChequeNo, B.ActChequeDate, B.ActReceiveBy, " & vbCrLf _
    + "B.ActAmount " & vbCrLf _
    + "From BankChequeIssueHeader H " & vbCrLf _
    + "Left Join BankChequeIssueBody B on H.VoucherID = B.VoucherID where H.VoucherID = " & TxtVoucherID.Text
...
Private Sub PopulateDataToGrid()
   ...
   If RsBody.RecordCount > 0 Then
      sSql = "Select B.ActChequeNo, B.ActChequeDate, B.ActReceiveBy, B.ActAmount From BankChequeIssueBody B  where B.VoucherID =" & Val(TxtVoucherID.Text)
      With CN.Execute(sSql)
         If .RecordCount > 0 Then
            ...
            While Not .EOF
               ...
               Grid.Columns("ReceiveBy").Text = IIf(IsNull(!ActReceiveBy), "", !ActReceiveBy)
    ...
    On Error GoTo ErrorHandler
      ...
      ElseIf KeyCode = vbKeyF1 Then
         Select Case ActiveControl.Name
            ...
            Case TxtActPayeeID.Name: If FunSelectPayee(ssFunctionKey, False) = True Then dtpChequedate.SetFocus
         End Select
...
Private Function FunSelectAccount(ByVal CallerName As SelectAccountCaller, ByVal IsOptional As Boolean) As Boolean
   ...
   If CallerName = ssButton Or CallerName = ssFunctionKey Then
      SchAccounts.ParaInWhereClause = " and c.accountno like '" & objRegistry.BankAccounts & "%'"
...
Private Function FunSelectPayee(ByVal CallerName As SelectAccountCaller, ByVal IsOptional As Boolean) As Boolean
   ...
   End If
   Dim vStrSQL As String
   vStrSQL = "select * from ChartofAccounts where AccountNo = '" & (TxtActPayeeID.Text) & "'"
   With CN.Execute(vStrSQL)
         If .RecordCount > 0 Then
...
Private Sub GetDataFromTextBoxesToGrid()
   ...
   If TxtChequeNo.Enabled = True Then
      If CN.Execute("Select ActChequeNo from BankChequeIssueBody where ActChequeNo = '" & TxtChequeNo.Text & "' and VoucherID <> " & TxtVoucherID.Text).EOF = False Then
   ...
   With Grid
      ...
      RsBody!ActReceiveBy = IIf((TxtReceiveBy.Text = ""), Null, TxtReceiveBy.Text)
      .MoveLast
...
Private Sub btnSave_Click()
   ...
   With Rs
      ...
      !BankACID = Val(TxtBankActID.Text)
      !BankACName = TxtBankActName.Text
      !ACPayeeID = Val(TxtActPayeeID.Text)
      !ACPayeeName = TxtActPayeeName.Text
...
Private Sub btnBank_Click()
   If FunSelectAccount(ssButton, False) = True Then
      If TxtBankActID.Enabled Then TxtActPayeeID.SetFocus
   Else
...
Private Sub BtnOpen_Click()
   SchChqIssu.Show vbModal, Me
   If SchChqIssu.ParaOutVoucherNo <> 0 Then
      TxtVoucherID.Text = SchChqIssu.ParaOutVoucherNo
      GetCompeleteInfo
   End If
...
Private Sub GetCompeleteInfo()
   On Error GoTo ErrorHandler
   sSql = "select H.VoucherID, H.VoucherDate, H.BankACID, H.BankACName, H.ACPayeeID, H.ACPayeeName, H.Description,    B.ActChequeNo, B.ActChequeDate, B.ActReceiveBy, B.ActAmount  from BankChequeIssueHeader H Left Join BankChequeIssueBody B on H.VoucherID = B.VoucherID   where H.VoucherID = " & Val(TxtVoucherID.Text)
   With CN.Execute(sSql)
      If Not .BOF Then
         TxtVoucherID.Text = !VoucherID
         dtpVoucherDate.DateValue = !VoucherDate
         TxtBankActID.Text = IIf(IsNull(!BankACID), " ", !BankACID)
         TxtBankActName.Text = IIf(IsNull(!BankACName), "", !BankACName)
