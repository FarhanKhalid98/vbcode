...
Begin VB.Form FrmBankChequeIssueReconciliation 
   ...
   Icon            =   "FrmBankChequeIssueReconciliation.frx":0000
   KeyPreview      =   -1  'True
   ScaleHeight     =   770
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   1030
   ...
   Begin JeweledBut.JeweledButton btnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmBankChequeIssueReconciliation.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton btnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmBankChequeIssueReconciliation.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton btnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmBankChequeIssueReconciliation.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton btnOpen 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmBankChequeIssueReconciliation.frx":0F1E
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton btndelete 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmBankChequeIssueReconciliation.frx":0F3A
      BC              =   14737632
      FC              =   0
   End
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmBankChequeIssueReconciliation.frx":0F56
      ...
      BeginProperty stylesets(1).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(1).Picture=   "FrmBankChequeIssueReconciliation.frx":0F72
      stylesets(2).Name=   "StyleCol"
      stylesets(2).BackColor=   14548991
      stylesets(2).Picture=   "FrmBankChequeIssueReconciliation.frx":0F8E
      MultiLine       =   0   'False
...
Private Sub PopulateDataToGrid()
   On Error GoTo ErrorHandler
   If RsBody.State = adStateOpen Then RsBody.Close
   RsBody.Open "select * from BankChequeIssueBody where ChequeDate Between ' " & dtpFromDate.DateValue & " ' and  '" & DtpToDate.DateValue & "'", CN, adOpenStatic, adLockBatchOptimistic
   If RsBody.RecordCount > 0 Then
      sSql = "Select AccountName as ACPayeeName, B.* From BankChequeIssueBody B Inner Join BankChequeIssueHeader H on B.VoucherID = H.VoucherID inner join ChartofAccounts c on c.AccountNo = AcPayeeID Where ChequeDate Between '" & dtpFromDate.DateValue & "' And '" & DtpToDate.DateValue & "'"
