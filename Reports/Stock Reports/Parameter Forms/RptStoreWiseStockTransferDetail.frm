...
Begin VB.Form RptStoreWiseStockTransferDetail 
   AutoRedraw      =   -1  'True
   ...
   ClientTop       =   375
   ClientWidth     =   15360
   Icon            =   "RptStoreWiseStockTransferDetail.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   742
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptStoreWiseStockTransferDetail.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptStoreWiseStockTransferDetail.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptStoreWiseStockTransferDetail.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptStoreWiseStockTransferDetail.frx":0F1E
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnFromStore 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptStoreWiseStockTransferDetail.frx":0F3A
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnToStore 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptStoreWiseStockTransferDetail.frx":0F56
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptStoreWiseStockTransferDetail.frx":0F72
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSubGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptStoreWiseStockTransferDetail.frx":0F8E
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnCompany 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptStoreWiseStockTransferDetail.frx":0FAA
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "RptStoreWiseStockTransferDetail"
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
   ...
   ElseIf KeyCode = vbKeyF1 Then
      Select Case ActiveControl.Name
         ...
         Case TxtSubGroupID.Name: If FunSelectSubGroup(ssFunctionKey, True) = True Then DtpFrom.SetFocus
      End Select
   End If
   Exit Sub
ErrorHandler:
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Stock Transfer Detail (Store Wise)"
   Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   Set RptStoreWiseStockTransferDetail = Nothing
Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
...
Private Function SetReport() As Boolean
   ...
   sSql = "EXEC ProdRptStoreWiseStockTransferDetail '" & DtpFrom.DateValue & "','" & DtpTo.DateValue & "'," & IIf(TxtFromStoreID.Text = "", "Null", TxtFromStoreID.Text) & "," & IIf(TxtToStoreID.Text = "", "Null", TxtToStoreID.Text) & "," & IIf(Trim(TxtProductID.Text) = "", "Null", TxtProductID.Text) & "," & IIf(Trim(TxtGroupID.Text) = "", "Null", TxtGroupID.Text) & "," & IIf(Trim(TxtCompanyID.Text) = "", "Null", TxtCompanyID.Text) & "," & IIf(Trim(TxtSubGroupID.Text) = "", "Null", TxtSubGroupID.Text) & "," & Abs(ObjRegistry.ShowMultiBranches)
   Set RsReport = CN.Execute(sSql)
   Set RptReportViewer.Report = New CryRptStoreWiseStockTransferDetail
   If RsReport.BOF Then
       MsgBox "No record exists.", vbInformation, Me.Caption
       Me.MousePointer = vbDefault
       Exit Function
   End If
   RptReportViewer.Report.ReportTitle = "Stock Transfer Detail (Store Wise)"
