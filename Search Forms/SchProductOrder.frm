...
Begin VB.Form SchProductOrder 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchProductOrder.frx":0000
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchProductOrder.frx":001C
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnSelect 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchProductOrder.frx":0038
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "SchProductOrder"
...
Private Sub TxtID_Change()
   ...
   Rs.Find "ID ='" & Right("0" + CStr(Val(TxtID.Text)), 2) & "'", , adSearchForward, 1
...
Private Sub LoadGrid()
   On Error GoTo ErrorHandler
   vStrSQL = "select * from productmeasurements where depth = 1 and Name like '%" & Replace(TxtName.Text, "'", "''") & "%'" & vOrder & vDirection
