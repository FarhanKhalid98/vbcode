...
Private Sub BtnPreview_Click()
   If SetReport Then
       RptReportViewer.Caption = "Product List"
...
Private Function SetReport() As Boolean
    ...
    SetReport = False
    vStrSQL = "Select P.ProductID, P.ProductName, P.PurPrice, P.DiscPc, P.RetailPrice From Products P Where 1=1" & vbCrLf _
