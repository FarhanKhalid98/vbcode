...
Begin VB.Form SchChqDepositBy 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchChqDepositBy.frx":0000
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchChqDepositBy.frx":001C
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnSelect 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchChqDepositBy.frx":0038
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "SchChqDepositBy"
...
Private Sub BtnSelect_Click()
  ...
  Me.ParaOutDepositBy = Rs!DepositBy
  Unload Me
  Exit Sub
ErrorHandler:
...
Private Sub DepositBy_Change()
   ...
   Rs.Find "DepositBy like '" & DepositBy.Text & "%'", , adSearchForward, 1
...
Private Sub LoadData()
   VStrSQL = "SELECT Distinct DepositBy FROM BankChequeDepositBody " & vOrder & vDirection
   If Rs.State = adStateOpen Then Rs.Close
   Rs.Open VStrSQL, CN, adOpenStatic, adLockReadOnly
   Set Grid.DataSource = Rs
   Grid.Columns("DepositBy").DataField = "DepositBy"
