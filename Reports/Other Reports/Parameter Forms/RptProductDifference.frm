...
Begin VB.Form RptProductDifference 
   AutoRedraw      =   -1  'True
   ...
   ClientTop       =   375
   ClientWidth     =   15360
   Icon            =   "RptProductDifference.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   742
   ...
   Begin VB.CheckBox ChkQty 
      Caption         =   "Exclude Whose Product Qty Difference Zero (0)"
      Height          =   255
      Left            =   4846
      TabIndex        =   16
      Top             =   5288
   ...
   Begin VB.CheckBox ChkDiff 
      Caption         =   "Exclude Whose Product Difference Zero (0)"
      Height          =   255
      Left            =   4846
      TabIndex        =   15
      Top             =   4808
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductDifference.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductDifference.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductDifference.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductDifference.frx":0F1E
      BC              =   12632256
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "RptProductDifference"
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Product Difference"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   For Each frmObj In Forms
       Set frmObj = Nothing
   Next
   Set RptProductDifference = Nothing
   Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
...
Private Function SetReport() As Boolean
   ...
   Set RsReport = CN.Execute("EXEC ProdRptProductDifference " & IIf(Trim(TxtCode.Text) = "", "Null", "'" & TxtCode.Text & "'") & "," & IIf(ChkDiff.Value = 1, 0, "Null") & "," & IIf(ChkQty.Value = 1, 0, "Null"))
   Set RptReportViewer.Report = New CrptProductDifference
   RptReportViewer.Report.ReportTitle = "Product Difference"
