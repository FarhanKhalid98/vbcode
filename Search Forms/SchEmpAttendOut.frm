...
Begin VB.Form SchEmpAttendOut 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchEmpAttendOut.frx":0ECA
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
      ...
      Columns(4).Caption=   "Date Out"
      Columns(4).Name =   "Date"
      Columns(4).CaptionAlignment=   2
      Columns(4).DataField=   "Column 1"
      Columns(4).DataType=   8
      Columns(4).NumberFormat=   "dd/MM/yyyy"
      Columns(4).FieldLen=   256
      Columns(5).Width=   1746
      Columns(5).Caption=   "Time Out"
      Columns(5).Name =   "TimeOut"
   ...
   Begin JeweledBut.JeweledButton BtnSelect 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchEmpAttendOut.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchEmpAttendOut.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "SchEmpAttendOut"
...
Public ParaOutDateOut As String
...
Private Sub LoadGrid()
   ...
   vSQL = "SELECT  EmpName as EmployeeName" & vbCrLf _
         + " , EA.EmpID,  EA.DateOut, EA.AttendDate, Substring (CONVERT ( varchar ( 20 ) ,  EA.timeIn),13,7) TimeIn, Substring (CONVERT ( varchar ( 20 ) ,  EA.timeOut),13,7)TimeOut " & vbCrLf _
         + " FROM EmpAttendance EA INNER JOIN" & vbCrLf _
         + " Employees Emp on Emp.EmpID = EA.EmpID " & vbCrLf _
         + " WHERE DateOut between '" & DtpFrom.DateValue & "' and '" & DtpTo.DateValue & "'" & vOrder & vDirection
   Rs.Open vSQL, CN, adOpenStatic, adLockReadOnly
   Set Grid.DataSource = Rs
   Grid.Columns("Date").DataField = "DateOut"
   Grid.Columns("DateIn").DataField = "AttendDate"
   Grid.Columns("EmpID").DataField = "EmpID"
   Grid.Columns("EmployeeName").DataField = "EmployeeName"
   Grid.Columns("TimeIn").DataField = "TimeIn"
   Grid.Columns("TimeOut").DataField = "TimeOut"
 Exit Sub
ErrorHandler:
