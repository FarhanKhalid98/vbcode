...
Public ParaOutAdjustmentID As Integer
Public ParaOutAdjustmentDate As String

Private Sub LoadGrid()
   On Error GoTo ErrorHandler
   Set Rs = New ADODB.Recordset
   vStrSQL = "SELECT h.AdjustmentID, h.AdjustmentDate" & vbCrLf _
...
Private Sub BtnClose_Click()
  Me.ParaOutAdjustmentID = 0
  Me.ParaOutAdjustmentDate = ""
  Unload Me
End Sub
...
Private Sub BtnSelect_Click()
  ...
  Me.ParaOutAdjustmentID = Rs!AdjustmentID
  Me.ParaOutAdjustmentDate = Rs!AdjustmentDate
  Unload Me
  Exit Sub
ErrorHandler:
  Call ShowErrorMessage
...
Private Sub Form_Load()
   ...
   Me.ParaOutAdjustmentID = 0
   Me.ParaOutAdjustmentDate = ""
   vOrder = " order by h.AdjustmentID"
   Grid.Columns("ID").DataField = "AdjustmentID"
   Grid.Columns("Date").DataField = "AdjustmentDate"
...
Private Sub TxtID_Change()
   ...
   Rs.Find "AdjustmentID = " & TxtID.Text, , adSearchForward, 1
