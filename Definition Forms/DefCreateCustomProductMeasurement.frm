...
Begin VB.Form DefCreateCustomProductMeasurement 
   AutoRedraw      =   -1  'True
   ...
   ClientTop       =   375
   ClientWidth     =   15360
   Icon            =   "DefCreateCustomProductMeasurement.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   742
   ...
   Begin VB.Frame FraHelp 
      ...
      Begin VB.TextBox Text1 
         ...
         TabIndex        =   15
         Tag             =   "NC"
         Text            =   "DefCreateCustomProductMeasurement.frx":0ECA
         Top             =   360
         Width           =   3930
      End
   ...
   Begin JeweledBut.JeweledButton BtnNew 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "DefCreateCustomProductMeasurement.frx":0F31
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "DefCreateCustomProductMeasurement.frx":0F4D
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "DefCreateCustomProductMeasurement.frx":0F69
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "DefCreateCustomProductMeasurement.frx":0F85
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnUnit 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "DefCreateCustomProductMeasurement.frx":0FA1
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "DefCreateCustomProductMeasurement"
...
Private Sub BtnSave_Click()
  ...
  If ParaInIsNew Then
    ...
    Rs!Type = CN.Execute("Select Name From CustomProductsMeasurements where ID = '" & IIf(Me.ParaInParentID = "", 0, Me.ParaInParentID) & "'").Fields(0)
    Rs!Depth = CN.Execute("Select Depth+1 From CustomProductsMeasurements where ID = '" & IIf(Me.ParaInParentID = "", 0, Me.ParaInParentID) & "'").Fields(0)
...
Private Function FunValidation() As Boolean
  ...
  If Me.ParaInIsNew Then
    If Trim(TxtID.Text) = "" Then
      ...
      Exit Function
    End If
    If CN.Execute("Select * From CustomProductsMeasurements where ID = '" & TxtPrefix.Text & TxtID.Text & "'").RecordCount > 0 Then
...
Private Sub Form_Load()
  ...
  With CN.Execute("Select * FROM Units")
    ...
    Rs.Open "Select * FROM CustomProductsMeasurements Where ID = '" & Me.ParaInID & "'", CN, adOpenDynamic, adLockOptimistic
...
Private Property Let FormStatus(ByVal vNewValue As FormMode)
  ...
  Select Case vNewValue
    Case Is = NewMode
      ...
      TxtName.Text = ""
      TxtID.Text = ""
      'TxtID.Text = CN.Execute("Select substring(cast(isnull(max(cast(ID as int)+1),0) as Varchar(10))," & Len(Me.ParaInParentID) + 1 & ",10) From CustomProductsMeasurements where ParentID ='" & Me.ParaInParentID & "'").Fields(0)
      vSQL = "Select substring(cast(isnull(max(cast(ID as int)+1),01) as Varchar(4))," & Len(Me.ParaInParentID) + 1 & ",4) as ID From CustomProductsMeasurements where ParentID ='" & IIf(Me.ParaInParentID = "", "0", Me.ParaInParentID) & "'"
