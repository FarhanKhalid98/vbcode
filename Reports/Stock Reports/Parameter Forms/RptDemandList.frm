...
Begin VB.Form RptDemandList 
   ...
   End
End
Attribute VB_Name = "RptDemandList"
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Demand List"
   Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
...
Private Function SetReport() As Boolean
   ...
   Set RsReport = CN.Execute("EXEC ProdRptDemandList " & IIf(Trim(TxtProductID.Text) = "", "Null", TxtProductID.Text) & "," & IIf(Trim(TxtGroupID.Text) = "", "Null", TxtGroupID.Text) & "," & IIf(Trim(TxtSubGroupID.Text) = "", "Null", TxtSubGroupID.Text) & "," & IIf(Trim(TxtCompanyID.Text) = "", "Null", TxtCompanyID.Text) & "," & IIf(Trim(TxtVendorID.Text) = "", "Null", TxtVendorID.Text))
   Set RptReportViewer.Report = New CrptDemandList
   If RsReport.BOF Then
      MsgBox "No record exists.", vbInformation, Me.Caption
      Me.MousePointer = vbDefault
      Exit Function
   End If
   RptReportViewer.Report.ReportTitle = "Demand List"
