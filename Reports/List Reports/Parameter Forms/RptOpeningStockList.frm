...
Begin VB.Form RptOpeningStockList 
   AutoRedraw      =   -1  'True
   ...
   ClientTop       =   375
   ClientWidth     =   15360
   Icon            =   "RptOpeningStockList.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   742
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockList.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockList.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockList.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockList.frx":0F1E
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSubGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockList.frx":0F3A
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnCompany 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockList.frx":0F56
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockList.frx":0F72
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnStore 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockList.frx":0F8E
      BC              =   12632256
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "RptOpeningStockList"
...
Private Function FunSelectStore(ByVal CallerName As SelectAccountCaller, ByVal IsOptional As Boolean) As Boolean
   ...
   End If
    ...
    VStrSQL = " SELECT StoreID, StoreName From Stores Where StoreID = " & TxtStoreID.Text
...
Private Sub BtnStore_Click()
   If FunSelectStore(ssButton, True) = True Then
...
Private Sub TxtStoreID_Validate(Cancel As Boolean)
   ...
   If vTemp = True Then
      vTemp = Not FunSelectStore(ssValidate, False)
   End If
   Cancel = vTemp
   Exit Sub
ErrorHandler:
...
Private Sub BtnPreview_Click()
   If SetReport Then
       RptReportViewer.Caption = "Opening Stock List"
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
   ...
   ElseIf KeyCode = vbKeyF1 Then
      Select Case ActiveControl.Name
         Case TxtStoreID.Name: If FunSelectStore(ssFunctionKey, True) = True Then TxtCompanyID.SetFocus
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Opening Stock List"
End Sub
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   For Each frmObj In Forms
       Set frmObj = Nothing
   Next
   Set RptOpeningStockList = Nothing
Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
...
Private Function SetReport() As Boolean
   ...
   + "Left Outer Join   Stores S on S.StoreID = OS.StoreID" & vbCrLf _
   + "Left Outer Join Companies C on P.comPanyID = C.comPanyID" & vbCrLf _
   + "Left Outer Join Groups G on P.GroupID = G.GroupID" & vbCrLf _
   + "Left Outer Join SubGroups SG on P.SubGroupID = SG.SubGroupID Where 1=1 " & IIf(Trim(TxtStoreID.Text) = "", "", " And S.StoreID = " & TxtStoreID.Text) & vbCrLf _
   ...
   + "" & IIf(Trim(TxtCode.Text) = "", "", " And P.ProductID = " & TxtCode.Text)
   Me.MousePointer = vbHourglass
   If RsReport.State = adStateOpen Then RsReport.Close
   RsReport.Open VStrSQL, CN, adOpenStatic, adLockReadOnly
   Set RptReportViewer.Report = New CRptOpeningStockList
