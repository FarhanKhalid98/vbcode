...
Begin VB.Form FrmStockReturnFromSaleman 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   11130
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   15360
   Icon            =   "FrmStockReturnFromSaleman.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   742
   ...
   Begin JeweledBut.JeweledButton BtnSaleman 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmStockReturnFromSaleman.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmStockReturnFromSaleman.frx":0EE6
      AllowUpdate     =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmStockReturnFromSaleman.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnDelete 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmStockReturnFromSaleman.frx":0F1E
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmStockReturnFromSaleman.frx":0F3A
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnOpen 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmStockReturnFromSaleman.frx":0F56
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmStockReturnFromSaleman.frx":0F72
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmStockReturnFromSaleman.frx":0F8E
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmStockReturnFromSaleman.frx":0FAA
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnStore 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmStockReturnFromSaleman.frx":0FC6
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin VB.Label LblCaption 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Stock Return From Saleman"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   18
         Charset         =   178
   ...
   End
End
Attribute VB_Name = "FrmStockReturnFromSaleman"
...
Private Function FunSelectProduct(ByVal CallerName As SelectAccountCaller, ByVal IsOptional As Boolean) As Boolean
   ...
   With cn.Execute(vStrSQL)
      If .RecordCount > 0 Then
         ...
         End If
         With cn.Execute("select Cost, QtyLoose from CurrentStockSM where ProductID ='" & TxtProductID.Text & "' and SalemanId='" & TxtSalemanID.Text & "'")
            If .RecordCount > 0 Then
               'TxtPrice.Text = !Cost
...
Private Sub BtnDelete_Click()
   ...
   Grid.Redraw = False
   Grid.RemoveAll
   cn.Execute "Delete from StockReturnBody where ReturnID = " & Val(TxtReturnID.Text) & " And ReturnDate ='" & DtpReturnDate.DateValue & "'"
   Grid.Redraw = True
   cn.Execute "Delete from StockReturnHeader where ReturnID = " & Val(TxtReturnID.Text) & " And ReturnDate ='" & DtpReturnDate.DateValue & "'"
   cn.CommitTrans
   FormStatus = NewMode
   Exit Sub
ErrorHandler:
...
Private Sub BtnOpen_Click()
   SchStockReturn.Show vbModal
   If SchStockReturn.ParaOutReturnID <> 0 Then
      TxtReturnID.Text = SchStockReturn.ParaOutReturnID
      DtpReturnDate.DateValue = SchStockReturn.ParaOutReturnDate
      GetReturn
   End If
End Sub
...
Private Sub BtnPrint_Click()
   On Error GoTo ErrorHandler
    vStrSQL = " Select  H.ReturnID, H.ReturnDate, H.TotalAmount, S.StoreName, SM.SaleManName, " & vbCrLf _
      + " B.ProductID,  B.Multiplier, B.QtyPack, B.QtyLoose, Isnull(B.Price,0) Price, " & vbCrLf _
      + " Isnull(B.Amount,0) Amount,   ProductName, PK.PackingName from StockReturnHeader H " & vbCrLf _
      + " join StockReturnBody B on H.ReturnID = B.ReturnID And H.ReturnDate = B.ReturnDate" & vbCrLf _
    ...
    Set RptReportViewer.Report = New CrpStockReturn
...
'  Header Validation
   ...
   If TxtReturnID.Enabled Then
      If cn.Execute("Select * from StockReturnHeader where ReturnID = " & Val(TxtReturnID.Text) & " and ReturnDate = '" & DtpReturnDate.DateValue & "'").RecordCount > 0 Then
  ...
  'Saving record
   cn.BeginTrans
   sSql = "select * from StockReturnHeader where ReturnID=" & Val(TxtReturnID.Text) & " and ReturnDate = '" & DtpReturnDate.DateValue & "'"
...
Private Sub PopulateDataToGrid()
   ...
   RsBody.Open "Select * from StockReturnBody where ReturnID=" & Val(TxtReturnID.Text & " And ReturnDate='" & DtpReturnDate.DateValue & "'"), cn, adOpenStatic, adLockBatchOptimistic
   If RsBody.RecordCount > 0 Then
      sSql = "select p.productname, b.* from StockReturnBody b join products p on p.productid = b.productid where ReturnID=" & Val(TxtReturnID.Text) & " And ReturnDate='" & DtpReturnDate.DateValue & "'"
...
Private Sub Form_Load()
   On Error GoTo ErrorHandler
   SetWindowText Me.hWnd, "Stock Return from Salesman"
   ShowPicture Me, 2
...
Private Function FunGetMaxID() As Long
   On Error GoTo ErrorHandler
   FunGetMaxID = cn.Execute("Select isnull(max(ReturnID),0)+1 from StockReturnHeader where ReturnDate = '" & DtpReturnDate.DateValue & "'").Fields(0)
   Exit Function
ErrorHandler:
   Call ShowErrorMessage
End Function
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   Else
    ...
    Next
    Set RsBody = Nothing
    Set FrmStockReturnFromSaleman = Nothing
   End If
   Exit Sub
ErrorHandler:
   Call ShowErrorMessage
...
Private Sub GetReturn()
   On Error GoTo ErrorHandler
   sSql = "select h.*, salemanname, StoreName FROM StockReturnHeader h inner join stores s on s.storeid = h.storeid inner join salesman sm on sm.salemanid = h.salemanid where h.ReturnID=" & Val(TxtReturnID.Text) & " And ReturnDate='" & DtpReturnDate.DateValue & "'"
   With cn.Execute(sSql)
      If Not .BOF Then
