...
Begin VB.Form RptGroupList 
   ...
   End
End
Attribute VB_Name = "RptGroupList"
...
Private Sub BtnPreview_Click()
   If SetReport Then
       RptReportViewer.Caption = "Group List"
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Group List"
End Sub
...
Private Function SetReport() As Boolean
   ...
   SetReport = False
   VStrSQL = "Select GroupID, GroupName from Groups where 1=1 " & vbCrLf _
   + "" & IIf(Trim(TxtGroupID.Text) = "", "", " And GroupID = " & TxtGroupID.Text)
   
   Me.MousePointer = vbHourglass
   If RsReport.State = adStateOpen Then RsReport.Close
   RsReport.Open VStrSQL, CN, adOpenStatic, adLockReadOnly
   Set RptReportViewer.Report = New CrptGroupList
