...
Begin VB.Form FrmCustomOrderDelivery 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   11130
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   15360
   Icon            =   "FrmCustomOrderDelivery.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   742
   ...
   Begin VB.Frame FraHelp 
      ...
      Begin VB.TextBox Text1 
         ...
         TabIndex        =   19
         Tag             =   "NC"
         Text            =   "FrmCustomOrderDelivery.frx":0ECA
         Top             =   360
         Width           =   3975
      End
   ...
   Begin JeweledBut.JeweledButton BtnDelete 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomOrderDelivery.frx":0FAA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomOrderDelivery.frx":0FC6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnOpen 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomOrderDelivery.frx":0FE2
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomOrderDelivery.frx":0FFE
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomOrderDelivery.frx":101A
      BC              =   14737632
      FC              =   0
   End
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmCustomOrderDelivery.frx":1036
      AllowUpdate     =   0   'False
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid GridDetail 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmCustomOrderDelivery.frx":1052
      ...
      BeginProperty stylesets(1).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(1).Picture=   "FrmCustomOrderDelivery.frx":106E
      ...
      BeginProperty stylesets(2).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(2).Picture=   "FrmCustomOrderDelivery.frx":108A
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
   ...
   Begin SSCalendarWidgets_A.SSDateCombo DtpDeliveryDate 
      ...
      Mask            =   2
   End
   Begin SITextBox.Txt TxtDeliveryID 
      Height          =   315
      Left            =   2430
      TabIndex        =   28
      Top             =   2198
   ...
   Begin JeweledBut.JeweledButton BtnOrder 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomOrderDelivery.frx":10A6
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomOrderDelivery.frx":10C2
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnOrganization 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmCustomOrderDelivery.frx":10DE
      BC              =   12632256
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "FrmCustomOrderDelivery"
...
Private Sub BtnOpen_Click()
   SchCustomOrderDelivery.Show vbModal, Me
   If SchCustomOrderDelivery.ParaOutDeliveryID <> 0 Then
      TxtDeliveryID.Text = SchCustomOrderDelivery.ParaOutDeliveryID
      cn.Execute ("Insert Into UserActivities values ('Custom Order Delivery'" & "," & TxtDeliveryID.Text & ",'" & DtpDeliveryDate.DateValue & "','Opened','" & Date & "','" & Time & "',4,'Opened'," & vUser & ")")
      GetPrevious
   End If
End Sub
...
Private Function FunSelectBooking(ByVal CallerName As SelectAccountCaller, ByVal IsOptional As Boolean) As Boolean
    ...
    ssql = " Select h.*,p.partyname, BankMachineName from CustomOrderHeader h left outer join parties p on h.customerid = p.partyid left outer join BankMachines b on b.BankMachineid = h.BankMachineid " & _
          " where DeliveryId = " & Val(TxtDeliveryID.Text)
   
    ssql = " Select h.*, BankMachineName, OrganizationName " & vbCrLf _
            + " from CustomOrderHeader h left outer join Organizations o on o.OrganizationID = h.OrganizationID left outer join BankMachines b on b.BankMachineid = h.BankMachineid " & vbCrLf _
...
Private Sub GetPrevious()
   On Error GoTo ErrorHandler
   vStrSQL = " Select h.*, co.*, p.partyname, BankMachineName, OrganizationName from CustomOrderDelivery h inner join CustomOrderHeader co on co.OrderID = h.OrderID left outer join Organizations o on o.OrganizationID = h.OrganizationID left outer join parties p on h.customerid = p.partyid left outer join BankMachines b on b.BankMachineid = h.BankMachineid " & _
          " where DeliveryId = " & Val(TxtDeliveryID.Text)
   With cn.Execute(vStrSQL)
      If Not .BOF Then
         TxtDeliveryID.Text = !DeliveryID
         DtpDeliveryDate.DateValue = !DeliveryDate
         TxtOrganizationID.Text = IIf(IsNull(!OrganizationID), "", !OrganizationID)
         TxtOrganizationName.Text = IIf(IsNull(!OrganizationName), "", !OrganizationName)
...
On Error GoTo ErrorHandler
   vStrSQL = " select u.username, d.DeliveryID, d.DeliveryDate, h.OrderID, h.OrderDate, h.TotalAmount, h.Advance, d.payment, Name as productname, b.qty, b.price as price, b.amount, " & vbCrLf _
      + " d.Cash, d.Credit, d.BankCard" & vbCrLf _
      + " from CustomOrderHeader h inner join CustomOrderBody b on h.OrderID = b.OrderID " & vbCrLf _
      + " inner Join CustomOrderDelivery D on d.orderID = h.OrderID" & vbCrLf _
      ...
      + "  where d.DeliveryID = " & Val(TxtDeliveryID.Text) & " and d.DeliveryDate ='" & DtpDeliveryDate.DateValue & "'" & vbCrLf _
      + " Order By SerialNo"
   ...
   RptReportViewer.Report.SelectPrinter "Printer Driver", "Printer Name", "LPT1"
      ...
      If InStr(1, Printer.DeviceName, "CBM1000") > 0 Then
         Set RptReportViewer.Report = New CrptCustomOrderDeliveryCBM
      ElseIf InStr(1, Printer.DeviceName, "AB-80K") > 0 Then
         Set RptReportViewer.Report = New CrptCustomOrderDeliveryAurora
   ...
   cn.Execute ("Insert Into UserActivities values ('Custom Order Delivery'" & "," & TxtDeliveryID.Text & ",'" & DtpDeliveryDate.DateValue & "','Printed','" & Date & "','" & Time & "',5,'Printed'," & vUser & ")")
...
Private Sub BtnSave_Click()
   ...
   ''''''''''''' User Authentication ''''''''''''''
   vUserAction = UserAuthentication("MniCustomOrderDelivery", vUser, ObjUserSecurity.IsAdministrator, IIf(vIsNewRecord = True, eUserNewRecord, eUserEdit))
   If vUserAction <> "" Then
   ...
   If TxtDeliveryID.Enabled Then
      If cn.Execute("Select * from CustomOrderDelivery where DeliveryId = " & Val(TxtDeliveryID.Text)).RecordCount > 0 Then
         MsgBox "This Delivery ID already exists. A new Delivery ID. has been generated. Please try again", vbCritical, "Alert"
         TxtDeliveryID.Text = FunGetMaxID
         Exit Sub
      End If
   End If
    ...
    With cn.Execute(vStrSQL)
        If .Fields(0).Value >= DtpDeliveryDate.DateValue Then
  ...
  'Saving record
   ...
   vStrSQL = "select * from CustomOrderDelivery where DeliveryId = " & Val(TxtDeliveryID.Text)
   With Rs
      .Open vStrSQL, cn, adOpenStatic, adLockPessimistic
      If .BOF Then
         .AddNew
         !DeliveryID = Val(TxtDeliveryID.Text)
      End If
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Customer Order Delivery"
   HelpLocation Me
...
Private Property Let FormStatus(ByVal vNewValue As FormMode)
   ...
   Case Is = NewMode
      ...
      DtpDeliveryDate.DateValue = IIf(Abs(vSystemDate) = 1, vDate, IIf(Format(Now, "hh") >= vHDiff, vDate, DateAdd("d", -1, vDate)))
      If DtpDeliveryDate.Enabled And DtpDeliveryDate.Visible Then DtpDeliveryDate.SetFocus
...
Private Function FunGetMaxID() As Long
   On Error GoTo ErrorHandler
   FunGetMaxID = cn.Execute("Select isnull(max(DeliveryID),0) from CustomOrderDelivery").Fields(0) + 1
   Exit Function
ErrorHandler:
   Call ShowErrorMessage
End Function
...
Private Sub BtnClear_Click()
   ...
   cn.Execute ("Insert Into UserActivities values ('Custom Order Delivery'" & "," & TxtDeliveryID.Text & ",'" & DtpDeliveryDate.DateValue & "','Cleared','" & Date & "','" & Time & "',6,'Cleared'," & vUser & ")")
...
Private Sub BtnClose_Click()
   '''''''''''''''''''''''''''''''''''''User Activities'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
   cn.Execute ("Insert Into UserActivities values ('Custom Order Delivery'" & "," & TxtDeliveryID.Text & ",'" & DtpDeliveryDate.DateValue & "','Closed','" & Date & "','" & Time & "',7,'Closed'," & vUser & ")")
   ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
   Unload Me
End Sub
...
Private Sub BtnDelete_Click()
   ...
   If MsgBox("Do you want to remove this record?", vbYesNo + vbQuestion, "Confirmation") = vbNo Then Exit Sub
    ''''''''''''' User Authentication ''''''''''''''
   vUserAction = UserAuthentication("MniCustomOrderDelivery", vUser, ObjUserSecurity.IsAdministrator, eUserDelete)
   If vUserAction <> "" Then
      MsgBox vUserAction, vbCritical, "Error"
      Exit Sub
   End If
...
'   vMaxBinID = FunGetMaxBinID
   ''''''''''''''''''''''''''''''''''''''''''''''''Bin Header-----------------------------------------------
'   CN.Execute ("Insert Into Bin_CustomOrderDelivery Select " & vMaxBinID & ",'" & Date & "',* from CustomOrderDelivery Where DeliveryID = " & TxtDeliveryID.Text & " And DeliveryDate ='" & DtpDeliveryDate.DateValue & "'")
   

   '''''''''''''''''''''''''''''''''''''User Activities'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
   cn.Execute ("Insert Into UserActivities values ('Custom Order Delivery'" & "," & TxtDeliveryID.Text & ",'" & DtpDeliveryDate.DateValue & "','Removed','" & Date & "','" & Time & "',3,'Removed'," & vUser & ")")
   ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
   
   cn.Execute "Delete from CustomOrderDelivery where DeliveryId = " & Val(TxtDeliveryID.Text)
   cn.CommitTrans
   FormStatus = NewMode
   Exit Sub
ErrorHandler:
...
Private Function FunGetMaxBinID() As Long
   ...
   FunGetMaxBinID = cn.Execute("Select isnull(max(BinID),0)+1 from Bin_CustomOrderDelivery ").Fields(0)
   Exit Function
ErrorHandler:
   Call ShowErrorMessage
End Function
...
Private Sub UserActivities()
    ...
    For i = 1 To Grid.rows - 1
        With cn.Execute("Select * from CustomOrderBody Where DeliveryID = " & TxtDeliveryID.Text & " and CustomProductCode ='" & Grid.Columns("Code").Text & "'")
             If .EOF = True Then
                cn.Execute ("Insert Into UserActivities values ('Custom Order Delivery'" & "," & TxtDeliveryID.Text & ",'" & DtpDeliveryDate.DateValue & "','Inserted New ProdcutID-" & Grid.Columns("Code").Text & " Qty-" & Grid.Columns("Qty").Text & " Price-" & Grid.Columns("Price").Text & " Amount-" & Grid.Columns("Amount").Text & "','" & Date & "','" & Time & "',2,'Updated'," & vUser & ")")
             Else
                If Grid.Columns("Qty").Text <> !Qty Or Grid.Columns("Price").Text <> !Price Then
                   cn.Execute ("Insert Into UserActivities values ('Custom Order Delivery'" & "," & TxtDeliveryID.Text & ",'" & DtpDeliveryDate.DateValue & "','Updated ProdcutID-" & Grid.Columns("Code").Text & " Qty-" & !Qty & " Price-" & !Price & " Amount-" & !Amount & "','" & Date & "','" & Time & "',2,'Updated'," & vUser & ")")
                End If
            End If
        End With
    Grid.MoveNext
    Next
   Else
    cn.Execute ("Insert Into UserActivities values ('Custom Order Delivery'" & "," & TxtDeliveryID.Text & ",'" & DtpDeliveryDate.DateValue & "','Saved','" & Date & "','" & Time & "',1,'Saved'," & vUser & ")")
   End If
End Sub
