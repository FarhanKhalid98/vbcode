...
Begin VB.Form SchChqReceive 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "SchChqIReceive.frx":0054
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid GridDetail 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "SchChqIReceive.frx":0070
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
      AllowRowSizing  =   0   'False
      AllowGroupSizing=   0   'False
...
Private Sub LoadData()
  On Error GoTo ErrorHandler
    ...
    vSQL = " Select h.VochID ID,  h.VochDate as Date, Sum(isnull((b.ActAmount),0)) as Amount" & vbCrLf _
      + " from BankchqRCVHeader h inner join BankchqRCVBody b on h.VochID = b.VochID " & vbCrLf _
      ...
      + " Group by h.VochID,  Vochdate " & vOrder & vDirection
...
Private Sub LoadDetail()
  On Error GoTo ErrorHandler
    ...
    vSQL = " Select B.ActChequeNo, B.ReceivingName, B.ActAmount from BankchqRCVBody B" & vbCrLf _
      + " inner join BankchqRCVHeader H on h.vochID = b.vochID " & vbCrLf _
