...
Begin VB.Form FrmDisputeInvoice 
   AutoRedraw      =   -1  'True
   ...
   ClientTop       =   480
   ClientWidth     =   15360
   Icon            =   "FrmDisputeInvoice.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   742
   ...
   Begin VB.ComboBox CmbInvoiceType 
      Height          =   315
      ItemData        =   "FrmDisputeInvoice.frx":0ECA
      Left            =   6597
      List            =   "FrmDisputeInvoice.frx":0ED4
      Style           =   2  'Dropdown List
      TabIndex        =   1
      Top             =   2070
      Width           =   1215
   End
   Begin VB.TextBox TxtDisputeID 
      Alignment       =   1  'Right Justify
      Appearance      =   0  'Flat
      BackColor       =   &H00EFEFEF&
      CausesValidation=   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnSave 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmDisputeInvoice.frx":0EE1
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClear 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmDisputeInvoice.frx":0EFD
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmDisputeInvoice.frx":0F19
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnOpen 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmDisputeInvoice.frx":0F35
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnDelete 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmDisputeInvoice.frx":0F51
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmDisputeInvoice.frx":0F6D
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnStore 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmDisputeInvoice.frx":0F89
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSearch 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "FrmDisputeInvoice.frx":0FA5
      BC              =   12632256
      FC              =   0
   End
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "FrmDisputeInvoice.frx":0FC1
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
   ...
   End
End
Attribute VB_Name = "FrmDisputeInvoice"
...
Private Sub BtnPrint_Click()
   ...
   vStrSQL = " Select H.*, StoreName, B.productID, ProductName, OverQty,  UnderQty " & vbCrLf _
            + " from DisputeInvoiceHeader H " & vbCrLf _
            + " Inner Join DisputeInvoiceBody B On H.DisputeID = B.DisputeID and h.DisputeDate = b.DisputeDate" & vbCrLf _
            + " Inner Join Stores S on S.SToreID = H.StoreID" & vbCrLf _
            + " Inner Join Products P ON p.ProductiD = B.productID" & vbCrLf _
            + " where h.DisputeID = " & TxtDisputeID.Text & " And h.DisputeDate = '" & DtpDisputeDate.DateValue & "'"

   If RsReport.State = adStateOpen Then RsReport.Close
   RsReport.Open vStrSQL, cn, adOpenStatic, adLockReadOnly
   Set RptReportViewer.Report = New CrptDisputeInvoice
   ...
   cn.Execute ("Insert Into UserActivities values ('Dispute Invoice'" & "," & TxtDisputeID.Text & ",'" & DtpDisputeDate.DateValue & "','Printed','" & Date & "','" & Time & "',5,'Printed'," & vUser & ")")
...
Private Sub BtnClear_Click()
  On Error GoTo ErrorHandler
  cn.Execute ("Insert Into UserActivities values ('Dispute Invoice'" & "," & TxtDisputeID.Text & ",'" & DtpDisputeDate.DateValue & "','Cleared','" & Date & "','" & Time & "',6,'Cleared'," & vUser & ")")
  FormStatus = NewMode
  Exit Sub
ErrorHandler:
  Call ShowErrorMessage
...
Private Sub BtnClose_Click()
    '''''''''''''''''''''''''''''''''''''User Activities'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
   cn.Execute ("Insert Into UserActivities values ('Dispute Invoice'" & "," & TxtDisputeID.Text & ",'" & DtpDisputeDate.DateValue & "','Closed','" & Date & "','" & Time & "',7,'Closed'," & vUser & ")")
  ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
Private Sub BtnDelete_Click()
  On Error GoTo ErrorHandler
    ...
    ''''''''''''' User Authentication ''''''''''''''
   vUserAction = UserAuthentication("MniDisputeInvoice", vUser, ObjUserSecurity.IsAdministrator, eUserDelete)
   If vUserAction <> "" Then
  ...
  '''''''''''''''''''''''''''''''''''''User Activities'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
   cn.Execute ("Insert Into UserActivities values ('Dispute Invoice'" & "," & TxtDisputeID.Text & ",'" & DtpDisputeDate.DateValue & "','Removed','" & Date & "','" & Time & "',3,'Removed'," & vUser & ")")
  ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
  
  cn.Execute "Delete from DisputeInvoiceBody where DisputeID = " & Val(TxtDisputeID.Text) & " and DisputeDate = '" & DtpDisputeDate.DateValue & "'"
  cn.Execute "Delete from DisputeInvoiceHeader WHere DisputeID = " & Val(TxtDisputeID.Text) & " and DisputeDate = '" & DtpDisputeDate.DateValue & "'"
  cn.CommitTrans
  FormStatus = NewMode
  Exit Sub
ErrorHandler:
...
Private Sub PopulateDataToGrid()
   ...
   RsBody.Open "Select * from DisputeInvoiceBody where DisputeID = " & Val(TxtDisputeID.Text) & " and DisputeDate = '" & DtpDisputeDate.DateValue & "'", cn, adOpenStatic, adLockBatchOptimistic
   If RsBody.RecordCount > 0 Then
      ssql = "Select B.*, ProductName from DisputeInvoiceBody b inner join Products P on P.ProductID = B.ProductID where DisputeID = " & Val(TxtDisputeID.Text) & " and DisputeDate = '" & DtpDisputeDate.DateValue & "'"
...
Private Sub GetDisputeInvoice()
   On Error GoTo ErrorHandler
   ssql = "Select * from DisputeInvoiceHeader where DisputeID = " & Val(TxtDisputeID.Text) & " and DisputeDate = '" & DtpDisputeDate.DateValue & "'" & IIf(vSessionID = 0, "", " and SessionID = " & vSessionID)
   With cn.Execute(ssql)
      If Not .BOF Then
          DtpDisputeDate.DateValue = !DisputeDate
...
Private Sub BtnOpen_Click()
   SchDisputeInvoice.ParaInDisputeDate = DtpDisputeDate.DateValue
   SchDisputeInvoice.Show vbModal
   If SchDisputeInvoice.ParaOutDisputeID <> Empty Then
      TxtDisputeID.Text = SchDisputeInvoice.ParaOutDisputeID
      DtpDisputeDate.DateValue = SchDisputeInvoice.ParaOutDisputeDate
      cn.Execute ("Insert Into UserActivities values ('Dispute Invoice'" & "," & TxtDisputeID.Text & ",'" & DtpDisputeDate.DateValue & "','Opened','" & Date & "','" & Time & "',4,'Opened'," & vUser & ")")
      GetDisputeInvoice
   End If
  Exit Sub
ErrorHandler:
...
Private Sub BtnSave_Click()
   ...
   ''''''''''''' User Authentication ''''''''''''''
   vUserAction = UserAuthentication("MniDisputeInvoice", vUser, ObjUserSecurity.IsAdministrator, IIf(vIsNewRecord = True, eUserNewRecord, eUserEdit))
   If vUserAction <> "" Then
      MsgBox vUserAction, vbCritical, "Error"
      Exit Sub
   End If
   ...
   End If
    ...
    With cn.Execute(vStrSQL)
        If .Fields(0).Value >= DtpDisputeDate.DateValue Then
   ...
   If vIsNewRecord Then
      If cn.Execute("Select * from DisputeInvoiceHeader where DisputeID = " & Val(TxtDisputeID.Text) & " And DisputeDate = '" & DtpDisputeDate.DateValue & "'").RecordCount > 0 Then
  ...
  'Saving record
   ...
   ssql = "Select * From DisputeInvoiceHeader Where DisputeID =" & Val(TxtDisputeID.Text) & " and DisputeDate = '" & DtpDisputeDate.DateValue & "'"
   Dim Rs As New ADODB.Recordset
   With Rs
      .Open ssql, cn, adOpenStatic, adLockPessimistic
      If .BOF Then
         .AddNew
         !DisputeID = Val(TxtDisputeID.Text)
         !DisputeDate = DtpDisputeDate.DateValue
      End If
...
Private Property Let FormStatus(ByVal vNewValue As FormMode)
  ...
  Select Case vNewValue
    Case Is = NewMode
      ...
      TxtDisputeID.Text = FunGetMaxID
      DtpDisputeDate.Enabled = True
      DtpDisputeDate.DateValue = Date
      If DtpDisputeDate.Enabled And DtpDisputeDate.Visible Then DtpDisputeDate.SetFocus
      vIsNewRecord = True
    Case Is = OpenMode
      BtnPrint.Enabled = True
      BtnOpen.Enabled = True
...
Private Sub DtpDisputeDate_Change()
    ...
    TxtDisputeID.Text = FunGetMaxID
    If DtpDisputeDate.Enabled And DtpDisputeDate.Visible Then FormStatus = ChangeMode
End Sub
...
Private Sub Form_Load()
   ...
   DtpDisputeDate.DateValue = IIf(Format(Now, "hh") >= Val(ObjRegistry.HourDifference), Date, DateAdd("d", -1, Date))
...
Private Sub mniRemoveRow_Click()
   ...
   cn.Execute ("Insert Into UserActivities values ('Dispute Invoice'" & "," & TxtDisputeID.Text & ",'" & DtpDisputeDate.DateValue & "','Removed ProdcutID-" & Grid.Columns("ID").Text & " OverQty-" & Grid.Columns("OverQty").Text & " UnderQty-" & Grid.Columns("UnderQty").Text & "','" & Date & "','" & Time & "',2,'Updated'," & vUser & ")")
...
Private Sub UserActivities()
    ...
    With cn.Execute("Select  * from DisputeInvoiceHeader where DisputeID =" & TxtDisputeID.Text & " And DisputeDate = '" & DtpDisputeDate.DateValue & "'")
        If TxtStoreID.Text <> !StoreID Then
            cn.Execute ("Insert Into UserActivities values ('Dispute Invoice'" & "," & TxtDisputeID.Text & ",'" & DtpDisputeDate.DateValue & "','Updated StoreID-" & !StoredID & "','" & Date & "','" & Time & "',2,'Updated'," & vUser & ")")
        End If
    End With
    Grid.MoveFirst
    For i = 1 To Grid.Rows - 1
        With cn.Execute("Select * from DisputeInvoiceBody Where DisputeID = " & TxtDisputeID.Text & " and DisputeDate ='" & DtpDisputeDate.DateValue & "' and Productid ='" & Grid.Columns("ID").Text & "'")
        
             If .EOF = True Then
                cn.Execute ("Insert Into UserActivities values ('Dispute Invoice'" & "," & TxtDisputeID.Text & ",'" & DtpDisputeDate.DateValue & "','Inserted New ProdcutID-" & Grid.Columns("ID").Text & " OverQty-" & Grid.Columns("OverQty").Text & " UnderQty-" & Grid.Columns("UnderQty").Text & "','" & Date & "','" & Time & "',2,'Updated'," & vUser & ")")
             Else
                If Grid.Columns("OverQty").Text <> !OverQty Or Grid.Columns("UnderQty").Text <> !UnderQty Then
                   cn.Execute ("Insert Into UserActivities values ('Dispute Invoice'" & "," & TxtDisputeID.Text & ",'" & DtpDisputeDate.DateValue & "','Updated ProdcutID-" & Grid.Columns("ID").Text & " OverQty-" & !OverQty & " UnderQty-" & !UnderQty & "','" & Date & "','" & Time & "',2,'Updated'," & vUser & ")")
                End If
            End If
        End With
    Grid.MoveNext
   ...
   Else
    cn.Execute ("Insert Into UserActivities values ('Dispute Invoice'" & "," & TxtDisputeID.Text & ",'" & DtpDisputeDate.DateValue & "','Saved','" & Date & "','" & Time & "',1,'Saved'," & vUser & ")")
   End If
