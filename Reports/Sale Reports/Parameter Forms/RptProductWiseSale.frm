...
Begin VB.Form RptProductWiseSale 
   AutoRedraw      =   -1  'True
   ...
   ClientWidth     =   12000
   ControlBox      =   0   'False
   Icon            =   "RptProductWiseSale.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductWiseSale.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductWiseSale.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductWiseSale.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductWiseSale.frx":0F1E
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSubGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductWiseSale.frx":0F3A
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnCompany 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductWiseSale.frx":0F56
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductWiseSale.frx":0F72
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnStore 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptProductWiseSale.frx":0F8E
      BC              =   12632256
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "RptProductWiseSale"
...
Private Sub BtnPreview_Click()
   If SetReport Then
       RptReportViewer.Caption = "Current Stock value Store Wise"
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
   ...
   ElseIf KeyCode = vbKeyF1 Then
      Select Case ActiveControl.Name
         ...
         Case TxtStoreID.Name: If FunSelectStore(ssFunctionKey, True) = True Then BtnPreview.SetFocus
      End Select
   End If
   Exit Sub
ErrorHandler:
...
Private Sub Form_Load()
   ShowPicture Me
   SetWindowText Me.hWnd, "Product Wise Sale"
End Sub
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   Set RptProductWiseSale = Nothing
Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
...
Private Function SetReport() As Boolean
    ...
    sSql = "EXEC ProdRptCurrentStockStore '" & IIf(Trim(TxtStoreID.Text) = "", "", TxtStoreID.Text) & "','" & IIf(Trim(TxtProductID.Text) = "", "", TxtProductID.Text) & "','" & IIf(Trim(TxtGroupID.Text) = "", "", TxtGroupID.Text) & "','" & IIf(Trim(TxtCompanyID.Text) = "", "", TxtCompanyID.Text) & "','" & IIf(Trim(TxtSubGroupID.Text) = "", "", TxtSubGroupID.Text) & "','" & IIf(TxtStockLimit.Text = "", "", TxtStockLimit.Text) & "'," & ChkIncludeZeroStock.Value
    Set RsReport = CN.Execute(sSql)
    Set RptReportViewer.Report = New CRptCurrentStockValueStoreWise
    If RsReport.BOF Then
        MsgBox "No record exists.", vbInformation, Me.Caption
        Me.MousePointer = vbDefault
        Exit Function
    End If
    RptReportViewer.Report.ReportTitle = "Store Wise Current Stock"
