...
Begin VB.Form SchSlip 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchSlip.frx":0000
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
   ...
   If KeyCode = vbKeyReturn Then
      ...
      Case Grid.Name, TxtSlipNo.Name, TxtDescription.Name
...
Private Sub Form_Load()
    ...
    Grid.Columns("Amount").DataField = "DepositAmount"
    LoadGrid
    vOrder = " order by DepositAmount "
    Me.ParaOutID = ""
    Exit Sub
ErrorHandler:
  Call ShowErrorMessage
...
Private Sub Grid_KeyPress(KeyAscii As Integer)
   ...
   Case Asc("a") To Asc("z"), Asc("A") To Asc("Z")
      TxtDescription.Text = Chr(KeyAscii): TxtDescription.SetFocus
...
Private Sub TxtSlipNo_change()
   ...
   Rs.Find "SlipNo Like '%" & TxtSlipNo.Text & "%'"
...
Private Sub LoadGrid()
   VStrSQL = "SELECT SlipNo, DepositAmount FROM BankCashDepositBody where DepositAmount like '%" & TxtDescription.Text & "%'" & vOrder & vDirection
