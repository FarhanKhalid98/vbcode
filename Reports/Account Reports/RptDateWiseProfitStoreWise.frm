...
Begin VB.Form RptDateWiseProfitStoreWise 
   AutoRedraw      =   -1  'True
   ...
   ClientTop       =   375
   ClientWidth     =   15360
   Icon            =   "RptDateWiseProfitStoreWise.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   742
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDateWiseProfitStoreWise.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDateWiseProfitStoreWise.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDateWiseProfitStoreWise.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnStore 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDateWiseProfitStoreWise.frx":0F1E
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "RptDateWiseProfitStoreWise"
...
Private Sub BtnPreview_Click()
   If SetReport Then
       RptReportViewer.Caption = "Hot And Cold Products Store Wise "
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Date Wise Profit Store Wise"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   For Each frmObj In Forms
       Set frmObj = Nothing
   Next
   Set RptDateWiseProfitStoreWise = Nothing
Exit Sub
ErrorHandler:
   Call ShowErrorMessage
End Sub
...
'   CN.Execute "exec SPAverageCost '" & DtpTo.DateValue & "'"
   Set RsReport = CN.Execute("EXEC ProdRptDateWiseProfitStoreWise '" & DtpFrom.DateValue & "','" & DtpTo.DateValue & "'," & IIf(Trim(TxtStoreID.Text) = "", "Null", TxtStoreID.Text))
   'Set RsReport = CN.Execute("EXEC ProdRptProductWiseProfit null,null,null,null,'2007-07-27', '2008-09-27'")
   Set RptReportViewer.Report = New CrpDateWiseProfitStoreWise
