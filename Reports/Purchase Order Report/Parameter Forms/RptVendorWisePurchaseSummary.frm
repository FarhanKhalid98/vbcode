...
Begin VB.Form RptVendorWisePurchaseSummary 
   AutoRedraw      =   -1  'True
   ...
   ClientWidth     =   12000
   ControlBox      =   0   'False
   Icon            =   "RptVendorWisePurchaseSummary.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptVendorWisePurchaseSummary.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptVendorWisePurchaseSummary.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptVendorWisePurchaseSummary.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnVendor 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptVendorWisePurchaseSummary.frx":0F1E
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin VB.Label Label7 
      ...
      Caption         =   "Purchase Summary (Vendor Wise)"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   13.5
         Charset         =   178
   ...
   End
End
Attribute VB_Name = "RptVendorWisePurchaseSummary"
...
Private Sub Form_Load()
    ShowPicture Me
    SetWindowText Me.hWnd, "Purchase Summary (Vendor Wise)"
...
Private Function SetReport() As Boolean
   ...
   Dim RsReport As New ADODB.Recordset
   Set RsReport = CN.Execute("EXEC ProdRptVendorWisePurchaseSummary '" & DtpFrom.DateValue & "','" & DtpTo.DateValue & "','" & IIf(TxtVendorName.Text = "All Vendors", "", TxtVendorID.Text) & "'")
   Set RptReportViewer.Report = New CRptVendorWisePurchaseSummary
