...
Begin VB.Form RptDateWiseProfit 
   AutoRedraw      =   -1  'True
   ...
   ClientWidth     =   12000
   ControlBox      =   0   'False
   Icon            =   "RptDateWiseProfit.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDateWiseProfit.frx":0ECA
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDateWiseProfit.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptDateWiseProfit.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "RptDateWiseProfit"
...
Private Sub Form_Load()
   ...
   SetWindowText Me.hWnd, "Date Wise Profit"
...
Private Function SetReport() As Boolean
   ...
   Set RsReport = CN.Execute("EXEC ProdRptDateWiseProfit '" & DtpFrom.DateValue & "','" & DtpTo.DateValue & "'")
   Set RptReportViewer.Report = New CrpDateWiseProfit
   RptReportViewer.Report.ReportTitle = "Date Wise Profit"
