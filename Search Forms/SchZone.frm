...
Begin VB.Form SchZone 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchZone.frx":0000
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
...
Public ParaOutZoneID As String
...
Private Sub TxtZoneID_Change()
   ...
   Rs.Find "ZoneID like '" & TxtZoneID.Text & "%'", , adSearchForward, 1
