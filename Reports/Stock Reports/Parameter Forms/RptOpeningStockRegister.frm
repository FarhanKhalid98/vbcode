...
Begin VB.Form RptOpeningStockRegister 
   AutoRedraw      =   -1  'True
   ...
   ClientTop       =   375
   ClientWidth     =   15360
   Icon            =   "RptOpeningStockRegister.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   742
   ...
   Begin VB.ComboBox CmbSortName 
      Height          =   315
      ItemData        =   "RptOpeningStockRegister.frx":0ECA
      Left            =   9405
      List            =   "RptOpeningStockRegister.frx":0ECC
   ...
   Begin VB.ComboBox CmbSortType 
      Height          =   315
      ItemData        =   "RptOpeningStockRegister.frx":0ECE
      Left            =   11295
      List            =   "RptOpeningStockRegister.frx":0ED0
      Style           =   2  'Dropdown List
      TabIndex        =   50
      Top             =   6720
      Width           =   1275
   ...
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockRegister.frx":0ED2
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPreview 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockRegister.frx":0EEE
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnPrint 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockRegister.frx":0F0A
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnProduct 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockRegister.frx":0F26
      BC              =   12632256
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnStore 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockRegister.frx":0F42
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockRegister.frx":0F5E
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnCompany 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockRegister.frx":0F7A
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnSubGroup 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockRegister.frx":0F96
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnVender 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockRegister.frx":0FB2
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnBrand 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockRegister.frx":0FCE
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnOrganization 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockRegister.frx":0FEA
      BC              =   14737632
      FC              =   0
   End
   ...
   Begin JeweledBut.JeweledButton BtnDepartment 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockRegister.frx":1006
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnSubDepartment 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockRegister.frx":1022
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton TxtSeason 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockRegister.frx":103E
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnItemCode 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockRegister.frx":105A
      BC              =   12632256
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnItemDesc 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockRegister.frx":1076
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnDescription 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "RptOpeningStockRegister.frx":1092
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "RptOpeningStockRegister"
...
Private Sub BtnPreview_Click()
   ...
   If SetReport Then
     If RdoDetail.Value = True Then
        RptReportViewer.Caption = "Opening Stock Register Detail (" & CmbGroup.Text & ")"
     Else
        RptReportViewer.Caption = "Opening Stock Register Summary (" & CmbGroup.Text & ")"
     End If
...
Private Function SetReport() As Boolean
   ...
   If RdoDetail.Value = True Then
      Select Case CmbGroup.Text
         Case "Invoice Wise"
            Set RptReportViewer.Report = New CrpOpenningStockRegisterInvoiceWise
      End Select
   Else
      Select Case CmbGroup.Text
         Case "Invoice Wise"
            Set RptReportViewer.Report = New CrpOpenningStockRegisterSummaryInvoiceWise
      End Select
   End If
   ...
   sSql = "EXEC ProdRptOpeningStockRegister '" & DtpDate.DateValue & "'," & IIf(Trim(TxtProductID.Text) = "", "Null", "'" & TxtProductID.Text & "'") & "," & IIf(Trim(TxtGroupID.Text) = "", "Null", "'" & TxtGroupID.Text & "'") & "," & IIf(Trim(TxtSubGroupID.Text) = "", "Null", "'" & TxtSubGroupID.Text & "'") & "," & IIf(Trim(TxtCompanyID.Text) = "", "Null", "'" & TxtCompanyID.Text & "'") & "," & IIf(Trim(TxtBrandID.Text) = "", "Null", TxtBrandID.Text) & "," & IIf(Trim(TxtStoreID.Text) = "", "Null", TxtStoreID.Text) & "," & IIf(Trim(TxtOrganizationID.Text) = "", "Null", TxtOrganizationID.Text) & "," & IIf(Trim(TxtVenderID.Text) = "", "Null", "'" & TxtVenderID.Text & "'") & vbCrLf _
      ...
      & "," & IIf(ObjRegistry.ShowWholeSaleMargin, "'WSPrice'", "'RetailPrice'") & "," & IIf(ChkZeroCost.Value = 1, 0, "Null") & "," & IIf(ChkZeroQty.Value = 1, "Null", 0) & "," & vSaleDate & ",'" & CmbSortName.Text & " " & CmbSortType.Text & "'"
