...
Begin VB.Form SchBanquetInvoice 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00F8E8D6&
   ...
   ClientTop       =   375
   ClientWidth     =   15420
   Icon            =   "SchBanquetInvoice.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid Grid 
      ...
      EndProperty
      stylesets(0).Picture=   "SchBanquetInvoice.frx":0ECA
      AllowUpdate     =   0   'False
      MultiLine       =   0   'False
      ...
      Columns(1).Caption=   "Invoice Date"
      Columns(1).Name =   "Date"
      ...
      Columns(6).Caption=   "Tot Attend"
      Columns(6).Name =   "TotalAttendants"
      Columns(6).Alignment=   1
      Columns(6).DataField=   "Column 8"
      Columns(6).DataType=   8
      Columns(6).FieldLen=   256
      Columns(7).Width=   2170
      Columns(7).Caption=   "Per Head Cost"
      Columns(7).Name =   "PerHeadCost"
      Columns(7).Alignment=   1
      Columns(7).DataField=   "Column 9"
      Columns(7).DataType=   8
      Columns(7).FieldLen=   256
      Columns(8).Width=   1905
      Columns(8).Caption=   "Received"
      Columns(8).Name =   "Received"
      Columns(8).CaptionAlignment=   2
      Columns(8).DataField=   "Column 10"
      Columns(8).DataType=   8
      Columns(8).FieldLen=   256
      Columns(9).Width=   2170
      Columns(9).Caption=   "Balance"
      Columns(9).Name =   "Balance"
      Columns(9).CaptionAlignment=   2
      Columns(9).DataField=   "Column 11"
   ...
   Begin JeweledBut.JeweledButton BtnSelect 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchBanquetInvoice.frx":0EE6
      BC              =   14737632
      FC              =   0
   End
   Begin JeweledBut.JeweledButton BtnClose 
      ...
      FOCUSR          =   -1  'True
      MPTR            =   0
      MICON           =   "SchBanquetInvoice.frx":0F02
      BC              =   14737632
      FC              =   0
   End
   ...
   End
End
Attribute VB_Name = "SchBanquetInvoice"
...
Private Sub LoadGrid()
   ...
   vSQL = " SELECT b.BookingID as ID, b.*, i.*, UserName, ((TotalAttendants*PerHead)+ExtraCharges-Discount-AdvanceReceived-Received) as Balance" & vbCrLf _
         + " FROM BanquetOrder b inner join BanquetInvoice i on  b.BookingID = i.BookingID inner join users u on u.userno = b.userno " & vbCrLf _
         + " WHERE BookingDate Between '" & DtpFrom.DateValue & "' AND '" & DtpTo.DateValue & "'" & vEventName & vCustomerName & vOrder & vDirection
   
   Rs.Open vSQL, CN, adOpenDynamic, adLockReadOnly
   Set Grid.DataSource = Rs
   Grid.Columns("ID").DataField = "ID"
   Grid.Columns("Date").DataField = "InvoiceDate"
   ...
   Grid.Columns("TotalAttendants").DataField = "TotalAttendants"
   Grid.Columns("PerHeadCost").DataField = "PerHead"
   Grid.Columns("Received").DataField = "Received"
   Grid.Columns("Balance").DataField = "Balance"
